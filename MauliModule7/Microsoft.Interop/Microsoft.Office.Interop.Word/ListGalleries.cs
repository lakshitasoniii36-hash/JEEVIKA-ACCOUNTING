...
public interface ListGalleries : IEnumerable
{
  ...
  [DispId(0)]
  ListGallery this[[In] WdListGalleryType Index] { [DispId(0), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
}
