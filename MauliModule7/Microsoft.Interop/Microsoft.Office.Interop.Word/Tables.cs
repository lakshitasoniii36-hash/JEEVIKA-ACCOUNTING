...
public interface Tables : IEnumerable
{
  ...
  Table AddOld([MarshalAs(UnmanagedType.Interface), In] Range Range, [In] int NumRows, [In] int NumColumns);
  ...
  [DispId(100)]
  int NestingLevel { [DispId(100), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }
}
