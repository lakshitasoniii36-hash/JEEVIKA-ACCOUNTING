...
public interface KeyBindings : IEnumerable
{
  ...
  [DispId(0)]
  KeyBinding this[[In] int Index] { [DispId(0), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
  ...
  KeyBinding Add(
    ...
    [In] int KeyCode,
    [MarshalAs(UnmanagedType.Struct), In, Optional] ref object KeyCode2,
  ...
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.Interface)]
  KeyBinding Key([In] int KeyCode, [MarshalAs(UnmanagedType.Struct), In, Optional] ref object KeyCode2);
}
