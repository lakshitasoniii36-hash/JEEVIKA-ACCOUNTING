...
public interface HeadersFooters : IEnumerable
{
  ...
  [DispId(0)]
  HeaderFooter this[[In] WdHeaderFooterIndex Index] { [DispId(0), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
}
