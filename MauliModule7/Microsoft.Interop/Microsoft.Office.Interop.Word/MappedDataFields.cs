...
public interface MappedDataFields : IEnumerable
{
  ...
  [DispId(0)]
  MappedDataField this[[In] WdMappedDataFields Index] { [DispId(0), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
}
