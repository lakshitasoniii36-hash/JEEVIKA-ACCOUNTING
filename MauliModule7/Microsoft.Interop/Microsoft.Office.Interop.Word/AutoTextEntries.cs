...
// Type: Microsoft.Office.Interop.Word.AutoTextEntries
...
public interface AutoTextEntries : IEnumerable
{
  ...
  [DispId(0)]
  AutoTextEntry this[[MarshalAs(UnmanagedType.Struct), In] ref object Index] { [DispId(0), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
