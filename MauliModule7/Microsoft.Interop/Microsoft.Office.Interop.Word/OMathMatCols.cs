...
public interface OMathMatCols : IEnumerable
{
  ...
  [DispId(0)]
  OMathMatCol this[[In] int Index] { [DispId(0), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }

  [DispId(200)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.Interface)]
  OMathMatCol Add([MarshalAs(UnmanagedType.Struct), In, Optional] ref object BeforeCol);
}
