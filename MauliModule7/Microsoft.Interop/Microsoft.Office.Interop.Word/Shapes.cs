...
public interface Shapes : IEnumerable
{
  ...
  Shape AddCallout(
    ...
    [In] float Width,
    [In] float Height,
    [MarshalAs(UnmanagedType.Struct), In, Optional] ref object Anchor);
  ...
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.Interface)]
  Shape AddCurve([MarshalAs(UnmanagedType.Struct), In] ref object SafeArrayOfPoints, [MarshalAs(UnmanagedType.Struct), In, Optional] ref object Anchor);
  ...
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.Interface)]
  Shape AddLine([In] float BeginX, [In] float BeginY, [In] float EndX, [In] float EndY, [MarshalAs(UnmanagedType.Struct), In, Optional] ref object Anchor);
  ...
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.Interface)]
  Shape AddPolyline([MarshalAs(UnmanagedType.Struct), In] ref object SafeArrayOfPoints, [MarshalAs(UnmanagedType.Struct), In, Optional] ref object Anchor);

  [DispId(17)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.Interface)]
  Shape AddShape([In] int Type, [In] float Left, [In] float Top, [In] float Width, [In] float Height, [MarshalAs(UnmanagedType.Struct), In, Optional] ref object Anchor);
  ...
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.Interface)]
  Shape AddCanvas([In] float Left, [In] float Top, [In] float Width, [In] float Height, [MarshalAs(UnmanagedType.Struct), In, Optional] ref object Anchor);

  [DispId(103)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.Interface)]
  Shape AddChart(
    [In] XlChartType Type = (XlChartType) -1,
    [MarshalAs(UnmanagedType.Struct), In, Optional] ref object Left,
    [MarshalAs(UnmanagedType.Struct), In, Optional] ref object Top,
    [MarshalAs(UnmanagedType.Struct), In, Optional] ref object Width,
    [MarshalAs(UnmanagedType.Struct), In, Optional] ref object Height,
