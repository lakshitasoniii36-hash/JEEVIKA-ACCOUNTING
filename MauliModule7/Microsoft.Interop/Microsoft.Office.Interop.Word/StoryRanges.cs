...
public interface StoryRanges : IEnumerable
{
  ...
  [DispId(0)]
  Range this[[In] WdStoryType Index] { [DispId(0), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
}
