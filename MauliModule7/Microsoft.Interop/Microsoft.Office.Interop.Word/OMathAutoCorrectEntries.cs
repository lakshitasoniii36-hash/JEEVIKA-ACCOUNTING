...
// Type: Microsoft.Office.Interop.Word.OMathAutoCorrectEntries
...
[ComImport]
public interface OMathAutoCorrectEntries : IEnumerable
{
  [DispId(100)]
  ...
  [DispId(0)]
  OMathAutoCorrectEntry this[[MarshalAs(UnmanagedType.Struct), In] ref object Index] { [DispId(0), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }

  [DispId(200)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.Interface)]
  OMathAutoCorrectEntry Add([MarshalAs(UnmanagedType.BStr), In] string Name, [MarshalAs(UnmanagedType.BStr), In] string Value);
}
