...
public interface TablesOfAuthoritiesCategories : IEnumerable
{
  ...
  [DispId(0)]
  TableOfAuthoritiesCategory this[[MarshalAs(UnmanagedType.Struct), In] ref object Index] { [DispId(0), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
}
