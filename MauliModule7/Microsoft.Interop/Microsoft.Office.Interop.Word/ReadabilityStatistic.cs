...
// Type: Microsoft.Office.Interop.Word.ReadabilityStatistic
...
public interface ReadabilityStatistic
{
  ...
  [DispId(1)]
  float Value { [DispId(1), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }
}
