...
public interface OMathFunctions : IEnumerable
{
  ...
  [DispId(0)]
  OMathFunction this[[In] int Index] { [DispId(0), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }

  [DispId(104)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.Interface)]
  OMathFunction Add([MarshalAs(UnmanagedType.Interface), In] Range Range, [In] WdOMathFunctionType Type, [MarshalAs(UnmanagedType.Struct), In, Optional] ref object NumArgs, [MarshalAs(UnmanagedType.Struct), In, Optional] ref object NumCols);
}
