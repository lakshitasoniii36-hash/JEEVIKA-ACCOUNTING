...
public interface Dialogs : IEnumerable
{
  ...
  [DispId(0)]
  Dialog this[[In] WdWordDialog Index] { [DispId(0), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
}
