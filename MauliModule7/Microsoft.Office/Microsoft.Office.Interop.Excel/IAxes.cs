...
// Type: Microsoft.Office.Interop.Excel.IAxes
...
[TypeLibType(4112)]
[ComImport]
public interface IAxes : IEnumerable
{
  [DispId(148)]
  ...
  Axis Item([In] XlAxisType Type, [In] XlAxisGroup AxisGroup = XlAxisGroup.xlPrimary);
  ...
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.Interface)]
  Axis _Default([In] XlAxisType Type, [In] XlAxisGroup AxisGroup = XlAxisGroup.xlPrimary);
}
