...
public interface SmartTagRecognizer
{
  ...
  [DispId(2216)]
  string progID { [DispId(2216), MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.BStr)] get; }
