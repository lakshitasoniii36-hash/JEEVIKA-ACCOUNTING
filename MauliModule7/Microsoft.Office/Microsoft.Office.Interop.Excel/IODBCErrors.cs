...
// Type: Microsoft.Office.Interop.Excel.IODBCErrors
...
[TypeLibType(4112)]
[ComImport]
public interface IODBCErrors : IEnumerable
{
  [DispId(148)]
  ...
  ODBCError Item([In] int Index);

  [DispId(0)]
  [IndexerName("_Default")]
  ODBCError this[[In] int Index] { [TypeLibFunc(1024 /*0x0400*/), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
