...
// Type: Microsoft.Office.Interop.Excel.MenuItems
...
public interface MenuItems
{
  ...
  MenuItem Add(
    ...
    [MarshalAs(UnmanagedType.Struct), In, Optional] object Restore,
  ...
  [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.Interface)]
  Menu AddMenu([MarshalAs(UnmanagedType.BStr), In] string Caption, [MarshalAs(UnmanagedType.Struct), In, Optional] object Before, [MarshalAs(UnmanagedType.Struct), In, Optional] object Restore);
  ...
  object this[[MarshalAs(UnmanagedType.Struct), In] object Index] { [DispId(0), TypeLibFunc(1024 /*0x0400*/), MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.IDispatch)] get; }
