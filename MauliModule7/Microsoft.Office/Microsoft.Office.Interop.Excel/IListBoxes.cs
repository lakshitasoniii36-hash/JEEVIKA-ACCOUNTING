...
// Type: Microsoft.Office.Interop.Excel.IListBoxes
...
[TypeLibType(4112)]
[ComImport]
public interface IListBoxes : IEnumerable
{
  [DispId(148)]
  ...
  ListBox Add([In] double Left, [In] double Top, [In] double Width, [In] double Height);
