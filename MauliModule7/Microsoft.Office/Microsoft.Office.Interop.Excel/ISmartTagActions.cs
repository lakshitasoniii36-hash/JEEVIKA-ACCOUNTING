...
// Type: Microsoft.Office.Interop.Excel.ISmartTagActions
...
[TypeLibType(4112)]
[ComImport]
public interface ISmartTagActions : IEnumerable
{
  [DispId(148)]
  ...
  SmartTagAction this[[MarshalAs(UnmanagedType.Struct), In] object Index] { [TypeLibFunc(1024 /*0x0400*/), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }

  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.Interface)]
  SmartTagAction get_Item([MarshalAs(UnmanagedType.Struct), In] object Index);
