...
// Type: Microsoft.Office.Interop.Excel.IPivotLineCells
...
[TypeLibType(4112)]
[ComImport]
public interface IPivotLineCells : IEnumerable
{
  [DispId(148)]
  ...
  PivotCell this[[MarshalAs(UnmanagedType.Struct), In] object Index] { [TypeLibFunc(1024 /*0x0400*/), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
  ...
  PivotCell get_Item([MarshalAs(UnmanagedType.Struct), In] object Index);
