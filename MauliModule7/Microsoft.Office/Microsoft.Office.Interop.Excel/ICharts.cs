...
// Type: Microsoft.Office.Interop.Excel.ICharts
...
public interface ICharts : IEnumerable
{
  ...
  Chart Add([MarshalAs(UnmanagedType.Struct), In, Optional] object Before, [MarshalAs(UnmanagedType.Struct), In, Optional] object After, [MarshalAs(UnmanagedType.Struct), In, Optional] object Count);
