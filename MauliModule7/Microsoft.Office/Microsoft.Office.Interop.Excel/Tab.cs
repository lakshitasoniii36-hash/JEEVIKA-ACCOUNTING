...
// Type: Microsoft.Office.Interop.Excel.Tab
...
public interface Tab
{
  ...
  [DispId(2365)]
  XlThemeColor ThemeColor { [DispId(2365), MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; [DispId(2365), MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: In] set; }
