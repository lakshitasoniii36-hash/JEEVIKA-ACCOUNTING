...
// Type: Microsoft.Office.Interop.Excel.IPanes
...
public interface IPanes
{
  ...
  Pane get_Item([In] int Index);

  [DispId(0)]
  [IndexerName("_Default")]
  Pane this[[In] int Index] { [TypeLibFunc(1024 /*0x0400*/), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
}
