...
// Type: Microsoft.Office.Interop.Excel.IDropDowns
...
[TypeLibType(4112)]
[ComImport]
public interface IDropDowns : IEnumerable
{
  [DispId(148)]
  ...
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.Interface)]
  DropDown Add([In] double Left, [In] double Top, [In] double Width, [In] double Height, [MarshalAs(UnmanagedType.Struct), In, Optional] object Editable);
