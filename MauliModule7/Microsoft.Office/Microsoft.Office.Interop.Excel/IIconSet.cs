...
// Type: Microsoft.Office.Interop.Excel.IIconSet
...
[TypeLibType(4112)]
[ComImport]
public interface IIconSet : IEnumerable
{
  [DispId(148)]
  ...
  [DispId(570)]
  XlIconSet ID { [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }
  ...
  Icon this[[MarshalAs(UnmanagedType.Struct), In] object Index] { [TypeLibFunc(1024 /*0x0400*/), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
