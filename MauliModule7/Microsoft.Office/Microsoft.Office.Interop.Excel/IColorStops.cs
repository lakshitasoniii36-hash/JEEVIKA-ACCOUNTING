...
// Type: Microsoft.Office.Interop.Excel.IColorStops
...
public interface IColorStops : IEnumerable
{
  ...
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.Interface)]
  ColorStop Item([MarshalAs(UnmanagedType.Struct), In] object Index);

  [DispId(0)]
  [IndexerName("_Default")]
  ColorStop this[[MarshalAs(UnmanagedType.Struct), In] object Index] { [TypeLibFunc(1024 /*0x0400*/), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
