...
// Type: Microsoft.Office.Interop.Excel.IPictures
...
[ComImport]
public interface IPictures : IEnumerable
{
  [DispId(148)]
  ...
  Picture Add([In] double Left, [In] double Top, [In] double Width, [In] double Height);
  ...
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.Interface)]
  Picture Insert([MarshalAs(UnmanagedType.BStr), In] string Filename, [MarshalAs(UnmanagedType.Struct), In, Optional] object Converter);
  ...
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.Interface)]
  Picture Paste([MarshalAs(UnmanagedType.Struct), In, Optional] object Link);
}
