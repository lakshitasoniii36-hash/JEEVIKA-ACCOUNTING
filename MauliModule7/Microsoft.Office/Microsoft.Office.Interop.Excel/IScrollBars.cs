...
// Type: Microsoft.Office.Interop.Excel.IScrollBars
...
[ComImport]
public interface IScrollBars : IEnumerable
{
  [DispId(148)]
  ...
  ScrollBar Add([In] double Left, [In] double Top, [In] double Width, [In] double Height);
