...
// Type: Microsoft.Office.Interop.Excel.IMenuBars
...
[ComImport]
public interface IMenuBars : IEnumerable
{
  [DispId(148)]
  ...
  MenuBar this[[MarshalAs(UnmanagedType.Struct), In] object Index] { [TypeLibFunc(1024 /*0x0400*/), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
