...
// Type: Microsoft.Office.Interop.Excel.IPivotFilters
...
public interface IPivotFilters : IEnumerable
{
  ...
  PivotFilter this[[MarshalAs(UnmanagedType.Struct), In] object Index] { [TypeLibFunc(1024 /*0x0400*/), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
  ...
  PivotFilter get_Item([MarshalAs(UnmanagedType.Struct), In] object Index);
  ...
  PivotFilter Add(
    ...
    [MarshalAs(UnmanagedType.Struct), In, Optional] object Value1,
    [MarshalAs(UnmanagedType.Struct), In, Optional] object Value2,
    ...
    [MarshalAs(UnmanagedType.Struct), In, Optional] object MemberPropertyField);
}
