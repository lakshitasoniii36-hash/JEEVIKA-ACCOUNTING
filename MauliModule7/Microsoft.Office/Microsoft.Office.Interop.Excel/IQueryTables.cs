...
// Type: Microsoft.Office.Interop.Excel.IQueryTables
...
[TypeLibType(4112)]
[ComImport]
public interface IQueryTables : IEnumerable
{
  [DispId(148)]
  ...
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.Interface)]
  QueryTable Item([MarshalAs(UnmanagedType.Struct), In] object Index);

  [DispId(0)]
  [IndexerName("_Default")]
  QueryTable this[[MarshalAs(UnmanagedType.Struct), In] object Index] { [TypeLibFunc(1024 /*0x0400*/), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
