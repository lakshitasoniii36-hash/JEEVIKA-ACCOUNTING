...
// Type: Microsoft.Office.Interop.Excel.IRanges
...
[TypeLibType(4112)]
[ComImport]
public interface IRanges : IEnumerable
{
  [DispId(148)]
  ...
  Range this[[MarshalAs(UnmanagedType.Struct), In] object Index] { [TypeLibFunc(1024 /*0x0400*/), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
  ...
  Range get_Item([MarshalAs(UnmanagedType.Struct), In] object Index);
