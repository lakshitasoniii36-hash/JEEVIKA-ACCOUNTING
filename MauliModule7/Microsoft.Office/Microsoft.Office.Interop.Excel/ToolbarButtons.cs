...
// Type: Microsoft.Office.Interop.Excel.ToolbarButtons
...
[InterfaceType(2)]
[ComImport]
public interface ToolbarButtons
{
  [DispId(148)]
  ...
  ToolbarButton this[[In] int Index] { [TypeLibFunc(1024 /*0x0400*/), DispId(0), MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
}
