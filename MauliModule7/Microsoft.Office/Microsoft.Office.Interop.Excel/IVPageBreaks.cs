...
// Type: Microsoft.Office.Interop.Excel.IVPageBreaks
...
public interface IVPageBreaks : IEnumerable
{
  ...
  VPageBreak get_Item([In] int Index);

  [DispId(0)]
  [IndexerName("_Default")]
  VPageBreak this[[In] int Index] { [TypeLibFunc(1024 /*0x0400*/), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
  ...
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.Interface)]
  VPageBreak Add([MarshalAs(UnmanagedType.IDispatch), In] object Before);
}
