...
// Type: Microsoft.Office.Interop.Excel.IRecentFile
...
public interface IRecentFile
{
  ...
  [DispId(291)]
  string Path { [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.BStr)] get; }
