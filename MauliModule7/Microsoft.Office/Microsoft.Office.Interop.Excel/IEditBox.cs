...
// Type: Microsoft.Office.Interop.Excel.IEditBox
...
public interface IEditBox
{
  ...
  [DispId(862)]
  string LinkedObject { [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.BStr)] get; }
  ...
  [DispId(1162)]
  bool PasswordEdit { [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: In] set; }
}
