...
// Type: Microsoft.Office.Interop.Excel.IXmlSchemas
...
[TypeLibType(4112)]
[ComImport]
public interface IXmlSchemas : IEnumerable
{
  [DispId(148)]
  ...
  XmlSchema this[[MarshalAs(UnmanagedType.Struct), In] object Index] { [TypeLibFunc(1024 /*0x0400*/), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
