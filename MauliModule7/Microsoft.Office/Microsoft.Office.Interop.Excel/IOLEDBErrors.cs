...
// Type: Microsoft.Office.Interop.Excel.IOLEDBErrors
...
[ComImport]
public interface IOLEDBErrors : IEnumerable
{
  [DispId(148)]
  ...
  OLEDBError Item([In] int Index);

  [DispId(0)]
  [IndexerName("_Default")]
  OLEDBError this[[In] int Index] { [TypeLibFunc(1024 /*0x0400*/), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
