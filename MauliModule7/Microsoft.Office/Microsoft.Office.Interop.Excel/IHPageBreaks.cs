...
// Type: Microsoft.Office.Interop.Excel.IHPageBreaks
...
public interface IHPageBreaks : IEnumerable
{
  ...
  HPageBreak get_Item([In] int Index);

  [DispId(0)]
  [IndexerName("_Default")]
  HPageBreak this[[In] int Index] { [TypeLibFunc(1024 /*0x0400*/), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
  ...
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.Interface)]
  HPageBreak Add([MarshalAs(UnmanagedType.IDispatch), In] object Before);
}
