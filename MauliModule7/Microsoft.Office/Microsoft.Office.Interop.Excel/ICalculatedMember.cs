...
// Type: Microsoft.Office.Interop.Excel.ICalculatedMember
...
public interface ICalculatedMember
{
  ...
  [DispId(261)]
  string Formula { [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.BStr)] get; }
  ...
  [DispId(2187)]
  int SolveOrder { [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }

  [DispId(2188)]
  bool IsValid { [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }
  ...
  [DispId(108)]
  XlCalculatedMemberType Type { [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }
}
