...
// Type: Microsoft.Office.Interop.Excel.ILinearGradient
...
public interface ILinearGradient
{
  ...
  [DispId(1623)]
  double Degree { [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: In] set; }
}
