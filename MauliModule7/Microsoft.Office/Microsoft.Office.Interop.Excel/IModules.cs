...
// Type: Microsoft.Office.Interop.Excel.IModules
...
[TypeLibType(4112)]
[ComImport]
public interface IModules : IEnumerable
{
  [DispId(148)]
  ...
  Module Add([MarshalAs(UnmanagedType.Struct), In, Optional] object Before, [MarshalAs(UnmanagedType.Struct), In, Optional] object After, [MarshalAs(UnmanagedType.Struct), In, Optional] object Count);
