...
// Type: Microsoft.Office.Interop.Excel.IPivotTables
...
public interface IPivotTables : IEnumerable
{
  ...
  PivotTable Item([MarshalAs(UnmanagedType.Struct), In] object Index);
  ...
  [return: MarshalAs(UnmanagedType.Interface)]
  PivotTable Add(
    [MarshalAs(UnmanagedType.Interface), In] PivotCache PivotCache,
