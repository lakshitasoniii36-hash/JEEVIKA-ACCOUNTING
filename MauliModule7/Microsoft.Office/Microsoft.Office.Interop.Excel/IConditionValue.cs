...
// Type: Microsoft.Office.Interop.Excel.IConditionValue
...
public interface IConditionValue
{
  ...
  [DispId(108)]
  XlConditionValueTypes Type { [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }
