...
// Type: Microsoft.Office.Interop.Excel.IDialogs
...
[ComImport]
public interface IDialogs : IEnumerable
{
  [DispId(148)]
  ...
  Dialog get_Item([In] XlBuiltInDialog Index);

  [DispId(0)]
  [IndexerName("_Default")]
  Dialog this[[In] XlBuiltInDialog Index] { [TypeLibFunc(1024 /*0x0400*/), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
