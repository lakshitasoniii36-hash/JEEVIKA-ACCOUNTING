...
public interface ListRow
{
  ...
  [DispId(2324)]
  bool InvalidData { [TypeLibFunc(64 /*0x40*/), DispId(2324), MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }
