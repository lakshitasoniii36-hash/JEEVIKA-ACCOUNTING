...
// Type: Microsoft.Office.Interop.Excel.IServerViewableItems
...
[ComImport]
public interface IServerViewableItems : IEnumerable
{
  [DispId(148)]
  ...
  object Add([MarshalAs(UnmanagedType.Struct), In] object Obj);
