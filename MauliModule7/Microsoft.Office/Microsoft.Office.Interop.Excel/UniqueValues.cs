...
// Type: Microsoft.Office.Interop.Excel.UniqueValues
...
public interface UniqueValues
{
  ...
  [DispId(2733)]
  XlDupeUnique DupeUnique { [DispId(2733), MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; [DispId(2733), MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: In] set; }
