...
// Type: Microsoft.Office.Interop.Excel.ITableStyleElement
...
public interface ITableStyleElement
{
  ...
  [DispId(2735)]
  bool HasFormat { [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }
  ...
  [DispId(2736)]
  int StripeSize { [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: In] set; }
