...
// Type: Microsoft.Office.Interop.Excel.ITableStyles
...
public interface ITableStyles : IEnumerable
{
  ...
  TableStyle this[[MarshalAs(UnmanagedType.Struct), In] object Index] { [TypeLibFunc(1024 /*0x0400*/), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
