...
// Type: Microsoft.Office.Interop.Excel.ILegendEntries
...
public interface ILegendEntries : IEnumerable
{
  ...
  LegendEntry Item([MarshalAs(UnmanagedType.Struct), In] object Index);
  ...
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.Interface)]
  LegendEntry _Default([MarshalAs(UnmanagedType.Struct), In] object Index);
}
