...
// Type: Microsoft.Office.Interop.Excel.IColorScale
...
public interface IColorScale
{
  ...
  [DispId(2716)]
  ColorScaleCriteria ColorScaleCriteria { [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
}
