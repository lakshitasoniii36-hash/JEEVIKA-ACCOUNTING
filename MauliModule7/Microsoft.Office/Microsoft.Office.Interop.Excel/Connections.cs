...
public interface Connections
{
  ...
  WorkbookConnection this[[MarshalAs(UnmanagedType.Struct), In] object Index] { [DispId(0), TypeLibFunc(1024 /*0x0400*/), MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
