...
// Type: Microsoft.Office.Interop.Excel.IFormatConditions
...
public interface IFormatConditions : IEnumerable
{
  ...
  object Add(
    ...
    [MarshalAs(UnmanagedType.Struct), In, Optional] object TextOperator,
    [MarshalAs(UnmanagedType.Struct), In, Optional] object DateOperator,
    [MarshalAs(UnmanagedType.Struct), In, Optional] object ScopeType);
