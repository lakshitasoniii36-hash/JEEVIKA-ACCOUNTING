...
// Type: Microsoft.Office.Interop.Excel.IPivotAxis
...
public interface IPivotAxis
{
  ...
  [DispId(2685)]
  PivotLines PivotLines { [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
}
