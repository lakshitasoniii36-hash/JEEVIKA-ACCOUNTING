...
// Type: Microsoft.Office.Interop.Excel.IAreas
...
public interface IAreas : IEnumerable
{
  ...
  Range this[[In] int Index] { [TypeLibFunc(1024 /*0x0400*/), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
}
