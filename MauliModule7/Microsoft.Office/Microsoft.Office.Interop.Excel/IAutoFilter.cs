...
// Type: Microsoft.Office.Interop.Excel.IAutoFilter
...
public interface IAutoFilter
{
  ...
  [DispId(1617)]
  Filters Filters { [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }

  [DispId(800)]
  bool FilterMode { [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }
