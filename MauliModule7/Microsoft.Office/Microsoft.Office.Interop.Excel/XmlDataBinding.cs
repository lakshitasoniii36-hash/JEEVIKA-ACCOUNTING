...
// Type: Microsoft.Office.Interop.Excel.XmlDataBinding
...
public interface XmlDataBinding
{
  ...
  [DispId(2329)]
  [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  void LoadSettings([MarshalAs(UnmanagedType.BStr), In] string Url);
  ...
  [DispId(2331)]
  string SourceUrl { [DispId(2331), MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.BStr)] get; }
}
