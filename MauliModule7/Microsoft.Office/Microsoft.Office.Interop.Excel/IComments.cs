...
// Type: Microsoft.Office.Interop.Excel.IComments
...
public interface IComments : IEnumerable
{
  ...
  Comment Item([In] int Index);

  [DispId(0)]
  [IndexerName("_Default")]
  Comment this[[In] int Index] { [TypeLibFunc(1024 /*0x0400*/), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
