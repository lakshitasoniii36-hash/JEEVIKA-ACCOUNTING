...
// Type: Microsoft.Office.Interop.Excel.ICustomProperties
...
[ComImport]
public interface ICustomProperties : IEnumerable
{
  [DispId(148)]
  ...
  CustomProperty Add([MarshalAs(UnmanagedType.BStr), In] string Name, [MarshalAs(UnmanagedType.Struct), In] object Value);
  ...
  CustomProperty this[[MarshalAs(UnmanagedType.Struct), In] object Index] { [TypeLibFunc(1024 /*0x0400*/), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }

  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.Interface)]
  CustomProperty get_Item([MarshalAs(UnmanagedType.Struct), In] object Index);
