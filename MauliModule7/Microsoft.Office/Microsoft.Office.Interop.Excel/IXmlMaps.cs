...
// Type: Microsoft.Office.Interop.Excel.IXmlMaps
...
[TypeLibType(4112)]
[ComImport]
public interface IXmlMaps : IEnumerable
{
  [DispId(148)]
  ...
  XmlMap Add([MarshalAs(UnmanagedType.BStr), In] string Schema, [MarshalAs(UnmanagedType.Struct), In, Optional] object RootElementName);

  [DispId(0)]
  [IndexerName("_Default")]
  XmlMap this[[MarshalAs(UnmanagedType.Struct), In] object Index] { [TypeLibFunc(1024 /*0x0400*/), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }

  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.Interface)]
  XmlMap get_Item([MarshalAs(UnmanagedType.Struct), In] object Index);
