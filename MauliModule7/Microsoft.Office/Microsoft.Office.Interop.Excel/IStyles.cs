...
// Type: Microsoft.Office.Interop.Excel.IStyles
...
public interface IStyles : IEnumerable
{
  ...
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.Interface)]
  Style get_Item([MarshalAs(UnmanagedType.Struct), In] object Index);

  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.Struct)]
  object Merge([MarshalAs(UnmanagedType.Struct), In] object Workbook);
  ...
  Style this[[MarshalAs(UnmanagedType.Struct), In] object Index] { [LCIDConversion(1), TypeLibFunc(1024 /*0x0400*/), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
}
