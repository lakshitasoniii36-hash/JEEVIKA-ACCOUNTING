...
// Type: Microsoft.Office.Interop.Excel.IErrorBars
...
public interface IErrorBars
{
  ...
  [DispId(1124)]
  XlEndStyleCap EndStyle { [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: In] set; }
