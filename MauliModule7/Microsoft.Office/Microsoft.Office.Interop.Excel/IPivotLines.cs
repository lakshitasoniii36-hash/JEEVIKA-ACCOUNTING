...
// Type: Microsoft.Office.Interop.Excel.IPivotLines
...
[TypeLibType(4112)]
[ComImport]
public interface IPivotLines : IEnumerable
{
  [DispId(148)]
  ...
  PivotLine this[[MarshalAs(UnmanagedType.Struct), In] object Index] { [TypeLibFunc(1024 /*0x0400*/), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
  ...
  PivotLine get_Item([MarshalAs(UnmanagedType.Struct), In] object Index);
