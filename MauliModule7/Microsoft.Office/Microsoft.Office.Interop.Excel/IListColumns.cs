...
// Type: Microsoft.Office.Interop.Excel.IListColumns
...
[TypeLibType(4112)]
[ComImport]
public interface IListColumns : IEnumerable
{
  [DispId(148)]
  ...
  ListColumn Add([MarshalAs(UnmanagedType.Struct), In, Optional] object Position);

  [DispId(0)]
  [IndexerName("_Default")]
  ListColumn this[[MarshalAs(UnmanagedType.Struct), In] object Index] { [TypeLibFunc(1024 /*0x0400*/), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
  ...
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.Interface)]
  ListColumn get_Item([MarshalAs(UnmanagedType.Struct), In] object Index);
