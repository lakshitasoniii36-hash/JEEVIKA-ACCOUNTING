...
// Type: Microsoft.Office.Interop.Excel.ISmartTagRecognizer
...
[TypeLibType(4112)]
[ComImport]
public interface ISmartTagRecognizer
{
  [DispId(148)]
  ...
  [DispId(289)]
  string FullName { [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.BStr)] get; }
}
