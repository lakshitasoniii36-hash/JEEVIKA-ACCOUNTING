...
// Type: Microsoft.Office.Interop.Excel.IChartGroups
...
[ComImport]
public interface IChartGroups : IEnumerable
{
  [DispId(148)]
  ...
  ChartGroup Item([MarshalAs(UnmanagedType.Struct), In] object Index);
