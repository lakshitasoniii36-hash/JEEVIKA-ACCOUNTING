...
// Type: Microsoft.Office.Interop.Excel.ISortFields
...
public interface ISortFields : IEnumerable
{
  ...
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.Interface)]
  SortField get_Item([MarshalAs(UnmanagedType.Struct), In] object Index);
  ...
  SortField this[[MarshalAs(UnmanagedType.Struct), In] object Index] { [TypeLibFunc(1024 /*0x0400*/), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
