...
// Type: Microsoft.Office.Interop.Excel.IFilters
...
[ComImport]
public interface IFilters : IEnumerable
{
  [DispId(148)]
  ...
  Filter this[[In] int Index] { [TypeLibFunc(1024 /*0x0400*/), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
