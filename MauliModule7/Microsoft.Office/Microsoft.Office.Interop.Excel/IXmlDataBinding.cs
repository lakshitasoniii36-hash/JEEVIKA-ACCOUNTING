...
// Type: Microsoft.Office.Interop.Excel.IXmlDataBinding
...
public interface IXmlDataBinding
{
  ...
  [DispId(2331)]
  string SourceUrl { [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.BStr)] get; }
}
