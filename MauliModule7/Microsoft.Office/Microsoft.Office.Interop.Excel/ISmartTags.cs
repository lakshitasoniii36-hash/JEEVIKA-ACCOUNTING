...
// Type: Microsoft.Office.Interop.Excel.ISmartTags
...
[TypeLibType(4112)]
[ComImport]
public interface ISmartTags : IEnumerable
{
  [DispId(148)]
  ...
  SmartTag Add([MarshalAs(UnmanagedType.BStr), In] string SmartTagType);
  ...
  SmartTag this[[MarshalAs(UnmanagedType.Struct), In] object Index] { [TypeLibFunc(1024 /*0x0400*/), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
