...
// Type: Microsoft.Office.Interop.Excel.ICalculatedFields
...
[TypeLibType(4112)]
[ComImport]
public interface ICalculatedFields : IEnumerable
{
  [DispId(148)]
  ...
  PivotField this[[MarshalAs(UnmanagedType.Struct), In] object Field] { [TypeLibFunc(1024 /*0x0400*/), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
