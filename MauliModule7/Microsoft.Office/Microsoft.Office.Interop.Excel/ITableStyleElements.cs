...
// Type: Microsoft.Office.Interop.Excel.ITableStyleElements
...
public interface ITableStyleElements : IEnumerable
{
  ...
  TableStyleElement this[[In] XlTableStyleElementType Index] { [TypeLibFunc(1024 /*0x0400*/), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
