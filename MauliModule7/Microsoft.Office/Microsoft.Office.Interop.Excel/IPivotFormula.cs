...
// Type: Microsoft.Office.Interop.Excel.IPivotFormula
...
public interface IPivotFormula
{
  ...
  [DispId(486)]
  int Index { [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: In] set; }
