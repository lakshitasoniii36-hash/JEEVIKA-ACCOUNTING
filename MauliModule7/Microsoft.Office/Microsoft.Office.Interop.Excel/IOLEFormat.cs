...
// Type: Microsoft.Office.Interop.Excel.IOLEFormat
...
public interface IOLEFormat
{
  ...
  [DispId(1049)]
  object Object { [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.IDispatch)] get; }
  ...
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  void Verb([MarshalAs(UnmanagedType.Struct), In, Optional] object Verb);
}
