...
// Type: Microsoft.Office.Interop.Excel.IActions
...
[TypeLibType(4112)]
[ComImport]
public interface IActions : IEnumerable
{
  [DispId(148)]
  ...
  Action this[[MarshalAs(UnmanagedType.Struct), In] object Index] { [TypeLibFunc(1024 /*0x0400*/), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
  ...
  Action get_Item([MarshalAs(UnmanagedType.Struct), In] object Index);
