...
// Type: Microsoft.Office.Interop.Excel.IScenario
...
public interface IScenario
{
  ...
  object ChangeScenario([MarshalAs(UnmanagedType.Struct), In] object ChangingCells, [MarshalAs(UnmanagedType.Struct), In, Optional] object Values);

  [DispId(911)]
  Range ChangingCells { [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
  ...
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.Struct)]
  object get_Values([MarshalAs(UnmanagedType.Struct), In, Optional] object Index);
}
