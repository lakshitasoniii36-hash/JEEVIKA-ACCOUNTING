...
// Type: CrystalDecisions.ReportAppServer.Prompting.ILOVContexts
...
[TypeLibType(4688)]
[ComImport]
public interface ILOVContexts
{
  [DispId(0)]
  LOVContext this[[In] int Index] { [DispId(0), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; [DispId(0), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: MarshalAs(UnmanagedType.Interface), In] set; }
  ...
  void Add([MarshalAs(UnmanagedType.Interface), In] LOVContext Context);
  ...
  [DispId(1013)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  void Insert([In] int Index, [MarshalAs(UnmanagedType.Interface), In] LOVContext Context);
