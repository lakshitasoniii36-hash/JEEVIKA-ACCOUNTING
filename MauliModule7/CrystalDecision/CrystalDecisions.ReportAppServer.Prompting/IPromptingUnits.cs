...
// Type: CrystalDecisions.ReportAppServer.Prompting.IPromptingUnits
...
[Guid("3AD8DBFF-C584-4124-81F6-9FF395AC3B8B")]
[TypeLibType(4688)]
[ComImport]
public interface IPromptingUnits
{
  [DispId(0)]
  PromptingUnit this[[In] int Index] { [DispId(0), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; [DispId(0), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: MarshalAs(UnmanagedType.Interface), In] set; }
  ...
  void Add([MarshalAs(UnmanagedType.Interface), In] PromptingUnit unit);
  ...
  [DispId(1013)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  void Insert([In] int Index, [MarshalAs(UnmanagedType.Interface), In] PromptingUnit unit);
  ...
  PromptingUnit Find([MarshalAs(UnmanagedType.BStr), In] string Name, [MarshalAs(UnmanagedType.BStr), In] string PromptGroupRef);
