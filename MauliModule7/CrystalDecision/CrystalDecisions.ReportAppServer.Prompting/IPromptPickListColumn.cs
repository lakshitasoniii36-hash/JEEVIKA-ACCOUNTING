...
// Type: CrystalDecisions.ReportAppServer.Prompting.IPromptPickListColumn
...
[Guid("33D57FD9-6ABE-43EA-9CC5-2898E51A6C21")]
[TypeLibType(4688)]
[ComImport]
public interface IPromptPickListColumn
{
  ...
  PromptPickListColumn Clone([In] bool DeepClone = true);

  [DispId(1002)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  void CopyTo([MarshalAs(UnmanagedType.Interface), In] PromptPickListColumn column, [In] bool DeepCopy = true);

  [DispId(1003)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  bool Equals([MarshalAs(UnmanagedType.Interface), In] PromptPickListColumn column);
