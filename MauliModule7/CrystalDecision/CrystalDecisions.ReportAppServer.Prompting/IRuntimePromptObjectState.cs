...
// Type: CrystalDecisions.ReportAppServer.Prompting.IRuntimePromptObjectState
...
[TypeLibType(4688)]
[Guid("1289EA15-0C72-4099-98C7-31B2D6C222C9")]
[ComImport]
public interface IRuntimePromptObjectState
{
  [DispId(1)]
  ...
  [DispId(2)]
  LOVContexts ValueContexts { [DispId(2), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; [DispId(2), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: MarshalAs(UnmanagedType.Interface), In] set; }

  [DispId(4)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  bool IsSameID([MarshalAs(UnmanagedType.BStr), In] string ID);
}
