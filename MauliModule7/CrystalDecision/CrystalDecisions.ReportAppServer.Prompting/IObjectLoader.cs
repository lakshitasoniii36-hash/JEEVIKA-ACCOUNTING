...
// Type: CrystalDecisions.ReportAppServer.Prompting.IObjectLoader
...
[TypeLibType(4688)]
[Guid("2B41D6D7-6291-4CAD-97DE-C55A8C04656D")]
[ComImport]
public interface IObjectLoader
{
  ...
  object load([MarshalAs(UnmanagedType.BStr), In] string objRef, [MarshalAs(UnmanagedType.BStr), In] string objType);
  ...
  string getProtocol([In] int Index);
