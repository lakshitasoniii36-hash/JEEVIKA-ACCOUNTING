...
// Type: CrystalDecisions.ReportAppServer.Prompting.ILOVFields
...
[Guid("750261A6-76BA-4ACB-9C80-8678BB60AF7E")]
[TypeLibType(4688)]
[ComImport]
public interface ILOVFields
{
  [DispId(0)]
  LOVField this[[In] int Index] { [DispId(0), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; [DispId(0), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: MarshalAs(UnmanagedType.Interface), In] set; }
  ...
  void Add([MarshalAs(UnmanagedType.Interface), In] LOVField Field);
  ...
  [DispId(1013)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  void Insert([In] int Index, [MarshalAs(UnmanagedType.Interface), In] LOVField Field);
  ...
  LOVFields Clone([In] bool DeepClone = true);

  [DispId(1002)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  void CopyTo([MarshalAs(UnmanagedType.Interface), In] LOVFields LOVFields, [In] bool DeepCopy = true);

  [DispId(1003)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  bool Equals([MarshalAs(UnmanagedType.Interface), In] LOVFields LOVFields);
