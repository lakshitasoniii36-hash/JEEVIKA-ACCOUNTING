...
// Type: CrystalDecisions.ReportAppServer.Prompting.ILOVContext
...
[TypeLibType(4688)]
[Guid("913A2FC4-94B4-4730-A5B2-9217C8F634DA")]
[ComImport]
public interface ILOVContext
{
  [DispId(1)]
  ...
  LOVNode get_Node([In] int Index);

  [DispId(2)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  void set_Node([In] int Index, [MarshalAs(UnmanagedType.Interface), In] LOVNode Node);

  [DispId(3)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  void AddNode([MarshalAs(UnmanagedType.Interface), In] LOVNode Node);

  [DispId(4)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  void InsertNode([In] int Index, [MarshalAs(UnmanagedType.Interface), In] LOVNode Node);

  [DispId(5)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  void RemoveNode([In] int Index);
