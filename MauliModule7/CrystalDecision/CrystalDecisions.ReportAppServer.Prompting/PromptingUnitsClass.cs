...
// Type: CrystalDecisions.ReportAppServer.Prompting.PromptingUnitsClass
...
[TypeLibType(530)]
[ClassInterface(0)]
[Guid("F255376D-E560-426F-9957-46C09612A247")]
[ComImport]
public class PromptingUnitsClass : IPromptingUnits, PromptingUnits
{
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  public extern PromptingUnitsClass();

  [DispId(0)]
  public virtual extern PromptingUnit this[[In] int Index] { [DispId(0), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; [DispId(0), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: MarshalAs(UnmanagedType.Interface), In] set; }
  ...
  [DispId(1011)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  public virtual extern void Add([MarshalAs(UnmanagedType.Interface), In] PromptingUnit unit);
  ...
  [DispId(1013)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  public virtual extern void Insert([In] int Index, [MarshalAs(UnmanagedType.Interface), In] PromptingUnit unit);
  ...
  public virtual extern PromptingUnit Find([MarshalAs(UnmanagedType.BStr), In] string Name, [MarshalAs(UnmanagedType.BStr), In] string PromptGroupRef);
