...
// Type: CrystalDecisions.ReportAppServer.Prompting.CRPromptingInfoProviderFactoryClass
...
[TypeLibType(530)]
[ClassInterface(0)]
[Guid("3F174429-7B8D-4970-AB67-469577554628")]
[ComImport]
public class CRPromptingInfoProviderFactoryClass : 
  ICRPromptingInfoProviderFactory,
  CRPromptingInfoProviderFactory
{
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  public extern CRPromptingInfoProviderFactoryClass();

  [DispId(1)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.Interface)]
  public virtual extern CRPromptingInfoProvider createInfoProvider(
  ...
  [DispId(2)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  public virtual extern void setEnterpriseToken(
    [MarshalAs(UnmanagedType.Interface), In] CRPromptingInfoProvider infoProvider,
    [MarshalAs(UnmanagedType.BStr), In] string EnterpriseToken);
