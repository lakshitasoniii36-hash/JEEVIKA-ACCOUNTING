...
// Type: CrystalDecisions.ReportAppServer.Prompting.ICRParameterInstances
...
[Guid("3D31CED5-9E70-4757-90C2-11FD258CA969")]
[TypeLibType(4688)]
[ComImport]
public interface ICRParameterInstances
{
  [DispId(0)]
  CRParameterInstance this[[In] int Index] { [DispId(0), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; [DispId(0), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: MarshalAs(UnmanagedType.Interface), In] set; }
  ...
  void Add([MarshalAs(UnmanagedType.Interface), In] CRParameterInstance instance);
  ...
  [DispId(1013)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  void Insert([In] int Index, [MarshalAs(UnmanagedType.Interface), In] CRParameterInstance instance);
