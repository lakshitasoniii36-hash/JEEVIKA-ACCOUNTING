...
// Type: CrystalDecisions.ReportAppServer.Prompting.ILOVDataSources
...
[Guid("590313D5-96B0-45E9-8278-A0831F49DB36")]
[TypeLibType(4688)]
[ComImport]
public interface ILOVDataSources
{
  [DispId(0)]
  ILOVDataSource this[[In] int Index] { [DispId(0), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; [DispId(0), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: MarshalAs(UnmanagedType.Interface), In] set; }
  ...
  void Add([MarshalAs(UnmanagedType.Interface), In] ILOVDataSource lovDS);
  ...
  [DispId(1013)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  void Insert([In] int Index, [MarshalAs(UnmanagedType.Interface), In] ILOVDataSource lovDS);
