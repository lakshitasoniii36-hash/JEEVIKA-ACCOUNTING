...
// Type: CrystalDecisions.ReportAppServer.Prompting.IPromptingOption
...
[TypeLibType(4688)]
[Guid("079BCA87-A128-4DE4-BA69-075EA009B52B")]
[ComImport]
public interface IPromptingOption
{
  [DispId(1)]
  IPromptingRenderOption RenderOption { [DispId(1), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; [DispId(1), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: MarshalAs(UnmanagedType.Interface), In] set; }
