...
// Type: Microsoft.Vbe.Interop._dispCommandBarControlEvents_EventProvider
...
internal sealed class _dispCommandBarControlEvents_EventProvider : 
  ...
  IDisposable
{
    ...
    [In] _dispCommandBarControlEvents_ClickEventHandler obj0)
  {
    ...
    try
    {
      if (this.m_ConnectionPoint == null)
        this.Init();
      _dispCommandBarControlEvents_SinkHelper pUnkSink = new _dispCommandBarControlEvents_SinkHelper();
      int pdwCookie = 0;
  ...
  public virtual void remove_Click(
    [In] _dispCommandBarControlEvents_ClickEventHandler obj0)
  {
    Monitor.Enter((object) this);
    try
    {
      ...
      do
      {
        _dispCommandBarControlEvents_SinkHelper aEventSinkHelper = (_dispCommandBarControlEvents_SinkHelper) this.m_aEventSinkHelpers[index];
...
label_9:;
  ...
  public _dispCommandBarControlEvents_EventProvider([In] object obj0)
  {
  ...
  public override void Finalize()
  {
    ...
    try
    {
      ...
      if (0 < count)
      {
        do
        {
          this.m_ConnectionPoint.Unadvise(((_dispCommandBarControlEvents_SinkHelper) this.m_aEventSinkHelpers[index]).m_dwCookie);
          ++index;
        }
        while (index < count);
      }
