...
[TypeLibType(4288)]
[ComImport]
public interface Users : _Collection
{
  ...
  [DispId(0)]
  User this[[MarshalAs(UnmanagedType.Struct), In] object Item] { [DispId(0), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }

  [DispId(1610809345 /*0x60030001*/)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  void Append([MarshalAs(UnmanagedType.Struct), In] object Item, [MarshalAs(UnmanagedType.BStr), In] string Password = "");
