...
[TypeLibType(4288)]
[ComImport]
public interface Groups : _Collection
{
  ...
  [DispId(0)]
  Group this[[MarshalAs(UnmanagedType.Struct), In] object Item] { [DispId(0), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
