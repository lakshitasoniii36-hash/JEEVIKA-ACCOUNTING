...
[TypeLibType(4288)]
[ComImport]
public interface Keys : _Collection
{
  ...
  [DispId(0)]
  Key this[[MarshalAs(UnmanagedType.Struct), In] object Item] { [DispId(0), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }

  [DispId(1610809345 /*0x60030001*/)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  void Append(
    [MarshalAs(UnmanagedType.Struct), In] object Item,
    [In] KeyTypeEnum Type = KeyTypeEnum.adKeyPrimary,
    [MarshalAs(UnmanagedType.Struct), In, Optional] object Column,
    [MarshalAs(UnmanagedType.BStr), In] string RelatedTable = "",
    [MarshalAs(UnmanagedType.BStr), In] string RelatedColumn = "");
