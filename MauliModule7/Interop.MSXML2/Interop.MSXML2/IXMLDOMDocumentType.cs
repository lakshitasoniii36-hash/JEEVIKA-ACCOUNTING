...
// Type: MSXML2.IXMLDOMDocumentType
...
public interface IXMLDOMDocumentType : IXMLDOMNode
{
  ...
  [DispId(131)]
  string name { [DispId(131), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.BStr)] get; }

  [DispId(132)]
  IXMLDOMNamedNodeMap entities { [DispId(132), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }

  [DispId(133)]
  IXMLDOMNamedNodeMap notations { [DispId(133), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
}
