...
public interface IXTLRuntime : IXMLDOMNode
{
  ...
  [DispId(187)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  int uniqueID([MarshalAs(UnmanagedType.Interface), In] IXMLDOMNode pNode);

  [DispId(188)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  int depth([MarshalAs(UnmanagedType.Interface), In] IXMLDOMNode pNode);

  [DispId(189)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  int childNumber([MarshalAs(UnmanagedType.Interface), In] IXMLDOMNode pNode);

  [DispId(190)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  int ancestorChildNumber([MarshalAs(UnmanagedType.BStr), In] string bstrNodeName, [MarshalAs(UnmanagedType.Interface), In] IXMLDOMNode pNode);

  [DispId(191)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  int absoluteChildNumber([MarshalAs(UnmanagedType.Interface), In] IXMLDOMNode pNode);

  [DispId(192 /*0xC0*/)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.BStr)]
  string formatIndex([In] int lIndex, [MarshalAs(UnmanagedType.BStr), In] string bstrFormat);

  [DispId(193)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.BStr)]
  string formatNumber([In] double dblNumber, [MarshalAs(UnmanagedType.BStr), In] string bstrFormat);

  [DispId(194)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.BStr)]
  string formatDate([MarshalAs(UnmanagedType.Struct), In] object varDate, [MarshalAs(UnmanagedType.BStr), In] string bstrFormat, [MarshalAs(UnmanagedType.Struct), In, Optional] object varDestLocale);

  [DispId(195)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.BStr)]
  string formatTime([MarshalAs(UnmanagedType.Struct), In] object varTime, [MarshalAs(UnmanagedType.BStr), In] string bstrFormat, [MarshalAs(UnmanagedType.Struct), In, Optional] object varDestLocale);
}
