...
// Type: MSXML2.IXMLDOMCDATASection
...
public interface IXMLDOMCDATASection : IXMLDOMText
{
  ...
  [DispId(109)]
  new string data { [DispId(109), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.BStr)] get; [DispId(109), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: MarshalAs(UnmanagedType.BStr), In] set; }

  [DispId(110)]
  new int length { [DispId(110), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }
  ...
  [DispId(112 /*0x70*/)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  new void appendData([MarshalAs(UnmanagedType.BStr), In] string data);

  [DispId(113)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  new void insertData([In] int offset, [MarshalAs(UnmanagedType.BStr), In] string data);
  ...
  [DispId(115)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  new void replaceData([In] int offset, [In] int count, [MarshalAs(UnmanagedType.BStr), In] string data);
