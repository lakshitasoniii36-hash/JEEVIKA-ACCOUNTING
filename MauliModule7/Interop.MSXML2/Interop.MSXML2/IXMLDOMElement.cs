...
public interface IXMLDOMElement : IXMLDOMNode
{
  ...
  [DispId(97)]
  string tagName { [DispId(97), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.BStr)] get; }
  ...
  [DispId(100)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  void setAttribute([MarshalAs(UnmanagedType.BStr), In] string name, [MarshalAs(UnmanagedType.Struct), In] object value);

  [DispId(101)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  void removeAttribute([MarshalAs(UnmanagedType.BStr), In] string name);

  [DispId(102)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.Interface)]
  IXMLDOMAttribute getAttributeNode([MarshalAs(UnmanagedType.BStr), In] string name);

  [DispId(103)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.Interface)]
  IXMLDOMAttribute setAttributeNode([MarshalAs(UnmanagedType.Interface), In] IXMLDOMAttribute DOMAttribute);

  [DispId(104)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.Interface)]
  IXMLDOMAttribute removeAttributeNode([MarshalAs(UnmanagedType.Interface), In] IXMLDOMAttribute DOMAttribute);
