...
public interface ISchemaParticle : ISchemaItem
{
  ...
  [DispId(1455)]
  object minOccurs { [DispId(1455), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Struct)] get; }

  [DispId(1451)]
  object maxOccurs { [DispId(1451), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Struct)] get; }
}
