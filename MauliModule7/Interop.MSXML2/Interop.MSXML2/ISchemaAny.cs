...
public interface ISchemaAny : ISchemaParticle
{
  ...
  [DispId(1458)]
  ISchemaStringCollection namespaces { [DispId(1458), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }

  [ComAliasName("MSXML2.SCHEMAPROCESSCONTENTS")]
  [DispId(1463)]
  SCHEMAPROCESSCONTENTS processContents { [DispId(1463), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: ComAliasName("MSXML2.SCHEMAPROCESSCONTENTS")] get; }
}
