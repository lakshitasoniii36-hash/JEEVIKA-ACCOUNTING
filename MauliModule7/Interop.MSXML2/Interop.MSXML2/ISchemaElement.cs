...
public interface ISchemaElement : ISchemaParticle
{
  ...
  [DispId(1455)]
  new object minOccurs { [DispId(1455), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Struct)] get; }

  [DispId(1451)]
  new object maxOccurs { [DispId(1451), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Struct)] get; }
  ...
  [DispId(1443)]
  bool isNillable { [DispId(1443), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }

  [DispId(1441)]
  ISchemaItemCollection identityConstraints { [DispId(1441), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }

  [DispId(1471)]
  ISchemaElement substitutionGroup { [DispId(1471), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }

  [ComAliasName("MSXML2.SCHEMADERIVATIONMETHOD")]
  [DispId(1472)]
  SCHEMADERIVATIONMETHOD substitutionGroupExclusions { [DispId(1472), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: ComAliasName("MSXML2.SCHEMADERIVATIONMETHOD")] get; }

  [ComAliasName("MSXML2.SCHEMADERIVATIONMETHOD")]
  [DispId(1433)]
  SCHEMADERIVATIONMETHOD disallowedSubstitutions { [DispId(1433), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: ComAliasName("MSXML2.SCHEMADERIVATIONMETHOD")] get; }
