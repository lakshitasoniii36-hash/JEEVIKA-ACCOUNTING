...
// Type: MSXML2.IXMLDOMCharacterData
...
public interface IXMLDOMCharacterData : IXMLDOMNode
{
  ...
  [DispId(109)]
  string data { [DispId(109), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.BStr)] get; [DispId(109), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: MarshalAs(UnmanagedType.BStr), In] set; }

  [DispId(110)]
  int length { [DispId(110), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }
  ...
  [DispId(112 /*0x70*/)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  void appendData([MarshalAs(UnmanagedType.BStr), In] string data);

  [DispId(113)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  void insertData([In] int offset, [MarshalAs(UnmanagedType.BStr), In] string data);
  ...
  [DispId(115)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  void replaceData([In] int offset, [In] int count, [MarshalAs(UnmanagedType.BStr), In] string data);
}
