...
public interface ISchemaModelGroup : ISchemaParticle
{
  ...
  [DispId(1461)]
  ISchemaItemCollection particles { [DispId(1461), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
}
