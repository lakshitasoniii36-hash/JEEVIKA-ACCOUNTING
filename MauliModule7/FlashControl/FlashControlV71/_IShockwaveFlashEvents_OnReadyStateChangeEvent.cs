...
// Type: FlashControlV71._IShockwaveFlashEvents_OnReadyStateChangeEvent
...
public class _IShockwaveFlashEvents_OnReadyStateChangeEvent
{
  ...
  public _IShockwaveFlashEvents_OnReadyStateChangeEvent(int newState) => this.newState = newState;
}
