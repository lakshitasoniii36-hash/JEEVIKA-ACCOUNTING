...
// Type: MauliModule7.CReportBillFullPageWithReceipt14HeadNew1SR
...
public class CReportBillFullPageWithReceipt14HeadNew1SR : ReportClass
{
  private static List<WeakReference> __ENCList = new List<WeakReference>();

  [DebuggerNonUserCode]
  static CReportBillFullPageWithReceipt14HeadNew1SR()
  {
  }
  ...
  {
    lock (CReportBillFullPageWithReceipt14HeadNew1SR.__ENCList)
    {
      if (CReportBillFullPageWithReceipt14HeadNew1SR.__ENCList.Count == CReportBillFullPageWithReceipt14HeadNew1SR.__ENCList.Capacity)
      {
        int index1 = 0;
        int num = checked (CReportBillFullPageWithReceipt14HeadNew1SR.__ENCList.Count - 1);
        int index2 = 0;
        while (index2 <= num)
        {
          if (CReportBillFullPageWithReceipt14HeadNew1SR.__ENCList[index2].IsAlive)
          {
            if (index2 != index1)
              CReportBillFullPageWithReceipt14HeadNew1SR.__ENCList[index1] = CReportBillFullPageWithReceipt14HeadNew1SR.__ENCList[index2];
            checked { ++index1; }
          }
          checked { ++index2; }
        }
        CReportBillFullPageWithReceipt14HeadNew1SR.__ENCList.RemoveRange(index1, checked (CReportBillFullPageWithReceipt14HeadNew1SR.__ENCList.Count - index1));
        CReportBillFullPageWithReceipt14HeadNew1SR.__ENCList.Capacity = CReportBillFullPageWithReceipt14HeadNew1SR.__ENCList.Count;
      }
      CReportBillFullPageWithReceipt14HeadNew1SR.__ENCList.Add(new WeakReference(RuntimeHelpers.GetObjectValue(value)));
    }
  }

  public CReportBillFullPageWithReceipt14HeadNew1SR()
  {
    CReportBillFullPageWithReceipt14HeadNew1SR.__ENCAddToList((object) this);
  }

  public override string ResourceName
  {
    get => "CReportBillFullPageWithReceipt14HeadNew1SR.rpt";
    set
    {
    }
  }
  ...
  {
    get => "MauliModule7.CReportBillFullPageWithReceipt14HeadNew1SR.rpt";
    set
    {
    }
  }
