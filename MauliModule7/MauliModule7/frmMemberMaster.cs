...
// Type: MauliModule7.frmMemberMaster
...
[DesignerGenerated]
public class frmMemberMaster : Form
{
  ...
  {
    this.Load += new EventHandler(this.frmMemberMaster_Load);
    frmMemberMaster.__ENCAddToList((object) this);
  ...
  {
    lock (frmMemberMaster.__ENCList)
    {
      if (frmMemberMaster.__ENCList.Count == frmMemberMaster.__ENCList.Capacity)
      {
        int index1 = 0;
        int num = checked (frmMemberMaster.__ENCList.Count - 1);
        int index2 = 0;
        while (index2 <= num)
        {
          if (frmMemberMaster.__ENCList[index2].IsAlive)
          {
            if (index2 != index1)
              frmMemberMaster.__ENCList[index1] = frmMemberMaster.__ENCList[index2];
            checked { ++index1; }
          }
          checked { ++index2; }
        }
        frmMemberMaster.__ENCList.RemoveRange(index1, checked (frmMemberMaster.__ENCList.Count - index1));
        frmMemberMaster.__ENCList.Capacity = frmMemberMaster.__ENCList.Count;
      }
      frmMemberMaster.__ENCList.Add(new WeakReference(RuntimeHelpers.GetObjectValue(value)));
    }
  }
  ...
  internal virtual DataGridView DataGridView3
  {
    ...
    [DebuggerNonUserCode, MethodImpl(MethodImplOptions.Synchronized)] set
    {
      ...
      DataGridViewCellEventHandler cellEventHandler = new DataGridViewCellEventHandler(this.DataGridView3_CellEndEdit);
      if (this._DataGridView3 != null)
      {
        this._DataGridView3.CellValidating -= validatingEventHandler;
        this._DataGridView3.CellEndEdit -= cellEventHandler;
      }
  ...
  public DataSet GetFillGrid()
  {
    ...
    if (MyProject.Forms.frmMemberMasterSelected.CheckBox1.Checked)
      this.DataGridView3.Columns[8].Visible = true;
    if (MyProject.Forms.frmMemberMasterSelected.CheckBox2.Checked)
