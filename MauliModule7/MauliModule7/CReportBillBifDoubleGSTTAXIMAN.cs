...
// Type: MauliModule7.CReportBillBifDoubleGSTTAXIMAN
...
public class CReportBillBifDoubleGSTTAXIMAN : ReportClass
{
  private static List<WeakReference> __ENCList = new List<WeakReference>();

  [DebuggerNonUserCode]
  static CReportBillBifDoubleGSTTAXIMAN()
  {
  }
  ...
  {
    lock (CReportBillBifDoubleGSTTAXIMAN.__ENCList)
    {
      if (CReportBillBifDoubleGSTTAXIMAN.__ENCList.Count == CReportBillBifDoubleGSTTAXIMAN.__ENCList.Capacity)
      {
        int index1 = 0;
        int num = checked (CReportBillBifDoubleGSTTAXIMAN.__ENCList.Count - 1);
        int index2 = 0;
        while (index2 <= num)
        {
          if (CReportBillBifDoubleGSTTAXIMAN.__ENCList[index2].IsAlive)
          {
            if (index2 != index1)
              CReportBillBifDoubleGSTTAXIMAN.__ENCList[index1] = CReportBillBifDoubleGSTTAXIMAN.__ENCList[index2];
            checked { ++index1; }
          }
          checked { ++index2; }
        }
        CReportBillBifDoubleGSTTAXIMAN.__ENCList.RemoveRange(index1, checked (CReportBillBifDoubleGSTTAXIMAN.__ENCList.Count - index1));
        CReportBillBifDoubleGSTTAXIMAN.__ENCList.Capacity = CReportBillBifDoubleGSTTAXIMAN.__ENCList.Count;
      }
      CReportBillBifDoubleGSTTAXIMAN.__ENCList.Add(new WeakReference(RuntimeHelpers.GetObjectValue(value)));
    }
  }

  public CReportBillBifDoubleGSTTAXIMAN()
  {
    CReportBillBifDoubleGSTTAXIMAN.__ENCAddToList((object) this);
  }

  public override string ResourceName
  {
    get => "CReportBillBifDoubleGSTTAXIMAN.rpt";
    set
    {
    }
  }
  ...
  {
    get => "MauliModule7.CReportBillBifDoubleGSTTAXIMAN.rpt";
    set
    {
    }
  }
  ...
  [Browsable(false)]
  [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
  public IParameterField Parameter_t21 => (IParameterField) this.DataDefinition.ParameterFields[29];

  [Browsable(false)]
  [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
  public IParameterField Parameter_t22 => (IParameterField) this.DataDefinition.ParameterFields[30];
}
