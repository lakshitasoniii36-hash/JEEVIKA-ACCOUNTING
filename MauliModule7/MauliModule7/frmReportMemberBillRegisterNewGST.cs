...
// Type: MauliModule7.frmReportMemberBillRegisterNewGST
...
[DesignerGenerated]
public class frmReportMemberBillRegisterNewGST : Form
{
  ...
  [AccessedThroughProperty("grpExport")]
  ...
  [DebuggerNonUserCode]
  static frmReportMemberBillRegisterNewGST()
  {
  }

  [DebuggerNonUserCode]
  public frmReportMemberBillRegisterNewGST()
  {
    this.KeyDown += new KeyEventHandler(this.frmReportMemberBillRegisterNewGST_KeyDown);
    this.Load += new EventHandler(this.frmReportMemberBillRegisterNewGST_Load);
    frmReportMemberBillRegisterNewGST.__ENCAddToList((object) this);
  ...
  {
    lock (frmReportMemberBillRegisterNewGST.__ENCList)
    {
      if (frmReportMemberBillRegisterNewGST.__ENCList.Count == frmReportMemberBillRegisterNewGST.__ENCList.Capacity)
      {
        int index1 = 0;
        int num = checked (frmReportMemberBillRegisterNewGST.__ENCList.Count - 1);
        int index2 = 0;
        while (index2 <= num)
        {
          if (frmReportMemberBillRegisterNewGST.__ENCList[index2].IsAlive)
          {
            if (index2 != index1)
              frmReportMemberBillRegisterNewGST.__ENCList[index1] = frmReportMemberBillRegisterNewGST.__ENCList[index2];
            checked { ++index1; }
          }
          checked { ++index2; }
        }
        frmReportMemberBillRegisterNewGST.__ENCList.RemoveRange(index1, checked (frmReportMemberBillRegisterNewGST.__ENCList.Count - index1));
        frmReportMemberBillRegisterNewGST.__ENCList.Capacity = frmReportMemberBillRegisterNewGST.__ENCList.Count;
      }
      frmReportMemberBillRegisterNewGST.__ENCList.Add(new WeakReference(RuntimeHelpers.GetObjectValue(value)));
    }
  }
  ...
  {
    ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (frmReportMemberBillRegisterNewGST));
    ...
    point1 = new System.Drawing.Point(22, 19);
    ...
    point1 = new System.Drawing.Point(89, 11);
    ...
    point1 = new System.Drawing.Point(14, 207);
    ...
    mtxtDateFrom1.Location = point16;
    ...
    txtMemCodeFrom1.Location = point22;
    ...
    lblMemNameFrom1.Location = point32;
    ...
    point1 = new System.Drawing.Point(17, 11);
    ...
    point1 = new System.Drawing.Point(17, 147);
    System.Drawing.Point point46 = point1;
    btnPrintRegister1.Location = point46;
    ...
    this.grpVisible.Controls.Add((Control) this.grpPrint);
    this.grpVisible.Controls.Add((Control) this.lblType);
    this.grpVisible.Controls.Add((Control) this.grpSearch);
    ...
    point1 = new System.Drawing.Point(809, 311);
    System.Drawing.Point point53 = point1;
    grpVisible1.Location = point53;
    this.grpVisible.Name = "grpVisible";
    System.Windows.Forms.GroupBox grpVisible2 = this.grpVisible;
    size1 = new Size(171, 63 /*0x3F*/);
    Size size53 = size1;
    grpVisible2.Size = size53;
    ...
    point1 = new System.Drawing.Point(74, 41);
    System.Drawing.Point point54 = point1;
    dataGridView10_1.Location = point54;
    this.DataGridView10.Name = "DataGridView10";
    DataGridView dataGridView10_2 = this.DataGridView10;
    size1 = new Size(14, 10);
    Size size54 = size1;
    dataGridView10_2.Size = size54;
    this.DataGridView10.TabIndex = 105;
    ...
    point1 = new System.Drawing.Point(99, 44);
    System.Drawing.Point point55 = point1;
    dataGridView11_1.Location = point55;
    this.DataGridView11.Name = "DataGridView11";
    DataGridView dataGridView11_2 = this.DataGridView11;
    size1 = new Size(11, 15);
    Size size55 = size1;
    dataGridView11_2.Size = size55;
    this.DataGridView11.TabIndex = 106;
    ...
    dataGridView7_1.Location = point56;
    this.DataGridView7.Name = "DataGridView7";
    DataGridView dataGridView7_2 = this.DataGridView7;
    size1 = new Size(10, 10);
    Size size56 = size1;
    dataGridView7_2.Size = size56;
    ...
    dataGridView8_1.Location = point57;
    this.DataGridView8.Name = "DataGridView8";
    DataGridView dataGridView8_2 = this.DataGridView8;
    size1 = new Size(10, 10);
    Size size57 = size1;
    dataGridView8_2.Size = size57;
    ...
    dataGridView6_1.Location = point58;
    this.DataGridView6.Name = "DataGridView6";
    DataGridView dataGridView6_2 = this.DataGridView6;
    size1 = new Size(10, 10);
    Size size58 = size1;
    dataGridView6_2.Size = size58;
    ...
    dataGridView9_1.Location = point60;
    this.DataGridView9.Name = "DataGridView9";
    DataGridView dataGridView9_2 = this.DataGridView9;
    size1 = new Size(805, 576);
    Size size60 = size1;
    dataGridView9_2.Size = size60;
    this.DataGridView9.TabIndex = 102;
    System.Windows.Forms.Button btnExport1 = this.btnExport;
    point1 = new System.Drawing.Point(38, 21);
    System.Drawing.Point point61 = point1;
    btnExport1.Location = point61;
    this.btnExport.Name = "btnExport";
    System.Windows.Forms.Button btnExport2 = this.btnExport;
    size1 = new Size(100, 39);
    Size size61 = size1;
    btnExport2.Size = size61;
    this.btnExport.TabIndex = 103;
    this.btnExport.Text = "&Export to Excel";
    this.btnExport.UseVisualStyleBackColor = true;
    this.grpExport.Controls.Add((Control) this.btnExport);
    this.grpExport.Controls.Add((Control) this.btnCancel);
    System.Windows.Forms.GroupBox grpExport1 = this.grpExport;
    point1 = new System.Drawing.Point(809, 395);
    System.Drawing.Point point62 = point1;
    grpExport1.Location = point62;
    this.grpExport.Name = "grpExport";
    System.Windows.Forms.GroupBox grpExport2 = this.grpExport;
    size1 = new Size(171, 117);
    Size size62 = size1;
    grpExport2.Size = size62;
    this.grpExport.TabIndex = 104;
    this.grpExport.TabStop = false;
    this.grpExport.Text = "GroupBox4";
    this.AutoScaleDimensions = new SizeF(6f, 13f);
    this.AutoScaleMode = AutoScaleMode.Font;
    size1 = new Size(992, 573);
    this.ClientSize = size1;
    this.Controls.Add((Control) this.grpExport);
    ...
    this.Name = nameof (frmReportMemberBillRegisterNewGST);
  ...
  internal virtual System.Windows.Forms.GroupBox grpExport
  {
    [DebuggerNonUserCode] get => this._grpExport;
    [DebuggerNonUserCode, MethodImpl(MethodImplOptions.Synchronized)] set
    {
      this._grpExport = value;
    }
  }
  ...
  private void frmReportMemberBillRegisterNewGST_KeyDown(object sender, KeyEventArgs e)
  {
  ...
  private void frmReportMemberBillRegisterNewGST_Load(object sender, EventArgs e)
  {
  ...
  public DataSet GetFillGrid()
  {
    ...
    selectConnection.Close();
    OleDbDataAdapter oleDbDataAdapter6 = new OleDbDataAdapter("SELECT SocBillSetting.SocBSAccId, SocBillSetting.SocAccountMainId, SocBillSetting.AccIndex, SocBillSetting.AccShortName, SocBillSetting.IsGST, SocBillSetting.IsGSTLimit FROM SocBillSetting ORDER BY SocBillSetting.AccIndex", selectConnection);
    ...
    selectConnection.Close();
    OleDbDataAdapter oleDbDataAdapter7 = new OleDbDataAdapter("SELECT * FROM SocInfo", selectConnection);
    System.Data.DataTable dataTable5 = new System.Data.DataTable("SocInfo");
    oleDbDataAdapter7.Fill(dataTable5);
    this.DataGridView11.DataSource = (object) dataTable5;
    ...
    this.DataGridView4.ColumnCount = 42;
    this.DataGridView5.ReadOnly = true;
    this.DataGridView5.RowHeadersVisible = false;
    this.DataGridView5.AllowUserToAddRows = false;
    this.DataGridView5.RowCount = 0;
    this.DataGridView5.ColumnCount = 42;
    ...
    this.DataGridView5.Columns[5].HeaderText = "GST No.";
    this.DataGridView5.Columns[6].HeaderText = "Period";
    int num1 = checked (this.DataGridView6.RowCount - 1);
    int index1 = 0;
    while (index1 <= num1)
    {
      this.DataGridView5.Columns[checked (index1 + 7)].HeaderText = Conversions.ToString(this.DataGridView6.Rows[index1].Cells[3].Value);
      this.DataGridView5.Columns[checked (index1 + 7)].DefaultCellStyle.Format = "N2";
      this.DataGridView5.Columns[checked (index1 + 7)].ValueType = typeof (double);
      this.DataGridView5.Columns[checked (index1 + 7)].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
      checked { ++index1; }
    }
    this.DataGridView5.Columns[checked (7 + this.DataGridView6.RowCount)].HeaderText = "Priniciple";
    this.DataGridView5.Columns[checked (8 + this.DataGridView6.RowCount)].HeaderText = "Interest";
    this.DataGridView5.Columns[checked (9 + this.DataGridView6.RowCount)].HeaderText = "Total";
    this.DataGridView5.Columns[checked (10 + this.DataGridView6.RowCount)].HeaderText = "Arrears";
    ...
    while (index4 <= num4)
    {
      ...
      while (index6 <= num8)
      {
        ...
        {
          if (Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.DataGridView1.Rows[index6].Cells[6].Value.ToString().Trim(), this.lblType.Text, false) == 0 & Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView1.Rows[index6].Cells[7].Value)) >= Conversion.Val(this.txtNoFrom.Text) & Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView1.Rows[index6].Cells[7].Value)) <= Conversion.Val(this.txtNoTo.Text))
          {
            checked { ++index3; }
            ...
            this.DataGridView4.Rows[checked ((int) index3)].Cells[41].Value = RuntimeHelpers.GetObjectValue(this.DataGridView2.Rows[index4].Cells[34].Value);
            ...
            while (num10 <= num9)
            {
              ...
              {
                this.DataGridView4.Rows[checked ((int) index3)].Cells[checked (5 + num10)].Value = (object) Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView1.Rows[index6].Cells[checked (num10 + 22)].Value));
                numArray[checked (5 + num10)] = Conversion.Val((object) numArray[checked (5 + num10)]) + Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView1.Rows[index6].Cells[checked (num10 + 22)].Value));
              }
              else
              {
                this.DataGridView4.Rows[checked ((int) index3)].Cells[checked (5 + num10)].Value = (object) -Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView1.Rows[index6].Cells[checked (num10 + 22)].Value));
            ...
            if (Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.lblType.Text, "MCrn", false) != 0)
            {
              ...
              this.DataGridView4.Rows[checked ((int) index3)].Cells[checked (9 + this.DataGridView6.RowCount)].Value = (object) (Conversion.Val((object) Expression) + Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView1.Rows[index6].Cells[12].Value)));
            ...
            else
            {
              ...
              this.DataGridView4.Rows[checked ((int) index3)].Cells[checked (8 + this.DataGridView6.RowCount)].Value = (object) Conversion.Val((object) Expression);
              this.DataGridView4.Rows[checked ((int) index3)].Cells[checked (9 + this.DataGridView6.RowCount)].Value = (object) (Conversion.Val((object) Expression) + Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView1.Rows[index6].Cells[13].Value)));
              Expression = Expression - Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView1.Rows[index6].Cells[12].Value)) + Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView1.Rows[index6].Cells[13].Value));
            }
            ...
            if (Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.lblType.Text, "MCrn", false) != 0)
            {
              ...
              numArray[checked (8 + this.DataGridView6.RowCount)] = Conversion.Val((object) numArray[checked (8 + this.DataGridView6.RowCount)]) + Conversion.Val((object) Expression) - Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView1.Rows[index6].Cells[12].Value));
              numArray[checked (9 + this.DataGridView6.RowCount)] = Conversion.Val((object) numArray[checked (9 + this.DataGridView6.RowCount)]) + Conversion.Val((object) Expression);
            }
            else
            {
              numArray[checked (5 + this.DataGridView6.RowCount)] = Conversion.Val((object) numArray[checked (5 + this.DataGridView6.RowCount)]) - Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView1.Rows[index6].Cells[10].Value));
              ...
              numArray[checked (8 + this.DataGridView6.RowCount)] = Conversion.Val((object) numArray[checked (8 + this.DataGridView6.RowCount)]) + Conversion.Val((object) Expression) + Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView1.Rows[index6].Cells[13].Value));
              numArray[checked (9 + this.DataGridView6.RowCount)] = Conversion.Val((object) numArray[checked (9 + this.DataGridView6.RowCount)]) + Conversion.Val((object) Expression);
            }
            numArray[checked (10 + this.DataGridView6.RowCount)] = Conversion.Val((object) numArray[checked (10 + this.DataGridView6.RowCount)]) + Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView1.Rows[index6].Cells[14].Value));
          }
          else
            Expression = Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.DataGridView1.Rows[index6].Cells[6].Value.ToString(), "MCrn", false) == 0 ? Expression - Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView1.Rows[index6].Cells[12].Value)) + Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView1.Rows[index6].Cells[13].Value)) : Expression + Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView1.Rows[index6].Cells[12].Value)) - Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView1.Rows[index6].Cells[13].Value));
        }
        checked { ++index6; }
      }
      checked { ++index4; }
    ...
    long index7 = checked (index3 + 1L);
    this.DataGridView4.Rows.Add();
    int num11 = checked (this.DataGridView6.RowCount + 4);
    int num12 = 0;
    while (num12 <= num11)
    {
      this.DataGridView4.Rows[checked ((int) index7)].Cells[checked (5 + num12)].Value = (object) numArray[checked (5 + num12)];
      checked { ++num12; }
    }
    this.DataGridView4.Rows[checked ((int) index7)].Cells[3].Value = (object) "TOTAL";
    this.DataGridView4.Rows[checked ((int) index7)].Cells[checked (17 + this.DataGridView6.RowCount)].Value = (object) "C";
    this.DataGridView4.Rows[checked ((int) index7)].Cells[41].Value = (object) "";
    int index8 = 0;
    do
    {
      numArray[index8] = 0.0;
    ...
    while (index9 <= num13)
    {
      if (Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.DataGridView4.Rows[index9].Cells[41].Value.ToString(), "", false) != 0)
      {
        this.DataGridView5.Rows.Add();
        this.DataGridView5.Rows[checked (this.DataGridView5.RowCount - 1)].Cells[0].Value = RuntimeHelpers.GetObjectValue(this.DataGridView4.Rows[index9].Cells[0].Value);
        this.DataGridView5.Rows[checked (this.DataGridView5.RowCount - 1)].Cells[1].Value = RuntimeHelpers.GetObjectValue(this.DataGridView4.Rows[index9].Cells[1].Value);
        this.DataGridView5.Rows[checked (this.DataGridView5.RowCount - 1)].Cells[2].Value = RuntimeHelpers.GetObjectValue(this.DataGridView4.Rows[index9].Cells[2].Value);
        this.DataGridView5.Rows[checked (this.DataGridView5.RowCount - 1)].Cells[3].Value = RuntimeHelpers.GetObjectValue(this.DataGridView4.Rows[index9].Cells[3].Value);
        this.DataGridView5.Rows[checked (this.DataGridView5.RowCount - 1)].Cells[4].Value = RuntimeHelpers.GetObjectValue(this.DataGridView4.Rows[index9].Cells[40].Value);
        this.DataGridView5.Rows[checked (this.DataGridView5.RowCount - 1)].Cells[5].Value = RuntimeHelpers.GetObjectValue(this.DataGridView4.Rows[index9].Cells[41].Value);
        int index10 = 5;
        do
        {
          this.DataGridView5.Rows[checked (this.DataGridView5.RowCount - 1)].Cells[checked (index10 + 1)].Value = RuntimeHelpers.GetObjectValue(this.DataGridView4.Rows[index9].Cells[checked (index10 - 1)].Value);
          numArray[index10] = Conversion.Val((object) numArray[index10]) + Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView4.Rows[index9].Cells[checked (index10 - 1)].Value));
          checked { ++index10; }
        }
        while (index10 <= 40);
      }
    ...
    this.DataGridView5.Rows.Add();
    int num14 = checked (this.DataGridView6.RowCount + 10);
    int index11 = 6;
    while (index11 <= num14)
    {
      this.DataGridView5.Rows[checked (this.DataGridView5.RowCount - 1)].Cells[checked (index11 + 1)].Value = (object) numArray[index11];
      checked { ++index11; }
    }
    this.DataGridView5.Rows[checked (this.DataGridView5.RowCount - 1)].Cells[3].Value = (object) "TOTAL-GST";
    this.DataGridView5.Rows[checked (this.DataGridView5.RowCount - 1)].Cells[checked (17 + this.DataGridView6.RowCount)].Value = (object) "C";
    this.DataGridView5.Rows[checked (this.DataGridView5.RowCount - 1)].Cells[41].Value = (object) "";
    int index12 = 0;
    do
    {
    ...
    while (index13 <= num15)
    {
      if (Conversions.ToBoolean(Microsoft.VisualBasic.CompilerServices.Operators.AndObject((object) (Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.DataGridView4.Rows[index13].Cells[41].Value.ToString(), "", false) == 0), Microsoft.VisualBasic.CompilerServices.Operators.CompareObjectNotEqual(this.DataGridView4.Rows[index13].Cells[checked (17 + this.DataGridView6.RowCount)].Value, (object) "C", false))))
      {
        this.DataGridView5.Rows.Add();
        this.DataGridView5.Rows[checked (this.DataGridView5.RowCount - 1)].Cells[0].Value = RuntimeHelpers.GetObjectValue(this.DataGridView4.Rows[index13].Cells[0].Value);
        this.DataGridView5.Rows[checked (this.DataGridView5.RowCount - 1)].Cells[1].Value = RuntimeHelpers.GetObjectValue(this.DataGridView4.Rows[index13].Cells[1].Value);
        this.DataGridView5.Rows[checked (this.DataGridView5.RowCount - 1)].Cells[2].Value = RuntimeHelpers.GetObjectValue(this.DataGridView4.Rows[index13].Cells[2].Value);
        this.DataGridView5.Rows[checked (this.DataGridView5.RowCount - 1)].Cells[3].Value = RuntimeHelpers.GetObjectValue(this.DataGridView4.Rows[index13].Cells[3].Value);
        this.DataGridView5.Rows[checked (this.DataGridView5.RowCount - 1)].Cells[4].Value = RuntimeHelpers.GetObjectValue(this.DataGridView4.Rows[index13].Cells[40].Value);
        this.DataGridView5.Rows[checked (this.DataGridView5.RowCount - 1)].Cells[5].Value = RuntimeHelpers.GetObjectValue(this.DataGridView4.Rows[index13].Cells[41].Value);
        int index14 = 5;
        do
        {
          this.DataGridView5.Rows[checked (this.DataGridView5.RowCount - 1)].Cells[checked (index14 + 1)].Value = RuntimeHelpers.GetObjectValue(this.DataGridView4.Rows[index13].Cells[checked (index14 - 1)].Value);
          numArray[index14] = Conversion.Val((object) numArray[index14]) + Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView4.Rows[index13].Cells[checked (index14 - 1)].Value));
          checked { ++index14; }
        }
        while (index14 <= 40);
      }
    ...
    this.DataGridView5.Rows.Add();
    int num16 = checked (this.DataGridView6.RowCount + 10);
    int index15 = 6;
    while (index15 <= num16)
    {
      this.DataGridView5.Rows[checked (this.DataGridView5.RowCount - 1)].Cells[checked (index15 + 1)].Value = (object) numArray[index15];
      checked { ++index15; }
    }
    this.DataGridView5.Rows[checked (this.DataGridView5.RowCount - 1)].Cells[3].Value = (object) "TOTAL-NON GST";
    this.DataGridView5.Rows[checked (this.DataGridView5.RowCount - 1)].Cells[checked (17 + this.DataGridView6.RowCount)].Value = (object) "C";
    this.DataGridView5.Rows[checked (this.DataGridView5.RowCount - 1)].Cells[41].Value = (object) "";
    ...
    while (index16 <= num17)
    {
      if (Microsoft.VisualBasic.CompilerServices.Operators.ConditionalCompareObjectEqual(this.DataGridView4.Rows[index16].Cells[checked (17 + this.DataGridView6.RowCount)].Value, (object) "C", false))
      {
        this.DataGridView5.Rows.Add();
        this.DataGridView5.Rows[checked (this.DataGridView5.RowCount - 1)].Cells[0].Value = RuntimeHelpers.GetObjectValue(this.DataGridView4.Rows[index16].Cells[0].Value);
        this.DataGridView5.Rows[checked (this.DataGridView5.RowCount - 1)].Cells[1].Value = RuntimeHelpers.GetObjectValue(this.DataGridView4.Rows[index16].Cells[1].Value);
        this.DataGridView5.Rows[checked (this.DataGridView5.RowCount - 1)].Cells[2].Value = RuntimeHelpers.GetObjectValue(this.DataGridView4.Rows[index16].Cells[2].Value);
        this.DataGridView5.Rows[checked (this.DataGridView5.RowCount - 1)].Cells[3].Value = RuntimeHelpers.GetObjectValue(this.DataGridView4.Rows[index16].Cells[3].Value);
        this.DataGridView5.Rows[checked (this.DataGridView5.RowCount - 1)].Cells[4].Value = RuntimeHelpers.GetObjectValue(this.DataGridView4.Rows[index16].Cells[41].Value);
        int num18 = 5;
        do
        {
          this.DataGridView5.Rows[checked (this.DataGridView5.RowCount - 1)].Cells[checked (num18 + 1)].Value = RuntimeHelpers.GetObjectValue(this.DataGridView4.Rows[index16].Cells[checked (num18 - 1)].Value);
          checked { ++num18; }
        }
        while (num18 <= 40);
    ...
    this.DataGridView9.ColumnCount = 42;
    this.DataGridView9.Columns[0].HeaderText = "No";
    this.DataGridView9.Columns[1].HeaderText = "Date";
    this.DataGridView9.Columns[2].HeaderText = "Code";
    this.DataGridView9.Columns[3].HeaderText = "Name";
    this.DataGridView9.Columns[4].HeaderText = "Area";
    this.DataGridView9.Columns[5].HeaderText = "GST No.";
    this.DataGridView9.Columns[6].HeaderText = "Period";
    int num19 = 0;
    int num20 = checked (this.DataGridView6.RowCount - 3);
    int index17 = 0;
    while (index17 <= num20)
    {
      if (Microsoft.VisualBasic.CompilerServices.Operators.ConditionalCompareObjectEqual(this.DataGridView6.Rows[index17].Cells[4].Value, (object) false, false))
      {
        this.DataGridView9.Columns[checked (num19 + 7)].HeaderText = Conversions.ToString(this.DataGridView6.Rows[index17].Cells[3].Value);
        checked { ++num19; }
      }
      checked { ++index17; }
    }
    this.DataGridView9.Columns[checked (num19 + 7)].HeaderText = "Total GST EXAMPT";
    int num21 = checked (num19 + 1);
    int num22 = checked (this.DataGridView6.RowCount - 3);
    int index18 = 0;
    while (index18 <= num22)
    {
      if (Microsoft.VisualBasic.CompilerServices.Operators.ConditionalCompareObjectEqual(this.DataGridView6.Rows[index18].Cells[4].Value, (object) true, false))
      {
        this.DataGridView9.Columns[checked (num21 + 7)].HeaderText = Conversions.ToString(this.DataGridView6.Rows[index18].Cells[3].Value);
        checked { ++num21; }
      }
      checked { ++index18; }
    }
    this.DataGridView9.Columns[checked (num21 + 7)].HeaderText = "Interest";
    int num23 = checked (num21 + 1);
    this.DataGridView9.Columns[checked (num23 + 7)].HeaderText = "Total GST APPLY";
    int num24 = checked (num23 + 1);
    int num25 = checked (this.DataGridView6.RowCount - 2);
    int num26 = checked (this.DataGridView6.RowCount - 1);
    int index19 = num25;
    while (index19 <= num26)
    {
      this.DataGridView9.Columns[checked (num24 + 7)].HeaderText = Conversions.ToString(this.DataGridView6.Rows[index19].Cells[3].Value);
      checked { ++num24; }
      checked { ++index19; }
    }
    this.DataGridView9.Columns[checked (num24 + 7)].HeaderText = "Total GST";
    int num27 = checked (num24 + 1);
    this.DataGridView9.Columns[checked (num27 + 7)].HeaderText = "Total Bill";
    int num28 = checked (this.DataGridView6.RowCount + 2);
    int num29 = 0;
    while (num29 <= num28)
    {
      this.DataGridView9.Columns[checked (num29 + 7)].DefaultCellStyle.Format = "N2";
      this.DataGridView9.Columns[checked (num29 + 7)].ValueType = typeof (double);
      this.DataGridView9.Columns[checked (num29 + 7)].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
      checked { ++num29; }
    }
    int num30 = checked (this.DataGridView5.RowCount - 1);
    int index20 = 0;
    while (index20 <= num30)
    {
      ...
      do
      {
        this.DataGridView9.Rows[checked (this.DataGridView9.RowCount - 1)].Cells[index21].Value = RuntimeHelpers.GetObjectValue(this.DataGridView5.Rows[index20].Cells[index21].Value);
        checked { ++index21; }
      }
      while (index21 <= 6);
      this.DataGridView9.Rows[checked (this.DataGridView9.RowCount - 1)].Cells[checked (17 + this.DataGridView6.RowCount)].Value = RuntimeHelpers.GetObjectValue(this.DataGridView5.Rows[index20].Cells[checked (17 + this.DataGridView6.RowCount)].Value);
      int num31 = checked (this.DataGridView6.RowCount + 9);
      int index22 = 7;
      while (index22 <= num31)
      {
        int num32 = checked (this.DataGridView6.RowCount + 9);
        int index23 = 7;
        while (index23 <= num32)
        {
          if (Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.DataGridView9.Columns[index22].HeaderText.ToString(), this.DataGridView5.Columns[index23].HeaderText.ToString(), false) == 0)
            this.DataGridView9.Rows[checked (this.DataGridView9.RowCount - 1)].Cells[index22].Value = RuntimeHelpers.GetObjectValue(this.DataGridView5.Rows[index20].Cells[index23].Value);
          checked { ++index23; }
        }
        checked { ++index22; }
      }
    ...
    int num33 = checked (this.DataGridView9.RowCount - 1);
    int index24 = 0;
    while (index24 <= num33)
    {
      double num34 = 0.0;
      double num35 = 0.0;
      int num36 = checked (num19 + 7 - 1);
      int index25 = 7;
      while (index25 <= num36)
      {
        num34 += Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView9.Rows[index24].Cells[index25].Value));
        checked { ++index25; }
      }
      this.DataGridView9.Rows[index24].Cells[checked (num19 + 7)].Value = (object) Math.Round(num34, 2);
      double num37 = Math.Round(num35, 2) + Math.Round(num34, 2);
      double num38 = 0.0;
      int num39 = checked (num19 + 7 + 1);
      int num40 = checked (num23 + 7 - 1);
      int index26 = num39;
      while (index26 <= num40)
      {
        num38 += Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView9.Rows[index24].Cells[index26].Value));
        checked { ++index26; }
      }
      this.DataGridView9.Rows[index24].Cells[checked (num23 + 7)].Value = (object) Math.Round(num38, 2);
      double num41 = Math.Round(num37, 2) + Math.Round(num38, 2);
      double num42 = 0.0;
      int num43 = checked (num23 + 7 + 1);
      int num44 = checked (num27 + 7 - 1);
      int index27 = num43;
      while (index27 <= num44)
      {
        num42 += Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView9.Rows[index24].Cells[index27].Value));
        checked { ++index27; }
      }
      this.DataGridView9.Rows[index24].Cells[checked (num27 + 7 - 1)].Value = (object) Math.Round(num42, 2);
      double num45 = Math.Round(num41, 2) + Math.Round(num42, 2);
      this.DataGridView9.Rows[index24].Cells[checked (num27 + 7)].Value = (object) Math.Round(num45, 2);
      checked { ++index24; }
    }
    int num46 = checked (this.DataGridView9.RowCount - 1);
    int index28 = 0;
    while (index28 <= num46)
    {
      if (Microsoft.VisualBasic.CompilerServices.Operators.ConditionalCompareObjectEqual(this.DataGridView9.Rows[index28].Cells[checked (17 + this.DataGridView6.RowCount)].Value, (object) "C", false))
      {
        this.DataGridView9.Rows[index28].DefaultCellStyle.BackColor = Color.Brown;
        this.DataGridView9.Rows[index28].DefaultCellStyle.ForeColor = Color.Yellow;
        this.DataGridView9.Rows[index28].DefaultCellStyle.Font = new System.Drawing.Font("Arial", 9f, FontStyle.Bold);
      }
      checked { ++index28; }
    }
    this.DataGridView9.Rows[checked (this.DataGridView9.RowCount - 1)].DefaultCellStyle.BackColor = Color.Brown;
    this.DataGridView9.Rows[checked (this.DataGridView9.RowCount - 1)].DefaultCellStyle.ForeColor = Color.Yellow;
    this.DataGridView9.Rows[checked (this.DataGridView9.RowCount - 1)].DefaultCellStyle.Font = new System.Drawing.Font("Arial", 9f, FontStyle.Bold);
    DataSet fillGrid;
    return fillGrid;
  }
  ...
  private void btnExport_Click(object sender, EventArgs e)
  {
    ...
    this.DataGridView10.ColumnCount = 42;
    ...
    this.DataGridView10.Rows.Add();
    this.DataGridView10.Rows[2].Cells[0].Value = Microsoft.VisualBasic.CompilerServices.Operators.AddObject((object) "GSTIN : ", this.DataGridView11.Rows[0].Cells[21].Value);
    this.DataGridView10.Rows.Add();
    this.DataGridView10.Rows[3].Cells[0].Value = (object) $"Bill Register for Period : {this.mtxtDateFrom.Text} to {this.mtxtDateTo.Text}";
    this.DataGridView10.Rows.Add();
    int num1 = checked (this.DataGridView9.ColumnCount - 1);
    int index1 = 0;
    while (index1 <= num1)
    {
      this.DataGridView10.Rows[checked (this.DataGridView10.RowCount - 1)].Cells[index1].Value = (object) this.DataGridView9.Columns[index1].HeaderText;
      checked { ++index1; }
    }
    ...
    {
      this.DataGridView10.Rows.Add();
      int num3 = checked (this.DataGridView9.ColumnCount - 1);
      int index3 = 0;
      while (index3 <= num3)
      {
        this.DataGridView10.Rows[checked (this.DataGridView10.RowCount - 1)].Cells[index3].Value = RuntimeHelpers.GetObjectValue(this.DataGridView9.Rows[index2].Cells[index3].Value);
        checked { ++index3; }
      }
      checked { ++index2; }
    }
    ...
    while (index4 <= num5)
    {
      if (Microsoft.VisualBasic.CompilerServices.Operators.ConditionalCompareObjectEqual(this.DataGridView10.Rows[index4].Cells[checked (17 + this.DataGridView6.RowCount)].Value, (object) "C", false))
      {
    ...
    try
    {
      ...
      worksheet2.get_Range(RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) 1, (object) 1]), RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) 1, (object) checked (this.DataGridView6.RowCount + 12)])).Merge((object) Missing.Value);
      worksheet2.get_Range(RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) 2, (object) 1]), RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) 2, (object) checked (this.DataGridView6.RowCount + 12)])).Merge((object) Missing.Value);
      worksheet2.get_Range(RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) 3, (object) 1]), RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) 3, (object) checked (this.DataGridView6.RowCount + 12)])).Merge((object) Missing.Value);
      worksheet2.get_Range(RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) 4, (object) 1]), RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) 4, (object) checked (this.DataGridView6.RowCount + 12)])).Merge((object) Missing.Value);
      worksheet2.get_Range(RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) 1, (object) 1]), RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) 5, (object) checked (this.DataGridView6.RowCount + 12)])).HorizontalAlignment = (object) XlVAlign.xlVAlignCenter;
      worksheet2.get_Range(RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) 1, (object) 1]), RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) 5, (object) checked (this.DataGridView6.RowCount + 12)])).Font.FontStyle = (object) "Bold";
      worksheet2.get_Range(RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) 1, (object) 1]), RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) 5, (object) checked (this.DataGridView6.RowCount + 12)])).Font.Size = (object) 10;
      ...
      worksheet2.get_Range(RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) 1, (object) 8]), RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) 1, (object) checked (this.DataGridView6.RowCount + 12)])).ColumnWidth = (object) 10;
      worksheet2.get_Range(RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) 5, (object) 1]), RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) 5, (object) checked (this.DataGridView6.RowCount + 12)])).WrapText = (object) true;
      Microsoft.Office.Interop.Excel.Border border1 = worksheet1.get_Range(RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) 1, (object) 1]), RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) 5, (object) checked (this.DataGridView6.RowCount + 12)])).Borders[XlBordersIndex.xlEdgeBottom];
      border1.LineStyle = (object) XlLineStyle.xlContinuous;
      border1.Weight = (object) XlBorderWeight.xlThin;
      Microsoft.Office.Interop.Excel.Border border2 = worksheet1.get_Range(RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) 3, (object) 1]), RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) 5, (object) checked (this.DataGridView6.RowCount + 12)])).Borders[XlBordersIndex.xlInsideHorizontal];
      border2.LineStyle = (object) XlLineStyle.xlContinuous;
      border2.Weight = (object) XlBorderWeight.xlThin;
      Microsoft.Office.Interop.Excel.Border border3 = worksheet1.get_Range(RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) checked ((int) num4 + 1), (object) 1]), RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) checked ((int) num4 + 1), (object) checked (this.DataGridView6.RowCount + 12)])).Borders[XlBordersIndex.xlEdgeTop];
      border3.LineStyle = (object) XlLineStyle.xlContinuous;
      border3.Weight = (object) XlBorderWeight.xlThin;
      Microsoft.Office.Interop.Excel.Border border4 = worksheet1.get_Range(RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) checked ((int) num4 + 1), (object) 1]), RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) checked ((int) num4 + 1), (object) checked (this.DataGridView6.RowCount + 12)])).Borders[XlBordersIndex.xlEdgeBottom];
      border4.LineStyle = (object) XlLineStyle.xlContinuous;
      border4.Weight = (object) XlBorderWeight.xlThin;
      Microsoft.Office.Interop.Excel.Border border5 = worksheet1.get_Range(RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) checked ((int) num6 + 1), (object) 1]), RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) checked ((int) num6 + 1), (object) checked (this.DataGridView6.RowCount + 12)])).Borders[XlBordersIndex.xlEdgeTop];
      ...
      Microsoft.Office.Interop.Excel.Border border7 = worksheet1.get_Range(RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) 1, (object) 1]), RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) checked ((int) num6 + 2), (object) checked (this.DataGridView6.RowCount + 12)])).Borders[XlBordersIndex.xlEdgeTop];
      border7.LineStyle = (object) XlLineStyle.xlContinuous;
      border7.Weight = (object) XlBorderWeight.xlThin;
      Microsoft.Office.Interop.Excel.Border border8 = worksheet1.get_Range(RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) 1, (object) 1]), RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) checked ((int) num6 + 2), (object) checked (this.DataGridView6.RowCount + 12)])).Borders[XlBordersIndex.xlEdgeBottom];
      border8.LineStyle = (object) XlLineStyle.xlContinuous;
      border8.Weight = (object) XlBorderWeight.xlThin;
      Microsoft.Office.Interop.Excel.Border border9 = worksheet1.get_Range(RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) 1, (object) 1]), RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) checked ((int) num6 + 2), (object) checked (this.DataGridView6.RowCount + 12)])).Borders[XlBordersIndex.xlEdgeLeft];
      border9.LineStyle = (object) XlLineStyle.xlContinuous;
      border9.Weight = (object) XlBorderWeight.xlThin;
      Microsoft.Office.Interop.Excel.Border border10 = worksheet1.get_Range(RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) 1, (object) 1]), RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) checked ((int) num6 + 2), (object) checked (this.DataGridView6.RowCount + 12)])).Borders[XlBordersIndex.xlEdgeRight];
