...
// Type: MauliModule7.CReportReceiptFullPage21headNewSR
...
public class CReportReceiptFullPage21headNewSR : ReportClass
{
  private static List<WeakReference> __ENCList = new List<WeakReference>();

  [DebuggerNonUserCode]
  static CReportReceiptFullPage21headNewSR()
  {
  }
  ...
  {
    lock (CReportReceiptFullPage21headNewSR.__ENCList)
    {
      if (CReportReceiptFullPage21headNewSR.__ENCList.Count == CReportReceiptFullPage21headNewSR.__ENCList.Capacity)
      {
        int index1 = 0;
        int num = checked (CReportReceiptFullPage21headNewSR.__ENCList.Count - 1);
        int index2 = 0;
        while (index2 <= num)
        {
          if (CReportReceiptFullPage21headNewSR.__ENCList[index2].IsAlive)
          {
            if (index2 != index1)
              CReportReceiptFullPage21headNewSR.__ENCList[index1] = CReportReceiptFullPage21headNewSR.__ENCList[index2];
            checked { ++index1; }
          }
          checked { ++index2; }
        }
        CReportReceiptFullPage21headNewSR.__ENCList.RemoveRange(index1, checked (CReportReceiptFullPage21headNewSR.__ENCList.Count - index1));
        CReportReceiptFullPage21headNewSR.__ENCList.Capacity = CReportReceiptFullPage21headNewSR.__ENCList.Count;
      }
      CReportReceiptFullPage21headNewSR.__ENCList.Add(new WeakReference(RuntimeHelpers.GetObjectValue(value)));
    }
  }

  public CReportReceiptFullPage21headNewSR()
  {
    CReportReceiptFullPage21headNewSR.__ENCAddToList((object) this);
  }

  public override string ResourceName
  {
    get => "CReportReceiptFullPage21headNewSR.rpt";
    set
    {
    }
  }
  ...
  {
    get => "MauliModule7.CReportReceiptFullPage21headNewSR.rpt";
    set
    {
    }
  }
