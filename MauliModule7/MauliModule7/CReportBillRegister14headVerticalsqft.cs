...
// Type: MauliModule7.CReportBillRegister14headVerticalsqft
...
public class CReportBillRegister14headVerticalsqft : ReportClass
{
  private static List<WeakReference> __ENCList = new List<WeakReference>();

  [DebuggerNonUserCode]
  static CReportBillRegister14headVerticalsqft()
  {
  }
  ...
  {
    lock (CReportBillRegister14headVerticalsqft.__ENCList)
    {
      if (CReportBillRegister14headVerticalsqft.__ENCList.Count == CReportBillRegister14headVerticalsqft.__ENCList.Capacity)
      {
        int index1 = 0;
        int num = checked (CReportBillRegister14headVerticalsqft.__ENCList.Count - 1);
        int index2 = 0;
        while (index2 <= num)
        {
          if (CReportBillRegister14headVerticalsqft.__ENCList[index2].IsAlive)
          {
            if (index2 != index1)
              CReportBillRegister14headVerticalsqft.__ENCList[index1] = CReportBillRegister14headVerticalsqft.__ENCList[index2];
            checked { ++index1; }
          }
          checked { ++index2; }
        }
        CReportBillRegister14headVerticalsqft.__ENCList.RemoveRange(index1, checked (CReportBillRegister14headVerticalsqft.__ENCList.Count - index1));
        CReportBillRegister14headVerticalsqft.__ENCList.Capacity = CReportBillRegister14headVerticalsqft.__ENCList.Count;
      }
      CReportBillRegister14headVerticalsqft.__ENCList.Add(new WeakReference(RuntimeHelpers.GetObjectValue(value)));
    }
  }

  public CReportBillRegister14headVerticalsqft()
  {
    CReportBillRegister14headVerticalsqft.__ENCAddToList((object) this);
  }

  public override string ResourceName
  {
    get => "CReportBillRegister14headVerticalsqft.rpt";
    set
    {
    }
  }
  ...
  {
    get => "MauliModule7.CReportBillRegister14headVerticalsqft.rpt";
    set
    {
    }
  }
  ...
  [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
  [Browsable(false)]
  public Section ReportFooterSection2 => this.ReportDefinition.Sections[9];

  [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
  [Browsable(false)]
  public Section ReportFooterSection1 => this.ReportDefinition.Sections[10];
