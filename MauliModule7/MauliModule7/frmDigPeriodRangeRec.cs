...
// Type: MauliModule7.frmDigPeriodRangeRec
...
[DesignerGenerated]
public class frmDigPeriodRangeRec : Form
{
  ...
  [DebuggerNonUserCode]
  static frmDigPeriodRangeRec()
  {
  }

  [DebuggerNonUserCode]
  public frmDigPeriodRangeRec()
  {
    this.Load += new EventHandler(this.frmDigPeriodRangeRec_Load);
    frmDigPeriodRangeRec.__ENCAddToList((object) this);
  ...
  {
    lock (frmDigPeriodRangeRec.__ENCList)
    {
      if (frmDigPeriodRangeRec.__ENCList.Count == frmDigPeriodRangeRec.__ENCList.Capacity)
      {
        int index1 = 0;
        int num = checked (frmDigPeriodRangeRec.__ENCList.Count - 1);
        int index2 = 0;
        while (index2 <= num)
        {
          if (frmDigPeriodRangeRec.__ENCList[index2].IsAlive)
          {
            if (index2 != index1)
              frmDigPeriodRangeRec.__ENCList[index1] = frmDigPeriodRangeRec.__ENCList[index2];
            checked { ++index1; }
          }
          checked { ++index2; }
        }
        frmDigPeriodRangeRec.__ENCList.RemoveRange(index1, checked (frmDigPeriodRangeRec.__ENCList.Count - index1));
        frmDigPeriodRangeRec.__ENCList.Capacity = frmDigPeriodRangeRec.__ENCList.Count;
      }
      frmDigPeriodRangeRec.__ENCList.Add(new WeakReference(RuntimeHelpers.GetObjectValue(value)));
    }
  }
  ...
  private void InitializeComponent()
  {
    ...
    this.Name = nameof (frmDigPeriodRangeRec);
  ...
  internal virtual MaskedTextBox mtxtDateFrom
  {
    ...
    [DebuggerNonUserCode, MethodImpl(MethodImplOptions.Synchronized)] set
    {
      EventHandler eventHandler1 = new EventHandler(this.mtxtDateFrom_GotFocus);
      EventHandler eventHandler2 = new EventHandler(this.mtxtDateFrom_Validated);
      if (this._mtxtDateFrom != null)
      {
        this._mtxtDateFrom.GotFocus -= eventHandler1;
        this._mtxtDateFrom.Validated -= eventHandler2;
      }
  ...
  private void frmDigPeriodRangeRec_Load(object sender, EventArgs e)
  {
    this.mtxtDateFrom.Text = "  /  /";
