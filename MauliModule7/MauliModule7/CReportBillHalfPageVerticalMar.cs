...
// Type: MauliModule7.CReportBillHalfPageVerticalMar
...
public class CReportBillHalfPageVerticalMar : ReportClass
{
  private static List<WeakReference> __ENCList = new List<WeakReference>();

  [DebuggerNonUserCode]
  static CReportBillHalfPageVerticalMar()
  {
  }
  ...
  {
    lock (CReportBillHalfPageVerticalMar.__ENCList)
    {
      if (CReportBillHalfPageVerticalMar.__ENCList.Count == CReportBillHalfPageVerticalMar.__ENCList.Capacity)
      {
        int index1 = 0;
        int num = checked (CReportBillHalfPageVerticalMar.__ENCList.Count - 1);
        int index2 = 0;
        while (index2 <= num)
        {
          if (CReportBillHalfPageVerticalMar.__ENCList[index2].IsAlive)
          {
            if (index2 != index1)
              CReportBillHalfPageVerticalMar.__ENCList[index1] = CReportBillHalfPageVerticalMar.__ENCList[index2];
            checked { ++index1; }
          }
          checked { ++index2; }
        }
        CReportBillHalfPageVerticalMar.__ENCList.RemoveRange(index1, checked (CReportBillHalfPageVerticalMar.__ENCList.Count - index1));
        CReportBillHalfPageVerticalMar.__ENCList.Capacity = CReportBillHalfPageVerticalMar.__ENCList.Count;
      }
      CReportBillHalfPageVerticalMar.__ENCList.Add(new WeakReference(RuntimeHelpers.GetObjectValue(value)));
    }
  }

  public CReportBillHalfPageVerticalMar()
  {
    CReportBillHalfPageVerticalMar.__ENCAddToList((object) this);
  }

  public override string ResourceName
  {
    get => "CReportBillHalfPageVerticalMar.rpt";
    set
    {
    }
  }
  ...
  {
    get => "MauliModule7.CReportBillHalfPageVerticalMar.rpt";
    set
    {
    }
  }
