...
// Type: MauliModule7.CReportBillRegister14headVerticalLine
...
public class CReportBillRegister14headVerticalLine : ReportClass
{
  private static List<WeakReference> __ENCList = new List<WeakReference>();

  [DebuggerNonUserCode]
  static CReportBillRegister14headVerticalLine()
  {
  }
  ...
  {
    lock (CReportBillRegister14headVerticalLine.__ENCList)
    {
      if (CReportBillRegister14headVerticalLine.__ENCList.Count == CReportBillRegister14headVerticalLine.__ENCList.Capacity)
      {
        int index1 = 0;
        int num = checked (CReportBillRegister14headVerticalLine.__ENCList.Count - 1);
        int index2 = 0;
        while (index2 <= num)
        {
          if (CReportBillRegister14headVerticalLine.__ENCList[index2].IsAlive)
          {
            if (index2 != index1)
              CReportBillRegister14headVerticalLine.__ENCList[index1] = CReportBillRegister14headVerticalLine.__ENCList[index2];
            checked { ++index1; }
          }
          checked { ++index2; }
        }
        CReportBillRegister14headVerticalLine.__ENCList.RemoveRange(index1, checked (CReportBillRegister14headVerticalLine.__ENCList.Count - index1));
        CReportBillRegister14headVerticalLine.__ENCList.Capacity = CReportBillRegister14headVerticalLine.__ENCList.Count;
      }
      CReportBillRegister14headVerticalLine.__ENCList.Add(new WeakReference(RuntimeHelpers.GetObjectValue(value)));
    }
  }

  public CReportBillRegister14headVerticalLine()
  {
    CReportBillRegister14headVerticalLine.__ENCAddToList((object) this);
  }

  public override string ResourceName
  {
    get => "CReportBillRegister14headVerticalLine.rpt";
    set
    {
    }
  }
  ...
  {
    get => "MauliModule7.CReportBillRegister14headVerticalLine.rpt";
    set
    {
    }
  }
