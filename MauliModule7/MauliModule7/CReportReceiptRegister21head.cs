...
// Type: MauliModule7.CReportReceiptRegister21head
...
public class CReportReceiptRegister21head : ReportClass
{
  private static List<WeakReference> __ENCList = new List<WeakReference>();

  [DebuggerNonUserCode]
  static CReportReceiptRegister21head()
  {
  }
  ...
  {
    lock (CReportReceiptRegister21head.__ENCList)
    {
      if (CReportReceiptRegister21head.__ENCList.Count == CReportReceiptRegister21head.__ENCList.Capacity)
      {
        int index1 = 0;
        int num = checked (CReportReceiptRegister21head.__ENCList.Count - 1);
        int index2 = 0;
        while (index2 <= num)
        {
          if (CReportReceiptRegister21head.__ENCList[index2].IsAlive)
          {
            if (index2 != index1)
              CReportReceiptRegister21head.__ENCList[index1] = CReportReceiptRegister21head.__ENCList[index2];
            checked { ++index1; }
          }
          checked { ++index2; }
        }
        CReportReceiptRegister21head.__ENCList.RemoveRange(index1, checked (CReportReceiptRegister21head.__ENCList.Count - index1));
        CReportReceiptRegister21head.__ENCList.Capacity = CReportReceiptRegister21head.__ENCList.Count;
      }
      CReportReceiptRegister21head.__ENCList.Add(new WeakReference(RuntimeHelpers.GetObjectValue(value)));
    }
  }

  public CReportReceiptRegister21head()
  {
    CReportReceiptRegister21head.__ENCAddToList((object) this);
  }

  public override string ResourceName
  {
    get => "CReportReceiptRegister21head.rpt";
    set
    {
    }
  }
  ...
  {
    get => "MauliModule7.CReportReceiptRegister21head.rpt";
    set
    {
    }
  }
