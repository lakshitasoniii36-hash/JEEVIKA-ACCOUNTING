...
// Type: MauliModule7.CReportBillFullPageWithReceipt21HeadNew811
...
public class CReportBillFullPageWithReceipt21HeadNew811 : ReportClass
{
  private static List<WeakReference> __ENCList = new List<WeakReference>();

  [DebuggerNonUserCode]
  static CReportBillFullPageWithReceipt21HeadNew811()
  {
  }
  ...
  {
    lock (CReportBillFullPageWithReceipt21HeadNew811.__ENCList)
    {
      if (CReportBillFullPageWithReceipt21HeadNew811.__ENCList.Count == CReportBillFullPageWithReceipt21HeadNew811.__ENCList.Capacity)
      {
        int index1 = 0;
        int num = checked (CReportBillFullPageWithReceipt21HeadNew811.__ENCList.Count - 1);
        int index2 = 0;
        while (index2 <= num)
        {
          if (CReportBillFullPageWithReceipt21HeadNew811.__ENCList[index2].IsAlive)
          {
            if (index2 != index1)
              CReportBillFullPageWithReceipt21HeadNew811.__ENCList[index1] = CReportBillFullPageWithReceipt21HeadNew811.__ENCList[index2];
            checked { ++index1; }
          }
          checked { ++index2; }
        }
        CReportBillFullPageWithReceipt21HeadNew811.__ENCList.RemoveRange(index1, checked (CReportBillFullPageWithReceipt21HeadNew811.__ENCList.Count - index1));
        CReportBillFullPageWithReceipt21HeadNew811.__ENCList.Capacity = CReportBillFullPageWithReceipt21HeadNew811.__ENCList.Count;
      }
      CReportBillFullPageWithReceipt21HeadNew811.__ENCList.Add(new WeakReference(RuntimeHelpers.GetObjectValue(value)));
    }
  }

  public CReportBillFullPageWithReceipt21HeadNew811()
  {
    CReportBillFullPageWithReceipt21HeadNew811.__ENCAddToList((object) this);
  }

  public override string ResourceName
  {
    get => "CReportBillFullPageWithReceipt21HeadNew811.rpt";
    set
    {
    }
  }
  ...
  {
    get => "MauliModule7.CReportBillFullPageWithReceipt21HeadNew811.rpt";
    set
    {
    }
  }
  ...
  [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
  [Browsable(false)]
  public Section DetailSection3 => this.ReportDefinition.Sections[9];
  ...
  [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
  [Browsable(false)]
  public Section GroupFooterSection4 => this.ReportDefinition.Sections[11];

  [Browsable(false)]
  [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
  public Section Section4 => this.ReportDefinition.Sections[12];
  ...
  [Browsable(false)]
  [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
  public IParameterField Parameter_chkN2
  {
