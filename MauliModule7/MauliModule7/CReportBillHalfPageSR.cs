...
// Type: MauliModule7.CReportBillHalfPageSR
...
public class CReportBillHalfPageSR : ReportClass
{
  private static List<WeakReference> __ENCList = new List<WeakReference>();

  [DebuggerNonUserCode]
  static CReportBillHalfPageSR()
  {
  }
  ...
  {
    lock (CReportBillHalfPageSR.__ENCList)
    {
      if (CReportBillHalfPageSR.__ENCList.Count == CReportBillHalfPageSR.__ENCList.Capacity)
      {
        int index1 = 0;
        int num = checked (CReportBillHalfPageSR.__ENCList.Count - 1);
        int index2 = 0;
        while (index2 <= num)
        {
          if (CReportBillHalfPageSR.__ENCList[index2].IsAlive)
          {
            if (index2 != index1)
              CReportBillHalfPageSR.__ENCList[index1] = CReportBillHalfPageSR.__ENCList[index2];
            checked { ++index1; }
          }
          checked { ++index2; }
        }
        CReportBillHalfPageSR.__ENCList.RemoveRange(index1, checked (CReportBillHalfPageSR.__ENCList.Count - index1));
        CReportBillHalfPageSR.__ENCList.Capacity = CReportBillHalfPageSR.__ENCList.Count;
      }
      CReportBillHalfPageSR.__ENCList.Add(new WeakReference(RuntimeHelpers.GetObjectValue(value)));
    }
  }

  public CReportBillHalfPageSR() => CReportBillHalfPageSR.__ENCAddToList((object) this);

  public override string ResourceName
  {
    get => "CReportBillHalfPageSR.rpt";
    set
    {
    }
  }
  ...
  {
    get => "MauliModule7.CReportBillHalfPageSR.rpt";
    set
    {
    }
  }
