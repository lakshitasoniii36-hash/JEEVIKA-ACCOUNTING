...
// Type: MauliModule7.CReportBillFullPage21headNewShanGstArr
...
public class CReportBillFullPage21headNewShanGstArr : ReportClass
{
  private static List<WeakReference> __ENCList = new List<WeakReference>();

  [DebuggerNonUserCode]
  static CReportBillFullPage21headNewShanGstArr()
  {
  }
  ...
  {
    lock (CReportBillFullPage21headNewShanGstArr.__ENCList)
    {
      if (CReportBillFullPage21headNewShanGstArr.__ENCList.Count == CReportBillFullPage21headNewShanGstArr.__ENCList.Capacity)
      {
        int index1 = 0;
        int num = checked (CReportBillFullPage21headNewShanGstArr.__ENCList.Count - 1);
        int index2 = 0;
        while (index2 <= num)
        {
          if (CReportBillFullPage21headNewShanGstArr.__ENCList[index2].IsAlive)
          {
            if (index2 != index1)
              CReportBillFullPage21headNewShanGstArr.__ENCList[index1] = CReportBillFullPage21headNewShanGstArr.__ENCList[index2];
            checked { ++index1; }
          }
          checked { ++index2; }
        }
        CReportBillFullPage21headNewShanGstArr.__ENCList.RemoveRange(index1, checked (CReportBillFullPage21headNewShanGstArr.__ENCList.Count - index1));
        CReportBillFullPage21headNewShanGstArr.__ENCList.Capacity = CReportBillFullPage21headNewShanGstArr.__ENCList.Count;
      }
      CReportBillFullPage21headNewShanGstArr.__ENCList.Add(new WeakReference(RuntimeHelpers.GetObjectValue(value)));
    }
  }

  public CReportBillFullPage21headNewShanGstArr()
  {
    CReportBillFullPage21headNewShanGstArr.__ENCAddToList((object) this);
  }

  public override string ResourceName
  {
    get => "CReportBillFullPage21headNewShanGstArr.rpt";
    set
    {
    }
  }
  ...
  {
    get => "MauliModule7.CReportBillFullPage21headNewShanGstArr.rpt";
    set
    {
    }
  }
