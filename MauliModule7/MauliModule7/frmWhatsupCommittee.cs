...
// Type: MauliModule7.frmWhatsupCommittee
...
[DesignerGenerated]
public class frmWhatsupCommittee : Form
{
  ...
  [DebuggerNonUserCode]
  static frmWhatsupCommittee()
  {
  }

  public frmWhatsupCommittee()
  {
    this.KeyDown += new KeyEventHandler(this.frmWhatsupCommittee_KeyDown);
    this.Load += new EventHandler(this.frmWhatsupCommittee_Load);
    frmWhatsupCommittee.__ENCAddToList((object) this);
  ...
  {
    lock (frmWhatsupCommittee.__ENCList)
    {
      if (frmWhatsupCommittee.__ENCList.Count == frmWhatsupCommittee.__ENCList.Capacity)
      {
        int index1 = 0;
        int num = checked (frmWhatsupCommittee.__ENCList.Count - 1);
        int index2 = 0;
        while (index2 <= num)
        {
          if (frmWhatsupCommittee.__ENCList[index2].IsAlive)
          {
            if (index2 != index1)
              frmWhatsupCommittee.__ENCList[index1] = frmWhatsupCommittee.__ENCList[index2];
            checked { ++index1; }
          }
          checked { ++index2; }
        }
        frmWhatsupCommittee.__ENCList.RemoveRange(index1, checked (frmWhatsupCommittee.__ENCList.Count - index1));
        frmWhatsupCommittee.__ENCList.Capacity = frmWhatsupCommittee.__ENCList.Count;
      }
      frmWhatsupCommittee.__ENCList.Add(new WeakReference(RuntimeHelpers.GetObjectValue(value)));
    }
  }
  ...
  private void InitializeComponent()
  {
    ...
    ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (frmWhatsupCommittee));
    ...
    this.Name = nameof (frmWhatsupCommittee);
    this.ShowInTaskbar = false;
    this.StartPosition = FormStartPosition.CenterScreen;
    this.Text = "frmEmailCommittee";
  ...
  private void frmWhatsupCommittee_KeyDown(object sender, KeyEventArgs e)
  {
  ...
  private void frmWhatsupCommittee_Load(object sender, EventArgs e)
  {
