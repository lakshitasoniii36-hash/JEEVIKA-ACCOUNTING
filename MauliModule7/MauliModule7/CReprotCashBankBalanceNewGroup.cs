...
// Type: MauliModule7.CReprotCashBankBalanceNewGroup
...
public class CReprotCashBankBalanceNewGroup : ReportClass
{
  private static List<WeakReference> __ENCList = new List<WeakReference>();

  [DebuggerNonUserCode]
  static CReprotCashBankBalanceNewGroup()
  {
  }
  ...
  {
    lock (CReprotCashBankBalanceNewGroup.__ENCList)
    {
      if (CReprotCashBankBalanceNewGroup.__ENCList.Count == CReprotCashBankBalanceNewGroup.__ENCList.Capacity)
      {
        int index1 = 0;
        int num = checked (CReprotCashBankBalanceNewGroup.__ENCList.Count - 1);
        int index2 = 0;
        while (index2 <= num)
        {
          if (CReprotCashBankBalanceNewGroup.__ENCList[index2].IsAlive)
          {
            if (index2 != index1)
              CReprotCashBankBalanceNewGroup.__ENCList[index1] = CReprotCashBankBalanceNewGroup.__ENCList[index2];
            checked { ++index1; }
          }
          checked { ++index2; }
        }
        CReprotCashBankBalanceNewGroup.__ENCList.RemoveRange(index1, checked (CReprotCashBankBalanceNewGroup.__ENCList.Count - index1));
        CReprotCashBankBalanceNewGroup.__ENCList.Capacity = CReprotCashBankBalanceNewGroup.__ENCList.Count;
      }
      CReprotCashBankBalanceNewGroup.__ENCList.Add(new WeakReference(RuntimeHelpers.GetObjectValue(value)));
    }
  }

  public CReprotCashBankBalanceNewGroup()
  {
    CReprotCashBankBalanceNewGroup.__ENCAddToList((object) this);
  }

  public override string ResourceName
  {
    get => "CReprotCashBankBalanceNewGroup.rpt";
    set
    {
    }
  }
  ...
  {
    get => "MauliModule7.CReprotCashBankBalanceNewGroup.rpt";
    set
    {
    }
  }
  ...
  [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
  [Browsable(false)]
  public Section GroupFooterSection11 => this.ReportDefinition.Sections[16 /*0x10*/];

  [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
  [Browsable(false)]
  public Section GroupFooterSection7 => this.ReportDefinition.Sections[17];

  [Browsable(false)]
  [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
  public Section GroupFooterSection3 => this.ReportDefinition.Sections[18];

  [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
  [Browsable(false)]
  public Section GroupFooterSection4 => this.ReportDefinition.Sections[19];

  [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
  [Browsable(false)]
  public Section GroupFooterSection6 => this.ReportDefinition.Sections[20];

  [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
  [Browsable(false)]
  public Section GroupFooterSection1 => this.ReportDefinition.Sections[21];

  [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
  [Browsable(false)]
  public Section GroupFooterSection9 => this.ReportDefinition.Sections[22];

  [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
  [Browsable(false)]
  public Section GroupFooterSection8 => this.ReportDefinition.Sections[23];

  [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
  [Browsable(false)]
  public Section Section4 => this.ReportDefinition.Sections[24];

  [Browsable(false)]
  [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
  public Section Section5 => this.ReportDefinition.Sections[25];
