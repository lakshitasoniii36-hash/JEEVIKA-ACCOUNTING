...
// Type: MauliModule7.frmPaymentDetails
...
[DesignerGenerated]
public class frmPaymentDetails : Form
{
  ...
  [AccessedThroughProperty("mtxtClearDateN")]
  private MaskedTextBox _mtxtClearDateN;
  ...
  {
    this.KeyDown += new KeyEventHandler(this.frmPaymentDetails_KeyDown);
    this.Load += new EventHandler(this.frmPaymentDetails_Load);
    frmPaymentDetails.__ENCAddToList((object) this);
  ...
  {
    lock (frmPaymentDetails.__ENCList)
    {
      if (frmPaymentDetails.__ENCList.Count == frmPaymentDetails.__ENCList.Capacity)
      {
        int index1 = 0;
        int num = checked (frmPaymentDetails.__ENCList.Count - 1);
        int index2 = 0;
        while (index2 <= num)
        {
          if (frmPaymentDetails.__ENCList[index2].IsAlive)
          {
            if (index2 != index1)
              frmPaymentDetails.__ENCList[index1] = frmPaymentDetails.__ENCList[index2];
            checked { ++index1; }
          }
          checked { ++index2; }
        }
        frmPaymentDetails.__ENCList.RemoveRange(index1, checked (frmPaymentDetails.__ENCList.Count - index1));
        frmPaymentDetails.__ENCList.Capacity = frmPaymentDetails.__ENCList.Count;
      }
      frmPaymentDetails.__ENCList.Add(new WeakReference(RuntimeHelpers.GetObjectValue(value)));
    }
  }
  ...
  private void InitializeComponent()
  {
    ...
    ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (frmPaymentDetails));
    ...
    this.mtxtClearDateN = new MaskedTextBox();
    ...
    this.GrpVisible.Controls.Add((Control) this.mtxtClearDateN);
    ...
    point1 = new Point(6, 326);
    Point point31 = point1;
    dataGridView12_1.Location = point31;
    this.DataGridView12.Name = "DataGridView12";
    DataGridView dataGridView12_2 = this.DataGridView12;
    size1 = new Size(10, 14);
    Size size31 = size1;
    dataGridView12_2.Size = size31;
    this.DataGridView12.TabIndex = 115;
    ...
    point1 = new Point(7, 306);
    Point point32 = point1;
    dataGridView11_1.Location = point32;
    this.DataGridView11.Name = "DataGridView11";
    DataGridView dataGridView11_2 = this.DataGridView11;
    size1 = new Size(10, 14);
    Size size32 = size1;
    dataGridView11_2.Size = size32;
    this.DataGridView11.TabIndex = 114;
    ...
    point1 = new Point(18, 190);
    Point point33 = point1;
    dataGridView10_1.Location = point33;
    this.DataGridView10.Name = "DataGridView10";
    DataGridView dataGridView10_2 = this.DataGridView10;
    size1 = new Size(10, 14);
    Size size33 = size1;
    dataGridView10_2.Size = size33;
    this.DataGridView10.TabIndex = 113;
    ...
    this.DataGridView8.TabIndex = 110;
    this.mtxtClearDateN.Font = new Font("Microsoft Sans Serif", 9.75f, FontStyle.Regular, GraphicsUnit.Point, (byte) 0);
    this.mtxtClearDateN.InsertKeyMode = InsertKeyMode.Overwrite;
    MaskedTextBox mtxtClearDateN1 = this.mtxtClearDateN;
    point1 = new Point(4, 132);
    Point point37 = point1;
    mtxtClearDateN1.Location = point37;
    this.mtxtClearDateN.Mask = "00/00/0000";
    this.mtxtClearDateN.Name = "mtxtClearDateN";
    MaskedTextBox mtxtClearDateN2 = this.mtxtClearDateN;
    size1 = new Size(23, 22);
    Size size37 = size1;
    mtxtClearDateN2.Size = size37;
    this.mtxtClearDateN.TabIndex = 109;
    this.mtxtClearDateN.ValidatingType = typeof (DateTime);
    ...
    point1 = new Point(10, 112 /*0x70*/);
    Point point38 = point1;
    dataGridView7_1.Location = point38;
    this.DataGridView7.Name = "DataGridView7";
    DataGridView dataGridView7_2 = this.DataGridView7;
    size1 = new Size(10, 14);
    Size size38 = size1;
    dataGridView7_2.Size = size38;
    ...
    dataGridView6_1.Location = point40;
    this.DataGridView6.Name = "DataGridView6";
    DataGridView dataGridView6_2 = this.DataGridView6;
    size1 = new Size(10, 14);
    Size size40 = size1;
    dataGridView6_2.Size = size40;
    ...
    mtxtClearDate1.Location = point41;
    ...
    dataGridView1_1.Location = point44;
    this.DataGridView1.Name = "DataGridView1";
    this.DataGridView1.SelectionMode = DataGridViewSelectionMode.FullRowSelect;
    DataGridView dataGridView1_2 = this.DataGridView1;
    size1 = new Size(533, 187);
    Size size44 = size1;
    dataGridView1_2.Size = size44;
    ...
    groupBox2_1.Location = point54;
    this.GroupBox2.Name = "GroupBox2";
    GroupBox groupBox2_2 = this.GroupBox2;
    size1 = new Size(537, 65);
    Size size54 = size1;
    groupBox2_2.Size = size54;
    ...
    label6_1.Location = point57;
    this.Label6.Name = "Label6";
    Label label6_2 = this.Label6;
    size1 = new Size(53, 16 /*0x10*/);
    Size size57 = size1;
    label6_2.Size = size57;
    ...
    groupBox1_1.Location = point61;
    this.GroupBox1.Name = "GroupBox1";
    GroupBox groupBox1_2 = this.GroupBox1;
    size1 = new Size(537, 315);
    Size size61 = size1;
    groupBox1_2.Size = size61;
    ...
    this.btnNew.Controls.Add((Control) this.btnDetail);
    this.btnNew.Controls.Add((Control) this.btnPerson);
    this.btnNew.Controls.Add((Control) this.cmbPerson);
    this.btnNew.Controls.Add((Control) this.GroupBox6);
    this.btnNew.Controls.Add((Control) this.GroupBox2);
    this.btnNew.Controls.Add((Control) this.GrpVisible);
    this.btnNew.Controls.Add((Control) this.btnSave);
    this.btnNew.Controls.Add((Control) this.Label11);
    this.btnNew.Controls.Add((Control) this.btnExit);
    this.btnNew.Controls.Add((Control) this.Label10);
    this.btnNew.Controls.Add((Control) this.cmbCashbank);
    this.btnNew.Controls.Add((Control) this.Label9);
    this.btnNew.Controls.Add((Control) this.lblAccCode);
    this.btnNew.Controls.Add((Control) this.Label1);
    this.btnNew.Controls.Add((Control) this.Label8);
    this.btnNew.Controls.Add((Control) this.mtxtDate);
    this.btnNew.Controls.Add((Control) this.Label7);
    this.btnNew.Controls.Add((Control) this.txtPart2);
    this.btnNew.Controls.Add((Control) this.lblcashbank);
    this.btnNew.Controls.Add((Control) this.txtPart1);
    this.btnNew.Controls.Add((Control) this.GroupBox1);
    this.btnNew.Controls.Add((Control) this.txtChqNo);
    this.btnNew.Controls.Add((Control) this.txtBillNo);
    this.btnNew.Controls.Add((Control) this.txtChqDate);
    this.btnNew.Controls.Add((Control) this.Button2);
    GroupBox btnNew1 = this.btnNew;
    point1 = new Point(182, -7);
    Point point65 = point1;
    btnNew1.Location = point65;
    this.btnNew.Name = "btnNew";
    GroupBox btnNew2 = this.btnNew;
    ...
    point1 = new Point(510, 493);
    Point point67 = point1;
    btnPerson1.Location = point67;
    this.btnPerson.Name = "btnPerson";
    Button btnPerson2 = this.btnPerson;
    size1 = new Size(37, 26);
    Size size67 = size1;
    btnPerson2.Size = size67;
    ...
    cmbPerson1.Location = point68;
    this.cmbPerson.Name = "cmbPerson";
    ComboBox cmbPerson2 = this.cmbPerson;
    size1 = new Size(370, 24);
    Size size68 = size1;
    cmbPerson2.Size = size68;
    ...
    label2_1.Location = point70;
    this.Label2.Name = "Label2";
    Label label2_2 = this.Label2;
    size1 = new Size(82, 16 /*0x10*/);
    Size size70 = size1;
    label2_2.Size = size70;
    ...
    label4_1.Location = point78;
    this.Label4.Name = "Label4";
    Label label4_2 = this.Label4;
    size1 = new Size(101, 16 /*0x10*/);
    Size size78 = size1;
    label4_2.Size = size78;
    ...
    label3_1.Location = point81;
    this.Label3.Name = "Label3";
    Label label3_2 = this.Label3;
    size1 = new Size(101, 16 /*0x10*/);
    Size size81 = size1;
    label3_2.Size = size81;
    ...
    this.Name = nameof (frmPaymentDetails);
    this.ShowInTaskbar = false;
    this.StartPosition = FormStartPosition.CenterScreen;
    this.Text = nameof (frmPaymentDetails);
  ...
  internal virtual GroupBox btnNew
  {
    [DebuggerNonUserCode] get => this._btnNew;
    [DebuggerNonUserCode, MethodImpl(MethodImplOptions.Synchronized)] set => this._btnNew = value;
  }
  ...
  internal virtual MaskedTextBox mtxtClearDateN
  {
    [DebuggerNonUserCode] get => this._mtxtClearDateN;
    [DebuggerNonUserCode, MethodImpl(MethodImplOptions.Synchronized)] set
    {
      this._mtxtClearDateN = value;
    }
  }
  ...
  private void frmPaymentDetails_KeyDown(object sender, KeyEventArgs e)
  {
  ...
  private void btnSave_Click(object sender, EventArgs e)
  {
    ...
    if (Conversions.ToDouble(MyProject.Forms.DeleteDialog.lblResult.Text) == 1.0)
    {
      ...
      {
        int num10 = checked (MyProject.Forms.frmPayment.DataGridView1.RowCount - 1);
        int index2 = 0;
        while (index2 <= num10)
        {
          if (Conversions.ToBoolean(Microsoft.VisualBasic.CompilerServices.Operators.AndObject(Microsoft.VisualBasic.CompilerServices.Operators.AndObject(Microsoft.VisualBasic.CompilerServices.Operators.CompareObjectEqual((object) Conversion.Val(this.txtSubNo.Text), MyProject.Forms.frmPayment.DataGridView1.Rows[index2].Cells[28].Value, false), Microsoft.VisualBasic.CompilerServices.Operators.CompareObjectEqual((object) this.cmbSubTranType.Text, MyProject.Forms.frmPayment.DataGridView1.Rows[index2].Cells[27].Value, false)), Microsoft.VisualBasic.CompilerServices.Operators.CompareObjectEqual((object) this.lblType.Text, MyProject.Forms.frmPayment.DataGridView1.Rows[index2].Cells[6].Value, false))))
            checked { ++num9; }
          checked { ++index2; }
        }
        if (num9 >= 1)
      ...
      if (Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.btnSave.Text, "&Save", false) == 0 | Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.btnSave.Text, "&Update", false) == 0)
      {
        ...
        {
          string cmdText;
          if (Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.mtxtClearDateN.Text.ToString(), "  /  /", false) == 0)
          {
            this.DataGridView1.Rows[index4].Cells[1].Value = (object) this.DataGridView1.Rows[index4].Cells[1].Value.ToString().Replace("'", "''");
            cmdText = Conversions.ToString(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject((object) "Insert Into SocTran (SocTranClass, SocAccountMainId, SocSubGroupId, SocGroupId, GrpMainId, SocTranType, SocTranNo, SocTranDate, SocTranInt, SocTranPrin, SocTranAmount, ChqNo, ChqDt, BankName, PartyName, AccPart, AccPart1, AccPart2, AccName , SocTranAmountR, SubTranType, SubTranNo, MainAccount ) values (1,'", this.DataGridView1.Rows[index4].Cells[7].Value), (object) " ','"), (object) ""), this.DataGridView1.Rows[index4].Cells[4].Value), (object) "','"), (object) ""), this.DataGridView1.Rows[index4].Cells[5].Value), (object) "','"), (object) ""), this.DataGridView1.Rows[index4].Cells[6].Value), (object) "','"), (object) ""), (object) this.lblType.Text), (object) "','"), (object) ""), (object) Conversion.Val(this.txtSubNo.Text)), (object) "','"), (object) ""), (object) this.mtxtDate.Text), (object) "','"), (object) "0','"), (object) "0','"), (object) ""), Microsoft.VisualBasic.CompilerServices.Operators.SubtractObject(this.DataGridView1.Rows[index4].Cells[2].Value, this.DataGridView1.Rows[index4].Cells[3].Value)), (object) "','"), (object) ""), (object) this.txtChqNo.Text), (object) "','"), (object) ""), (object) this.txtChqDate.Text), (object) "','"), (object) ""), (object) this.txtBillNo.Text), (object) "','"), (object) ""), (object) str2.ToString().Trim()), (object) "','"), (object) ""), (object) this.txtPart1.Text), (object) "','"), (object) ""), (object) this.txtPart2.Text), (object) "','"), (object) ""), (object) this.txtPart3.Text), (object) "','"), (object) ""), (object) this.DataGridView1.Rows[index4].Cells[1].Value.ToString()), (object) "','"), (object) ""), Microsoft.VisualBasic.CompilerServices.Operators.SubtractObject(this.DataGridView1.Rows[index4].Cells[3].Value, this.DataGridView1.Rows[index4].Cells[2].Value)), (object) "','"), (object) ""), (object) this.cmbSubTranType.Text), (object) "','"), (object) ""), (object) Conversion.Val(this.txtSubNo.Text)), (object) "','"), (object) "N')"));
          }
          else
          {
            this.DataGridView1.Rows[index4].Cells[1].Value = (object) this.DataGridView1.Rows[index4].Cells[1].Value.ToString().Replace("'", "''");
            cmdText = Conversions.ToString(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject((object) "Insert Into SocTran (SocTranClass, SocAccountMainId, SocSubGroupId, SocGroupId, GrpMainId, SocTranType, SocTranNo, SocTranDate, SocTranInt, SocTranPrin, SocTranAmount, ChqNo, ChqDt, BankName, PartyName, AccPart, AccPart1, AccPart2, AccName , SocTranAmountR, SocTranbcr, SubTranType, SubTranNo, MainAccount ) values (1,'", this.DataGridView1.Rows[index4].Cells[7].Value), (object) " ','"), (object) ""), this.DataGridView1.Rows[index4].Cells[4].Value), (object) "','"), (object) ""), this.DataGridView1.Rows[index4].Cells[5].Value), (object) "','"), (object) ""), this.DataGridView1.Rows[index4].Cells[6].Value), (object) "','"), (object) ""), (object) this.lblType.Text), (object) "','"), (object) ""), (object) Conversion.Val(this.txtSubNo.Text)), (object) "','"), (object) ""), (object) this.mtxtDate.Text), (object) "','"), (object) "0','"), (object) "0','"), (object) ""), Microsoft.VisualBasic.CompilerServices.Operators.SubtractObject(this.DataGridView1.Rows[index4].Cells[2].Value, this.DataGridView1.Rows[index4].Cells[3].Value)), (object) "','"), (object) ""), (object) this.txtChqNo.Text), (object) "','"), (object) ""), (object) this.txtChqDate.Text), (object) "','"), (object) ""), (object) this.txtBillNo.Text), (object) "','"), (object) ""), (object) str2.ToString().Trim()), (object) "','"), (object) ""), (object) this.txtPart1.Text), (object) "','"), (object) ""), (object) this.txtPart2.Text), (object) "','"), (object) ""), (object) this.txtPart3.Text), (object) "','"), (object) ""), (object) this.DataGridView1.Rows[index4].Cells[1].Value.ToString()), (object) "','"), (object) ""), Microsoft.VisualBasic.CompilerServices.Operators.SubtractObject(this.DataGridView1.Rows[index4].Cells[3].Value, this.DataGridView1.Rows[index4].Cells[2].Value)), (object) "','"), (object) ""), (object) this.mtxtClearDateN.Text), (object) "','"), (object) ""), (object) this.cmbSubTranType.Text), (object) "','"), (object) ""), (object) Conversion.Val(this.txtSubNo.Text)), (object) "','"), (object) "N')"));
          }
      ...
      if (Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.btnSave.Text, "&Delete", false) == 0 | Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.btnSave.Text, "&Update", false) == 0)
      {
        ...
        string cmdText1;
        if (Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.lblType.Text, "Pymt", false) == 0 | Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.lblType.Text, "Ctra", false) == 0)
          cmdText1 = Conversions.ToString(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject((object) ("update SocAccount set Cl_Bal = Cl_Bal + " + Conversions.ToString(Math.Round(Conversion.Val(RuntimeHelpers.GetObjectValue(MyProject.Forms.frmPayment.DataGridView1.CurrentRow.Cells[13].Value)), 2)) + ", Tr_Cr = Tr_Cr - " + Conversions.ToString(Math.Round(Conversion.Val(RuntimeHelpers.GetObjectValue(MyProject.Forms.frmPayment.DataGridView1.CurrentRow.Cells[13].Value)), 2)) + " where SocAccountMainId ="), MyProject.Forms.frmPayment.DataGridView1.CurrentRow.Cells[2].Value), (object) ""));
        if (Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.lblType.Text, "Rcpt", false) == 0)
          cmdText1 = Conversions.ToString(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject((object) ("update SocAccount set Cl_Bal = Cl_Bal + " + Conversions.ToString(Math.Round(Conversion.Val(RuntimeHelpers.GetObjectValue(MyProject.Forms.frmPayment.DataGridView1.CurrentRow.Cells[13].Value)), 2)) + ", Tr_Db = Tr_Db + " + Conversions.ToString(Math.Round(Conversion.Val(RuntimeHelpers.GetObjectValue(MyProject.Forms.frmPayment.DataGridView1.CurrentRow.Cells[13].Value)), 2)) + " where SocAccountMainId ="), MyProject.Forms.frmPayment.DataGridView1.CurrentRow.Cells[2].Value), (object) ""));
  ...
  public DataSet FrmIntilize()
  {
    ...
    if (Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.btnSave.Text, "&Save", false) != 0)
    {
      ...
      this.txtNo.Text = Conversions.ToString(MyProject.Forms.frmPayment.DataGridView1.CurrentRow.Cells[28].Value);
      this.cmbSubTranType.Text = Conversions.ToString(MyProject.Forms.frmPayment.DataGridView1.CurrentRow.Cells[27].Value);
      this.lblSubTranType.Text = Conversions.ToString(MyProject.Forms.frmPayment.DataGridView1.CurrentRow.Cells[27].Value);
      this.txtSubNo.Text = Conversions.ToString(MyProject.Forms.frmPayment.DataGridView1.CurrentRow.Cells[28].Value);
      ...
      this.mtxtClearDate.Text = MyProject.Forms.frmPayment.DataGridView1.CurrentRow.Cells[15].Value.ToString();
      OleDbConnection selectConnection = new OleDbConnection($"Provider=Microsoft.ACE.OLEDB.12.0;Data Source={Constant.socDataPath}{Constant.SocDataFile}");
      ...
      while (index <= num)
      {
        ...
        this.mtxtClearDateN.Text = this.DataGridView4.Rows[index].Cells[16 /*0x10*/].Value.ToString();
        checked { ++index; }
      }
      if (Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.lblType.Text, "Pymt", false) == 0 | Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.lblType.Text, "Ctra", false) == 0)
        this.btnTotal.Text = (Conversion.Val(this.btnDrTotal.Text) - Conversion.Val(this.btnCrTotal.Text)).ToString("0.00");
      ...
      if (Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.lblType.Text, "Pymt", false) == 0)
      {
        ...
        {
          this.lblAuditId.Text = Conversions.ToString(this.DataGridView8.Rows[0].Cells[0].Value);
          this.chkAll.Checked = Conversions.ToBoolean(this.DataGridView8.Rows[0].Cells[6].Value);
          this.chkComSign.Checked = Conversions.ToBoolean(this.DataGridView8.Rows[0].Cells[7].Value);
          this.chkRecsign.Checked = Conversions.ToBoolean(this.DataGridView8.Rows[0].Cells[8].Value);
          this.chkSupport.Checked = Conversions.ToBoolean(this.DataGridView8.Rows[0].Cells[9].Value);
          this.chkMeetingapprov.Checked = Conversions.ToBoolean(this.DataGridView8.Rows[0].Cells[10].Value);
          this.chkTDS.Checked = Conversions.ToBoolean(this.DataGridView8.Rows[0].Cells[11].Value);
          this.chkVoucher.Checked = Conversions.ToBoolean(this.DataGridView8.Rows[0].Cells[12].Value);
          this.chkExcesscashlimit.Checked = Conversions.ToBoolean(this.DataGridView8.Rows[0].Cells[13].Value);
          this.txtChkRem1.Text = this.DataGridView8.Rows[0].Cells[14].Value.ToString();
          this.txtChkRem2.Text = this.DataGridView8.Rows[0].Cells[15].Value.ToString();
        }
      }
  ...
  private void btnPerson_Click(object sender, EventArgs e)
  {
    ...
    frmVendorDetail.txtCode.Text = this.DataGridView10.RowCount <= 0 ? Conversions.ToString(1) : Conversions.ToString(checked (this.DataGridView10.Rows.Cast<DataGridViewRow>().Select<DataGridViewRow, int>((System.Func<DataGridViewRow, int>) ([SpecialName] (T) => Conversions.ToInteger(T.Cells["SrNo"].Value))).Max() + 1));
  ...
  private void btnDetail_Click(object sender, EventArgs e)
  {
    ...
    try
    {
      foreach (DataGridViewRow row in (IEnumerable) this.DataGridView12.Rows)
  ...
  public DataSet GetFillGridShowVendor()
  {
    ...
    this.DataGridView12.ColumnCount = 25;
    this.DataGridView12.RowCount = 0;
    this.DataGridView12.Columns[0].HeaderText = "Type-No";
    this.DataGridView12.Columns[1].HeaderText = "Date";
    this.DataGridView12.Columns[2].HeaderText = "Code";
    this.DataGridView12.Columns[3].HeaderText = "Particular";
    this.DataGridView12.Columns[4].HeaderText = "Debit";
    this.DataGridView12.Columns[5].HeaderText = "Credit";
    this.DataGridView12.Columns[6].HeaderText = "Flag";
    ...
    if (this.DataGridView11.RowCount > 0)
    {
      this.DataGridView12.Rows.Add();
      this.DataGridView12.Rows[checked (this.DataGridView12.RowCount - 1)].Cells[0].Value = (object) "";
      this.DataGridView12.Rows[checked (this.DataGridView12.RowCount - 1)].Cells[1].Value = (object) "";
      this.DataGridView12.Rows[checked (this.DataGridView12.RowCount - 1)].Cells[2].Value = (object) "";
      this.DataGridView12.Rows[checked (this.DataGridView12.RowCount - 1)].Cells[3].Value = (object) this.DataGridView11.Rows[0].Cells[0].Value.ToString().Trim();
      this.DataGridView12.Rows[checked (this.DataGridView12.RowCount - 1)].Cells[4].Value = (object) "";
      this.DataGridView12.Rows[checked (this.DataGridView12.RowCount - 1)].Cells[5].Value = (object) "";
      this.DataGridView12.Rows[checked (this.DataGridView12.RowCount - 1)].Cells[6].Value = (object) "B";
      if (Microsoft.VisualBasic.Strings.Len(this.DataGridView11.Rows[0].Cells[21].Value.ToString().Trim()) > 0)
      {
        this.DataGridView12.Rows.Add();
        this.DataGridView12.Rows[checked (this.DataGridView12.RowCount - 1)].Cells[0].Value = (object) "";
        this.DataGridView12.Rows[checked (this.DataGridView12.RowCount - 1)].Cells[1].Value = (object) "Contract Period";
        this.DataGridView12.Rows[checked (this.DataGridView12.RowCount - 1)].Cells[2].Value = (object) "";
        this.DataGridView12.Rows[checked (this.DataGridView12.RowCount - 1)].Cells[3].Value = (object) this.DataGridView11.Rows[0].Cells[21].Value.ToString().Trim();
        this.DataGridView12.Rows[checked (this.DataGridView12.RowCount - 1)].Cells[4].Value = (object) "";
        this.DataGridView12.Rows[checked (this.DataGridView12.RowCount - 1)].Cells[5].Value = (object) "";
        this.DataGridView12.Rows[checked (this.DataGridView12.RowCount - 1)].Cells[6].Value = (object) "D";
      }
      if (Conversion.Val(this.DataGridView11.Rows[0].Cells[22].Value.ToString().Trim()) != 0.0)
      {
        this.DataGridView12.Rows.Add();
        this.DataGridView12.Rows[checked (this.DataGridView12.RowCount - 1)].Cells[0].Value = (object) "";
        this.DataGridView12.Rows[checked (this.DataGridView12.RowCount - 1)].Cells[1].Value = (object) "Contract Value";
        this.DataGridView12.Rows[checked (this.DataGridView12.RowCount - 1)].Cells[2].Value = (object) "";
        this.DataGridView12.Rows[checked (this.DataGridView12.RowCount - 1)].Cells[3].Value = (object) this.DataGridView11.Rows[0].Cells[22].Value.ToString().Trim();
        this.DataGridView12.Rows[checked (this.DataGridView12.RowCount - 1)].Cells[4].Value = (object) "";
        this.DataGridView12.Rows[checked (this.DataGridView12.RowCount - 1)].Cells[5].Value = (object) "";
        this.DataGridView12.Rows[checked (this.DataGridView12.RowCount - 1)].Cells[6].Value = (object) "D";
      }
      if (Microsoft.VisualBasic.Strings.Len(this.DataGridView11.Rows[0].Cells[23].Value.ToString().Trim()) > 0)
      {
        this.DataGridView12.Rows.Add();
        this.DataGridView12.Rows[checked (this.DataGridView12.RowCount - 1)].Cells[0].Value = (object) "";
        this.DataGridView12.Rows[checked (this.DataGridView12.RowCount - 1)].Cells[1].Value = (object) "Contract Detail";
        this.DataGridView12.Rows[checked (this.DataGridView12.RowCount - 1)].Cells[2].Value = (object) "";
        this.DataGridView12.Rows[checked (this.DataGridView12.RowCount - 1)].Cells[3].Value = (object) this.DataGridView11.Rows[0].Cells[23].Value.ToString().Trim();
        this.DataGridView12.Rows[checked (this.DataGridView12.RowCount - 1)].Cells[4].Value = (object) "";
        this.DataGridView12.Rows[checked (this.DataGridView12.RowCount - 1)].Cells[5].Value = (object) "";
        this.DataGridView12.Rows[checked (this.DataGridView12.RowCount - 1)].Cells[6].Value = (object) "D";
      }
      string Left = "";
      string Right = "";
      int num = checked (this.DataGridView11.RowCount - 1);
      int index = 0;
      while (index <= num)
      {
        this.DataGridView12.Rows.Add();
        this.DataGridView12.Rows[checked (this.DataGridView12.RowCount - 1)].Cells[0].Value = Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.DataGridView11.Rows[index].Cells[2].Value.ToString().Trim(), "Jrnl", false) != 0 ? (object) $"{this.DataGridView11.Rows[index].Cells[4].Value.ToString().Trim()}-{this.DataGridView11.Rows[index].Cells[5].Value.ToString().Trim()}" : (object) $"{this.DataGridView11.Rows[index].Cells[2].Value.ToString().Trim()}-{this.DataGridView11.Rows[index].Cells[3].Value.ToString().Trim()}";
        this.DataGridView12.Rows[checked (this.DataGridView12.RowCount - 1)].Cells[1].Value = (object) this.DataGridView11.Rows[index].Cells[1].Value.ToString().Trim().Substring(0, 10);
        this.DataGridView12.Rows[checked (this.DataGridView12.RowCount - 1)].Cells[2].Value = (object) this.DataGridView11.Rows[index].Cells[6].Value.ToString().Trim();
        this.DataGridView12.Rows[checked (this.DataGridView12.RowCount - 1)].Cells[3].Value = (object) this.DataGridView11.Rows[index].Cells[7].Value.ToString().Trim();
        if (Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView11.Rows[index].Cells[8].Value)) > 0.0)
          this.DataGridView12.Rows[checked (this.DataGridView12.RowCount - 1)].Cells[4].Value = (object) Math.Round(Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView11.Rows[index].Cells[8].Value)), 2);
        else
          this.DataGridView12.Rows[checked (this.DataGridView12.RowCount - 1)].Cells[5].Value = (object) Math.Round(-Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView11.Rows[index].Cells[8].Value)), 2);
        this.DataGridView12.Rows[checked (this.DataGridView12.RowCount - 1)].Cells[6].Value = (object) "E";
        if (index > 0)
        {
          if (index == checked (this.DataGridView11.RowCount - 1))
          {
            Left = "";
            Right = $"{this.DataGridView11.Rows[index].Cells[4].Value.ToString().Trim()}-{this.DataGridView11.Rows[index].Cells[5].Value.ToString().Trim()}";
          }
          else
          {
            Left = $"{this.DataGridView11.Rows[checked (index + 1)].Cells[4].Value.ToString().Trim()}-{this.DataGridView11.Rows[checked (index + 1)].Cells[5].Value.ToString().Trim()}";
            Right = $"{this.DataGridView11.Rows[index].Cells[4].Value.ToString().Trim()}-{this.DataGridView11.Rows[index].Cells[5].Value.ToString().Trim()}";
          }
        }
        if (Microsoft.VisualBasic.CompilerServices.Operators.CompareString(Left, Right, false) != 0)
        {
          if (Microsoft.VisualBasic.Strings.Len($"{this.DataGridView11.Rows[index].Cells[9].Value.ToString().Trim()},{this.DataGridView11.Rows[index].Cells[10].Value.ToString().Trim()},{this.DataGridView11.Rows[index].Cells[11].Value.ToString().Trim()}") > 2)
          {
            this.DataGridView12.Rows.Add();
            this.DataGridView12.Rows[checked (this.DataGridView12.RowCount - 1)].Cells[0].Value = (object) "";
            this.DataGridView12.Rows[checked (this.DataGridView12.RowCount - 1)].Cells[1].Value = (object) "";
            this.DataGridView12.Rows[checked (this.DataGridView12.RowCount - 1)].Cells[2].Value = (object) "";
            this.DataGridView12.Rows[checked (this.DataGridView12.RowCount - 1)].Cells[3].Value = (object) $"{this.DataGridView11.Rows[index].Cells[9].Value.ToString().Trim()},{this.DataGridView11.Rows[index].Cells[10].Value.ToString().Trim()},{this.DataGridView11.Rows[index].Cells[11].Value.ToString().Trim()}";
            this.DataGridView12.Rows[checked (this.DataGridView12.RowCount - 1)].Cells[4].Value = (object) "";
            this.DataGridView12.Rows[checked (this.DataGridView12.RowCount - 1)].Cells[5].Value = (object) "";
            this.DataGridView12.Rows[checked (this.DataGridView12.RowCount - 1)].Cells[6].Value = (object) "F";
          }
          if (Microsoft.VisualBasic.Strings.Len($"{this.DataGridView11.Rows[index].Cells[12].Value.ToString().Trim()},{this.DataGridView11.Rows[index].Cells[13].Value.ToString().Trim()}") > 2)
          {
            this.DataGridView12.Rows.Add();
            this.DataGridView12.Rows[checked (this.DataGridView12.RowCount - 1)].Cells[0].Value = (object) "";
            this.DataGridView12.Rows[checked (this.DataGridView12.RowCount - 1)].Cells[1].Value = (object) "";
            this.DataGridView12.Rows[checked (this.DataGridView12.RowCount - 1)].Cells[2].Value = (object) "";
            this.DataGridView12.Rows[checked (this.DataGridView12.RowCount - 1)].Cells[3].Value = (object) $"{this.DataGridView11.Rows[index].Cells[12].Value.ToString().Trim()},{this.DataGridView11.Rows[index].Cells[13].Value.ToString().Trim()}";
            this.DataGridView12.Rows[checked (this.DataGridView12.RowCount - 1)].Cells[4].Value = (object) "";
            this.DataGridView12.Rows[checked (this.DataGridView12.RowCount - 1)].Cells[5].Value = (object) "";
            this.DataGridView12.Rows[checked (this.DataGridView12.RowCount - 1)].Cells[6].Value = (object) "F";
          }
    ...
    this.DataGridView12.Columns[0].Name = "C1";
    this.DataGridView12.Columns[1].Name = "C2";
    this.DataGridView12.Columns[2].Name = "C3";
    this.DataGridView12.Columns[3].Name = "C4";
    this.DataGridView12.Columns[4].Name = "C5";
    this.DataGridView12.Columns[5].Name = "C6";
    this.DataGridView12.Columns[6].Name = "C7";
