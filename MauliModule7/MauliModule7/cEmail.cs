...
public class cEmail
{
    ...
    object subText)
  {
    ...
    message.Subject = Conversions.ToString(subText);
    message.Body = Conversions.ToString(sText);
    Attachment attachment = new Attachment(Conversions.ToString(path));
    ...
    try
    {
      ...
      Console.WriteLine("message send sucussfully...");
