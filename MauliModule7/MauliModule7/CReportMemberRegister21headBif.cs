...
// Type: MauliModule7.CReportMemberRegister21headBif
...
public class CReportMemberRegister21headBif : ReportClass
{
  private static List<WeakReference> __ENCList = new List<WeakReference>();

  [DebuggerNonUserCode]
  static CReportMemberRegister21headBif()
  {
  }
  ...
  {
    lock (CReportMemberRegister21headBif.__ENCList)
    {
      if (CReportMemberRegister21headBif.__ENCList.Count == CReportMemberRegister21headBif.__ENCList.Capacity)
      {
        int index1 = 0;
        int num = checked (CReportMemberRegister21headBif.__ENCList.Count - 1);
        int index2 = 0;
        while (index2 <= num)
        {
          if (CReportMemberRegister21headBif.__ENCList[index2].IsAlive)
          {
            if (index2 != index1)
              CReportMemberRegister21headBif.__ENCList[index1] = CReportMemberRegister21headBif.__ENCList[index2];
            checked { ++index1; }
          }
          checked { ++index2; }
        }
        CReportMemberRegister21headBif.__ENCList.RemoveRange(index1, checked (CReportMemberRegister21headBif.__ENCList.Count - index1));
        CReportMemberRegister21headBif.__ENCList.Capacity = CReportMemberRegister21headBif.__ENCList.Count;
      }
      CReportMemberRegister21headBif.__ENCList.Add(new WeakReference(RuntimeHelpers.GetObjectValue(value)));
    }
  }

  public CReportMemberRegister21headBif()
  {
    CReportMemberRegister21headBif.__ENCAddToList((object) this);
  }

  public override string ResourceName
  {
    get => "CReportMemberRegister21headBif.rpt";
    set
    {
    }
  }
  ...
  {
    get => "MauliModule7.CReportMemberRegister21headBif.rpt";
    set
    {
    }
  }
  ...
  [Browsable(false)]
  [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
  public Section DetailSection1 => this.ReportDefinition.Sections[8];
  ...
  [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
  [Browsable(false)]
  public Section DetailSection13 => this.ReportDefinition.Sections[10];

  [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
  [Browsable(false)]
  public Section DetailSection14 => this.ReportDefinition.Sections[11];
