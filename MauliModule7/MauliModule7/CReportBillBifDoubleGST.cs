...
// Type: MauliModule7.CReportBillBifDoubleGST
...
public class CReportBillBifDoubleGST : ReportClass
{
  private static List<WeakReference> __ENCList = new List<WeakReference>();

  [DebuggerNonUserCode]
  static CReportBillBifDoubleGST()
  {
  }
  ...
  {
    lock (CReportBillBifDoubleGST.__ENCList)
    {
      if (CReportBillBifDoubleGST.__ENCList.Count == CReportBillBifDoubleGST.__ENCList.Capacity)
      {
        int index1 = 0;
        int num = checked (CReportBillBifDoubleGST.__ENCList.Count - 1);
        int index2 = 0;
        while (index2 <= num)
        {
          if (CReportBillBifDoubleGST.__ENCList[index2].IsAlive)
          {
            if (index2 != index1)
              CReportBillBifDoubleGST.__ENCList[index1] = CReportBillBifDoubleGST.__ENCList[index2];
            checked { ++index1; }
          }
          checked { ++index2; }
        }
        CReportBillBifDoubleGST.__ENCList.RemoveRange(index1, checked (CReportBillBifDoubleGST.__ENCList.Count - index1));
        CReportBillBifDoubleGST.__ENCList.Capacity = CReportBillBifDoubleGST.__ENCList.Count;
      }
      CReportBillBifDoubleGST.__ENCList.Add(new WeakReference(RuntimeHelpers.GetObjectValue(value)));
    }
  }

  public CReportBillBifDoubleGST() => CReportBillBifDoubleGST.__ENCAddToList((object) this);

  public override string ResourceName
  {
    get => "CReportBillBifDoubleGST.rpt";
    set
    {
    }
  }
  ...
  {
    get => "MauliModule7.CReportBillBifDoubleGST.rpt";
    set
    {
    }
  }
