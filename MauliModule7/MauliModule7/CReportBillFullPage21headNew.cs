...
// Type: MauliModule7.CReportBillFullPage21headNew
...
public class CReportBillFullPage21headNew : ReportClass
{
  private static List<WeakReference> __ENCList = new List<WeakReference>();

  [DebuggerNonUserCode]
  static CReportBillFullPage21headNew()
  {
  }
  ...
  {
    lock (CReportBillFullPage21headNew.__ENCList)
    {
      if (CReportBillFullPage21headNew.__ENCList.Count == CReportBillFullPage21headNew.__ENCList.Capacity)
      {
        int index1 = 0;
        int num = checked (CReportBillFullPage21headNew.__ENCList.Count - 1);
        int index2 = 0;
        while (index2 <= num)
        {
          if (CReportBillFullPage21headNew.__ENCList[index2].IsAlive)
          {
            if (index2 != index1)
              CReportBillFullPage21headNew.__ENCList[index1] = CReportBillFullPage21headNew.__ENCList[index2];
            checked { ++index1; }
          }
          checked { ++index2; }
        }
        CReportBillFullPage21headNew.__ENCList.RemoveRange(index1, checked (CReportBillFullPage21headNew.__ENCList.Count - index1));
        CReportBillFullPage21headNew.__ENCList.Capacity = CReportBillFullPage21headNew.__ENCList.Count;
      }
      CReportBillFullPage21headNew.__ENCList.Add(new WeakReference(RuntimeHelpers.GetObjectValue(value)));
    }
  }

  public CReportBillFullPage21headNew()
  {
    CReportBillFullPage21headNew.__ENCAddToList((object) this);
  }

  public override string ResourceName
  {
    get => "CReportBillFullPage21headNew.rpt";
    set
    {
    }
  }
  ...
  {
    get => "MauliModule7.CReportBillFullPage21headNew.rpt";
    set
    {
    }
  }
  ...
  [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
  [Browsable(false)]
  public Section DetailSection5 => this.ReportDefinition.Sections[4];
