...
// Type: MauliModule7.CReportBillHalfPageVerticalSR
...
public class CReportBillHalfPageVerticalSR : ReportClass
{
  private static List<WeakReference> __ENCList = new List<WeakReference>();

  [DebuggerNonUserCode]
  static CReportBillHalfPageVerticalSR()
  {
  }
  ...
  {
    lock (CReportBillHalfPageVerticalSR.__ENCList)
    {
      if (CReportBillHalfPageVerticalSR.__ENCList.Count == CReportBillHalfPageVerticalSR.__ENCList.Capacity)
      {
        int index1 = 0;
        int num = checked (CReportBillHalfPageVerticalSR.__ENCList.Count - 1);
        int index2 = 0;
        while (index2 <= num)
        {
          if (CReportBillHalfPageVerticalSR.__ENCList[index2].IsAlive)
          {
            if (index2 != index1)
              CReportBillHalfPageVerticalSR.__ENCList[index1] = CReportBillHalfPageVerticalSR.__ENCList[index2];
            checked { ++index1; }
          }
          checked { ++index2; }
        }
        CReportBillHalfPageVerticalSR.__ENCList.RemoveRange(index1, checked (CReportBillHalfPageVerticalSR.__ENCList.Count - index1));
        CReportBillHalfPageVerticalSR.__ENCList.Capacity = CReportBillHalfPageVerticalSR.__ENCList.Count;
      }
      CReportBillHalfPageVerticalSR.__ENCList.Add(new WeakReference(RuntimeHelpers.GetObjectValue(value)));
    }
  }

  public CReportBillHalfPageVerticalSR()
  {
    CReportBillHalfPageVerticalSR.__ENCAddToList((object) this);
  }

  public override string ResourceName
  {
    get => "CReportBillHalfPageVerticalSR.rpt";
    set
    {
    }
  }
  ...
  {
    get => "MauliModule7.CReportBillHalfPageVerticalSR.rpt";
    set
    {
    }
  }
