...
// Type: MauliModule7.CReportMemberControlAccount21Head
...
public class CReportMemberControlAccount21Head : ReportClass
{
  private static List<WeakReference> __ENCList = new List<WeakReference>();

  [DebuggerNonUserCode]
  static CReportMemberControlAccount21Head()
  {
  }
  ...
  {
    lock (CReportMemberControlAccount21Head.__ENCList)
    {
      if (CReportMemberControlAccount21Head.__ENCList.Count == CReportMemberControlAccount21Head.__ENCList.Capacity)
      {
        int index1 = 0;
        int num = checked (CReportMemberControlAccount21Head.__ENCList.Count - 1);
        int index2 = 0;
        while (index2 <= num)
        {
          if (CReportMemberControlAccount21Head.__ENCList[index2].IsAlive)
          {
            if (index2 != index1)
              CReportMemberControlAccount21Head.__ENCList[index1] = CReportMemberControlAccount21Head.__ENCList[index2];
            checked { ++index1; }
          }
          checked { ++index2; }
        }
        CReportMemberControlAccount21Head.__ENCList.RemoveRange(index1, checked (CReportMemberControlAccount21Head.__ENCList.Count - index1));
        CReportMemberControlAccount21Head.__ENCList.Capacity = CReportMemberControlAccount21Head.__ENCList.Count;
      }
      CReportMemberControlAccount21Head.__ENCList.Add(new WeakReference(RuntimeHelpers.GetObjectValue(value)));
    }
  }

  public CReportMemberControlAccount21Head()
  {
    CReportMemberControlAccount21Head.__ENCAddToList((object) this);
  }

  public override string ResourceName
  {
    get => "CReportMemberControlAccount21Head.rpt";
    set
    {
    }
  }
  ...
  {
    get => "MauliModule7.CReportMemberControlAccount21Head.rpt";
    set
    {
    }
  }
  ...
  [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
  [Browsable(false)]
  public Section DetailSection7 => this.ReportDefinition.Sections[4];
