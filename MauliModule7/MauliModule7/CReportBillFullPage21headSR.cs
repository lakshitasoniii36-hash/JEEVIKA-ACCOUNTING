...
// Type: MauliModule7.CReportBillFullPage21headSR
...
public class CReportBillFullPage21headSR : ReportClass
{
  private static List<WeakReference> __ENCList = new List<WeakReference>();

  [DebuggerNonUserCode]
  static CReportBillFullPage21headSR()
  {
  }
  ...
  {
    lock (CReportBillFullPage21headSR.__ENCList)
    {
      if (CReportBillFullPage21headSR.__ENCList.Count == CReportBillFullPage21headSR.__ENCList.Capacity)
      {
        int index1 = 0;
        int num = checked (CReportBillFullPage21headSR.__ENCList.Count - 1);
        int index2 = 0;
        while (index2 <= num)
        {
          if (CReportBillFullPage21headSR.__ENCList[index2].IsAlive)
          {
            if (index2 != index1)
              CReportBillFullPage21headSR.__ENCList[index1] = CReportBillFullPage21headSR.__ENCList[index2];
            checked { ++index1; }
          }
          checked { ++index2; }
        }
        CReportBillFullPage21headSR.__ENCList.RemoveRange(index1, checked (CReportBillFullPage21headSR.__ENCList.Count - index1));
        CReportBillFullPage21headSR.__ENCList.Capacity = CReportBillFullPage21headSR.__ENCList.Count;
      }
      CReportBillFullPage21headSR.__ENCList.Add(new WeakReference(RuntimeHelpers.GetObjectValue(value)));
    }
  }

  public CReportBillFullPage21headSR() => CReportBillFullPage21headSR.__ENCAddToList((object) this);

  public override string ResourceName
  {
    get => "CReportBillFullPage21headSR.rpt";
    set
    {
    }
  }
  ...
  {
    get => "MauliModule7.CReportBillFullPage21headSR.rpt";
    set
    {
    }
  }
