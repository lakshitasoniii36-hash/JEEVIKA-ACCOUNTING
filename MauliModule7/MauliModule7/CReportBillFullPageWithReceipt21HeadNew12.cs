...
// Type: MauliModule7.CReportBillFullPageWithReceipt21HeadNew12
...
public class CReportBillFullPageWithReceipt21HeadNew12 : ReportClass
{
  private static List<WeakReference> __ENCList = new List<WeakReference>();

  [DebuggerNonUserCode]
  static CReportBillFullPageWithReceipt21HeadNew12()
  {
  }
  ...
  {
    lock (CReportBillFullPageWithReceipt21HeadNew12.__ENCList)
    {
      if (CReportBillFullPageWithReceipt21HeadNew12.__ENCList.Count == CReportBillFullPageWithReceipt21HeadNew12.__ENCList.Capacity)
      {
        int index1 = 0;
        int num = checked (CReportBillFullPageWithReceipt21HeadNew12.__ENCList.Count - 1);
        int index2 = 0;
        while (index2 <= num)
        {
          if (CReportBillFullPageWithReceipt21HeadNew12.__ENCList[index2].IsAlive)
          {
            if (index2 != index1)
              CReportBillFullPageWithReceipt21HeadNew12.__ENCList[index1] = CReportBillFullPageWithReceipt21HeadNew12.__ENCList[index2];
            checked { ++index1; }
          }
          checked { ++index2; }
        }
        CReportBillFullPageWithReceipt21HeadNew12.__ENCList.RemoveRange(index1, checked (CReportBillFullPageWithReceipt21HeadNew12.__ENCList.Count - index1));
        CReportBillFullPageWithReceipt21HeadNew12.__ENCList.Capacity = CReportBillFullPageWithReceipt21HeadNew12.__ENCList.Count;
      }
      CReportBillFullPageWithReceipt21HeadNew12.__ENCList.Add(new WeakReference(RuntimeHelpers.GetObjectValue(value)));
    }
  }

  public CReportBillFullPageWithReceipt21HeadNew12()
  {
    CReportBillFullPageWithReceipt21HeadNew12.__ENCAddToList((object) this);
  }

  public override string ResourceName
  {
    get => "CReportBillFullPageWithReceipt21HeadNew12.rpt";
    set
    {
    }
  }
  ...
  {
    get => "MauliModule7.CReportBillFullPageWithReceipt21HeadNew12.rpt";
    set
    {
    }
  }
  ...
  [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
  [Browsable(false)]
  public Section DetailSection6 => this.ReportDefinition.Sections[5];
  ...
  [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
  [Browsable(false)]
  public Section DetailSection3 => this.ReportDefinition.Sections[8];
  ...
  [Browsable(false)]
  [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
  public Section GroupFooterSection4 => this.ReportDefinition.Sections[10];
  ...
  [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
  [Browsable(false)]
  public IParameterField Parameter_PrintColRec
  {
