...
// Type: MauliModule7.CReportBillRegister14headVerticalsqftLine
...
public class CReportBillRegister14headVerticalsqftLine : ReportClass
{
  private static List<WeakReference> __ENCList = new List<WeakReference>();

  [DebuggerNonUserCode]
  static CReportBillRegister14headVerticalsqftLine()
  {
  }
  ...
  {
    lock (CReportBillRegister14headVerticalsqftLine.__ENCList)
    {
      if (CReportBillRegister14headVerticalsqftLine.__ENCList.Count == CReportBillRegister14headVerticalsqftLine.__ENCList.Capacity)
      {
        int index1 = 0;
        int num = checked (CReportBillRegister14headVerticalsqftLine.__ENCList.Count - 1);
        int index2 = 0;
        while (index2 <= num)
        {
          if (CReportBillRegister14headVerticalsqftLine.__ENCList[index2].IsAlive)
          {
            if (index2 != index1)
              CReportBillRegister14headVerticalsqftLine.__ENCList[index1] = CReportBillRegister14headVerticalsqftLine.__ENCList[index2];
            checked { ++index1; }
          }
          checked { ++index2; }
        }
        CReportBillRegister14headVerticalsqftLine.__ENCList.RemoveRange(index1, checked (CReportBillRegister14headVerticalsqftLine.__ENCList.Count - index1));
        CReportBillRegister14headVerticalsqftLine.__ENCList.Capacity = CReportBillRegister14headVerticalsqftLine.__ENCList.Count;
      }
      CReportBillRegister14headVerticalsqftLine.__ENCList.Add(new WeakReference(RuntimeHelpers.GetObjectValue(value)));
    }
  }

  public CReportBillRegister14headVerticalsqftLine()
  {
    CReportBillRegister14headVerticalsqftLine.__ENCAddToList((object) this);
  }

  public override string ResourceName
  {
    get => "CReportBillRegister14headVerticalsqftLine.rpt";
    set
    {
    }
  }
  ...
  {
    get => "MauliModule7.CReportBillRegister14headVerticalsqftLine.rpt";
    set
    {
    }
  }
  ...
  [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
  [Browsable(false)]
  public Section ReportFooterSection2 => this.ReportDefinition.Sections[8];
