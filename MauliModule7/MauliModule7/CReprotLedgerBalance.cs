...
// Type: MauliModule7.CReprotLedgerBalance
...
public class CReprotLedgerBalance : ReportClass
{
  private static List<WeakReference> __ENCList = new List<WeakReference>();

  [DebuggerNonUserCode]
  static CReprotLedgerBalance()
  {
  }
  ...
  {
    lock (CReprotLedgerBalance.__ENCList)
    {
      if (CReprotLedgerBalance.__ENCList.Count == CReprotLedgerBalance.__ENCList.Capacity)
      {
        int index1 = 0;
        int num = checked (CReprotLedgerBalance.__ENCList.Count - 1);
        int index2 = 0;
        while (index2 <= num)
        {
          if (CReprotLedgerBalance.__ENCList[index2].IsAlive)
          {
            if (index2 != index1)
              CReprotLedgerBalance.__ENCList[index1] = CReprotLedgerBalance.__ENCList[index2];
            checked { ++index1; }
          }
          checked { ++index2; }
        }
        CReprotLedgerBalance.__ENCList.RemoveRange(index1, checked (CReprotLedgerBalance.__ENCList.Count - index1));
        CReprotLedgerBalance.__ENCList.Capacity = CReprotLedgerBalance.__ENCList.Count;
      }
      CReprotLedgerBalance.__ENCList.Add(new WeakReference(RuntimeHelpers.GetObjectValue(value)));
    }
  }

  public CReprotLedgerBalance() => CReprotLedgerBalance.__ENCAddToList((object) this);

  public override string ResourceName
  {
    get => "CReprotLedgerBalance.rpt";
    set
    {
    }
  }
  ...
  {
    get => "MauliModule7.CReprotLedgerBalance.rpt";
    set
    {
    }
  }
  ...
  [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
  [Browsable(false)]
  public Section GroupFooterSection4 => this.ReportDefinition.Sections[9];

  [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
  [Browsable(false)]
  public Section GroupFooterSection6 => this.ReportDefinition.Sections[10];

  [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
  [Browsable(false)]
  public Section GroupFooterSection3 => this.ReportDefinition.Sections[11];
  ...
  [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
  [Browsable(false)]
  public IParameterField Parameter_PDetail
  {
  ...
  [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
  [Browsable(false)]
  public IParameterField Parameter_MBreak
  {
