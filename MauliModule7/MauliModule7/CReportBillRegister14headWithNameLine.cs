...
// Type: MauliModule7.CReportBillRegister14headWithNameLine
...
public class CReportBillRegister14headWithNameLine : ReportClass
{
  private static List<WeakReference> __ENCList = new List<WeakReference>();

  [DebuggerNonUserCode]
  static CReportBillRegister14headWithNameLine()
  {
  }
  ...
  {
    lock (CReportBillRegister14headWithNameLine.__ENCList)
    {
      if (CReportBillRegister14headWithNameLine.__ENCList.Count == CReportBillRegister14headWithNameLine.__ENCList.Capacity)
      {
        int index1 = 0;
        int num = checked (CReportBillRegister14headWithNameLine.__ENCList.Count - 1);
        int index2 = 0;
        while (index2 <= num)
        {
          if (CReportBillRegister14headWithNameLine.__ENCList[index2].IsAlive)
          {
            if (index2 != index1)
              CReportBillRegister14headWithNameLine.__ENCList[index1] = CReportBillRegister14headWithNameLine.__ENCList[index2];
            checked { ++index1; }
          }
          checked { ++index2; }
        }
        CReportBillRegister14headWithNameLine.__ENCList.RemoveRange(index1, checked (CReportBillRegister14headWithNameLine.__ENCList.Count - index1));
        CReportBillRegister14headWithNameLine.__ENCList.Capacity = CReportBillRegister14headWithNameLine.__ENCList.Count;
      }
      CReportBillRegister14headWithNameLine.__ENCList.Add(new WeakReference(RuntimeHelpers.GetObjectValue(value)));
    }
  }

  public CReportBillRegister14headWithNameLine()
  {
    CReportBillRegister14headWithNameLine.__ENCAddToList((object) this);
  }

  public override string ResourceName
  {
    get => "CReportBillRegister14headWithNameLine.rpt";
    set
    {
    }
  }
  ...
  {
    get => "MauliModule7.CReportBillRegister14headWithNameLine.rpt";
    set
    {
    }
  }
