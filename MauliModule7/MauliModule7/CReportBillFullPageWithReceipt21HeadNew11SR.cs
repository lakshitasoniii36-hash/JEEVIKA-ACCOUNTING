...
// Type: MauliModule7.CReportBillFullPageWithReceipt21HeadNew11SR
...
public class CReportBillFullPageWithReceipt21HeadNew11SR : ReportClass
{
  private static List<WeakReference> __ENCList = new List<WeakReference>();

  [DebuggerNonUserCode]
  static CReportBillFullPageWithReceipt21HeadNew11SR()
  {
  }
  ...
  {
    lock (CReportBillFullPageWithReceipt21HeadNew11SR.__ENCList)
    {
      if (CReportBillFullPageWithReceipt21HeadNew11SR.__ENCList.Count == CReportBillFullPageWithReceipt21HeadNew11SR.__ENCList.Capacity)
      {
        int index1 = 0;
        int num = checked (CReportBillFullPageWithReceipt21HeadNew11SR.__ENCList.Count - 1);
        int index2 = 0;
        while (index2 <= num)
        {
          if (CReportBillFullPageWithReceipt21HeadNew11SR.__ENCList[index2].IsAlive)
          {
            if (index2 != index1)
              CReportBillFullPageWithReceipt21HeadNew11SR.__ENCList[index1] = CReportBillFullPageWithReceipt21HeadNew11SR.__ENCList[index2];
            checked { ++index1; }
          }
          checked { ++index2; }
        }
        CReportBillFullPageWithReceipt21HeadNew11SR.__ENCList.RemoveRange(index1, checked (CReportBillFullPageWithReceipt21HeadNew11SR.__ENCList.Count - index1));
        CReportBillFullPageWithReceipt21HeadNew11SR.__ENCList.Capacity = CReportBillFullPageWithReceipt21HeadNew11SR.__ENCList.Count;
      }
      CReportBillFullPageWithReceipt21HeadNew11SR.__ENCList.Add(new WeakReference(RuntimeHelpers.GetObjectValue(value)));
    }
  }

  public CReportBillFullPageWithReceipt21HeadNew11SR()
  {
    CReportBillFullPageWithReceipt21HeadNew11SR.__ENCAddToList((object) this);
  }

  public override string ResourceName
  {
    get => "CReportBillFullPageWithReceipt21HeadNew11SR.rpt";
    set
    {
    }
  }
  ...
  {
    get => "MauliModule7.CReportBillFullPageWithReceipt21HeadNew11SR.rpt";
    set
    {
    }
  }
  ...
  [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
  [Browsable(false)]
  public Section DetailSection4 => this.ReportDefinition.Sections[11];
