...
// Type: MauliModule7.CReportBillRegister14headVertical
...
public class CReportBillRegister14headVertical : ReportClass
{
  private static List<WeakReference> __ENCList = new List<WeakReference>();

  [DebuggerNonUserCode]
  static CReportBillRegister14headVertical()
  {
  }
  ...
  {
    lock (CReportBillRegister14headVertical.__ENCList)
    {
      if (CReportBillRegister14headVertical.__ENCList.Count == CReportBillRegister14headVertical.__ENCList.Capacity)
      {
        int index1 = 0;
        int num = checked (CReportBillRegister14headVertical.__ENCList.Count - 1);
        int index2 = 0;
        while (index2 <= num)
        {
          if (CReportBillRegister14headVertical.__ENCList[index2].IsAlive)
          {
            if (index2 != index1)
              CReportBillRegister14headVertical.__ENCList[index1] = CReportBillRegister14headVertical.__ENCList[index2];
            checked { ++index1; }
          }
          checked { ++index2; }
        }
        CReportBillRegister14headVertical.__ENCList.RemoveRange(index1, checked (CReportBillRegister14headVertical.__ENCList.Count - index1));
        CReportBillRegister14headVertical.__ENCList.Capacity = CReportBillRegister14headVertical.__ENCList.Count;
      }
      CReportBillRegister14headVertical.__ENCList.Add(new WeakReference(RuntimeHelpers.GetObjectValue(value)));
    }
  }

  public CReportBillRegister14headVertical()
  {
    CReportBillRegister14headVertical.__ENCAddToList((object) this);
  }

  public override string ResourceName
  {
    get => "CReportBillRegister14headVertical.rpt";
    set
    {
    }
  }
  ...
  {
    get => "MauliModule7.CReportBillRegister14headVertical.rpt";
    set
    {
    }
  }
