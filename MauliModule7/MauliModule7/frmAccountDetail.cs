...
// Type: MauliModule7.frmAccountDetail
...
[DesignerGenerated]
public class frmAccountDetail : Form
{
  ...
  {
    this.KeyDown += new KeyEventHandler(this.frmAccountDetail_KeyDown);
    this.Load += new EventHandler(this.frmAccountDetail_Load);
    frmAccountDetail.__ENCAddToList((object) this);
  ...
  {
    lock (frmAccountDetail.__ENCList)
    {
      if (frmAccountDetail.__ENCList.Count == frmAccountDetail.__ENCList.Capacity)
      {
        int index1 = 0;
        int num = checked (frmAccountDetail.__ENCList.Count - 1);
        int index2 = 0;
        while (index2 <= num)
        {
          if (frmAccountDetail.__ENCList[index2].IsAlive)
          {
            if (index2 != index1)
              frmAccountDetail.__ENCList[index1] = frmAccountDetail.__ENCList[index2];
            checked { ++index1; }
          }
          checked { ++index2; }
        }
        frmAccountDetail.__ENCList.RemoveRange(index1, checked (frmAccountDetail.__ENCList.Count - index1));
        frmAccountDetail.__ENCList.Capacity = frmAccountDetail.__ENCList.Count;
      }
      frmAccountDetail.__ENCList.Add(new WeakReference(RuntimeHelpers.GetObjectValue(value)));
    }
  }
  ...
  {
    ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (frmAccountDetail));
    ...
    point1 = new Point(83, 108);
    Point point46 = point1;
    lblMarName1.Location = point46;
    this.lblMarName.Name = "lblMarName";
    Label lblMarName2 = this.lblMarName;
    size1 = new Size(105, 16 /*0x10*/);
    Size size46 = size1;
    lblMarName2.Size = size46;
    this.lblMarName.TabIndex = 85;
    ...
    this.Name = nameof (frmAccountDetail);
  ...
  private void frmAccountDetail_KeyDown(object sender, KeyEventArgs e)
  {
  ...
  public DataSet GetFillGrid()
  {
    ...
    if (Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.btnSave.Text.Trim(), "&Save", false) != 0)
    {
      ...
      while (index <= num)
      {
        if (Microsoft.VisualBasic.CompilerServices.Operators.ConditionalCompareObjectEqual(MyProject.Forms.frmAccount.DataGridView2.CurrentRow.Cells[0].Value, MyProject.Forms.frmConstantGrid.DataGridViewAccount.Rows[index].Cells[0].Value, false))
        {
