...
// Type: MauliModule7.CReprotCashBankGroup
...
public class CReprotCashBankGroup : ReportClass
{
  private static List<WeakReference> __ENCList = new List<WeakReference>();

  [DebuggerNonUserCode]
  static CReprotCashBankGroup()
  {
  }
  ...
  {
    lock (CReprotCashBankGroup.__ENCList)
    {
      if (CReprotCashBankGroup.__ENCList.Count == CReprotCashBankGroup.__ENCList.Capacity)
      {
        int index1 = 0;
        int num = checked (CReprotCashBankGroup.__ENCList.Count - 1);
        int index2 = 0;
        while (index2 <= num)
        {
          if (CReprotCashBankGroup.__ENCList[index2].IsAlive)
          {
            if (index2 != index1)
              CReprotCashBankGroup.__ENCList[index1] = CReprotCashBankGroup.__ENCList[index2];
            checked { ++index1; }
          }
          checked { ++index2; }
        }
        CReprotCashBankGroup.__ENCList.RemoveRange(index1, checked (CReprotCashBankGroup.__ENCList.Count - index1));
        CReprotCashBankGroup.__ENCList.Capacity = CReprotCashBankGroup.__ENCList.Count;
      }
      CReprotCashBankGroup.__ENCList.Add(new WeakReference(RuntimeHelpers.GetObjectValue(value)));
    }
  }

  public CReprotCashBankGroup() => CReprotCashBankGroup.__ENCAddToList((object) this);

  public override string ResourceName
  {
    get => "CReprotCashBankGroup.rpt";
    set
    {
    }
  }
  ...
  {
    get => "MauliModule7.CReprotCashBankGroup.rpt";
    set
    {
    }
  }
  ...
  [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
  [Browsable(false)]
  public Section GroupFooterSection9 => this.ReportDefinition.Sections[16 /*0x10*/];
