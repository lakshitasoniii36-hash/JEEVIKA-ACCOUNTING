...
// Type: MauliModule7.DeleteDialog
...
public class DeleteDialog : Form
{
  ...
  public DeleteDialog()
  {
    ...
    DeleteDialog.__ENCAddToList((object) this);
  ...
  {
    lock (DeleteDialog.__ENCList)
    {
      if (DeleteDialog.__ENCList.Count == DeleteDialog.__ENCList.Capacity)
      {
        int index1 = 0;
        int num = checked (DeleteDialog.__ENCList.Count - 1);
        int index2 = 0;
        while (index2 <= num)
        {
          if (DeleteDialog.__ENCList[index2].IsAlive)
          {
            if (index2 != index1)
              DeleteDialog.__ENCList[index1] = DeleteDialog.__ENCList[index2];
            checked { ++index1; }
          }
          checked { ++index2; }
        }
        DeleteDialog.__ENCList.RemoveRange(index1, checked (DeleteDialog.__ENCList.Count - index1));
        DeleteDialog.__ENCList.Capacity = DeleteDialog.__ENCList.Count;
      }
      DeleteDialog.__ENCList.Add(new WeakReference(RuntimeHelpers.GetObjectValue(value)));
    }
  }
  ...
  private void InitializeComponent()
  {
    ...
    this.Label1.Text = "Sure to Delete ?";
