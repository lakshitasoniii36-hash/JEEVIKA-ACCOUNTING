...
// Type: MauliModule7.frmReportMemberBillRegisterNew
...
[DesignerGenerated]
public class frmReportMemberBillRegisterNew : Form
{
  ...
  private System.Windows.Forms.CheckBox _chkArrBifurcation;
  ...
  [DebuggerNonUserCode]
  static frmReportMemberBillRegisterNew()
  {
  }

  [DebuggerNonUserCode]
  public frmReportMemberBillRegisterNew()
  {
    this.KeyDown += new KeyEventHandler(this.frmReportMemberBillRegisterNew_KeyDown);
    this.Load += new EventHandler(this.frmReportMemberBillRegisterNew_Load);
    frmReportMemberBillRegisterNew.__ENCAddToList((object) this);
  ...
  {
    lock (frmReportMemberBillRegisterNew.__ENCList)
    {
      if (frmReportMemberBillRegisterNew.__ENCList.Count == frmReportMemberBillRegisterNew.__ENCList.Capacity)
      {
        int index1 = 0;
        int num = checked (frmReportMemberBillRegisterNew.__ENCList.Count - 1);
        int index2 = 0;
        while (index2 <= num)
        {
          if (frmReportMemberBillRegisterNew.__ENCList[index2].IsAlive)
          {
            if (index2 != index1)
              frmReportMemberBillRegisterNew.__ENCList[index1] = frmReportMemberBillRegisterNew.__ENCList[index2];
            checked { ++index1; }
          }
          checked { ++index2; }
        }
        frmReportMemberBillRegisterNew.__ENCList.RemoveRange(index1, checked (frmReportMemberBillRegisterNew.__ENCList.Count - index1));
        frmReportMemberBillRegisterNew.__ENCList.Capacity = frmReportMemberBillRegisterNew.__ENCList.Count;
      }
      frmReportMemberBillRegisterNew.__ENCList.Add(new WeakReference(RuntimeHelpers.GetObjectValue(value)));
    }
  }
  ...
  {
    ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (frmReportMemberBillRegisterNew));
    ...
    this.chkArrBifurcation = new System.Windows.Forms.CheckBox();
    ...
    size1 = new Size(805, 574);
    Size size6 = size1;
    dataGridView5_2.Size = size6;
    this.DataGridView5.TabIndex = 24;
    this.grpShowReport.Controls.Add((Control) this.chkArrBifurcation);
    this.grpShowReport.Controls.Add((Control) this.Label8);
    this.grpShowReport.Controls.Add((Control) this.cmbSortType);
    ...
    System.Windows.Forms.CheckBox chkArrBifurcation1 = this.chkArrBifurcation;
    point1 = new System.Drawing.Point(14, 221);
    System.Drawing.Point point8 = point1;
    chkArrBifurcation1.Location = point8;
    this.chkArrBifurcation.Name = "chkArrBifurcation";
    System.Windows.Forms.CheckBox chkArrBifurcation2 = this.chkArrBifurcation;
    size1 = new Size(142, 17);
    Size size8 = size1;
    chkArrBifurcation2.Size = size8;
    this.chkArrBifurcation.TabIndex = 48 /*0x30*/;
    ...
    point1 = new System.Drawing.Point(14, 199);
    ...
    point1 = new System.Drawing.Point(1, 73);
    ...
    mtxtDateFrom1.Location = point17;
    ...
    txtMemCodeFrom1.Location = point23;
    ...
    point1 = new System.Drawing.Point(44, 238);
    System.Drawing.Point point28 = point1;
    btnPrint1.Location = point28;
    this.btnPrint.Name = "btnPrint";
    System.Windows.Forms.Button btnPrint2 = this.btnPrint;
    size1 = new Size(100, 31 /*0x1F*/);
    Size size28 = size1;
    btnPrint2.Size = size28;
    ...
    lblMemNameFrom1.Location = point33;
    ...
    txtSearch1.Location = point37;
    this.txtSearch.Name = "txtSearch";
    System.Windows.Forms.TextBox txtSearch2 = this.txtSearch;
    size1 = new Size(153, 20);
    Size size37 = size1;
    txtSearch2.Size = size37;
    this.txtSearch.TabIndex = 16 /*0x10*/;
    this.grpPrint.Controls.Add((Control) this.cmbShowGrid);
    this.grpPrint.Controls.Add((Control) this.Label12);
    this.grpPrint.Controls.Add((Control) this.cmbArea);
    this.grpPrint.Controls.Add((Control) this.Label11);
    this.grpPrint.Controls.Add((Control) this.cmbVertical);
    this.grpPrint.Controls.Add((Control) this.Label10);
    this.grpPrint.Controls.Add((Control) this.cmbNarration);
    this.grpPrint.Controls.Add((Control) this.Label9);
    this.grpPrint.Controls.Add((Control) this.cmbShowName);
    ...
    this.grpPrint.Controls.Add((Control) this.cmbShowArrears);
    ...
    point1 = new System.Drawing.Point(98, 150);
    ...
    point1 = new System.Drawing.Point(17, 150);
    ...
    point1 = new System.Drawing.Point(809, 559);
    ...
    dataGridView7_1.Location = point57;
    this.DataGridView7.Name = "DataGridView7";
    DataGridView dataGridView7_2 = this.DataGridView7;
    size1 = new Size(10, 10);
    Size size57 = size1;
    dataGridView7_2.Size = size57;
    ...
    dataGridView8_1.Location = point58;
    this.DataGridView8.Name = "DataGridView8";
    DataGridView dataGridView8_2 = this.DataGridView8;
    size1 = new Size(10, 10);
    Size size58 = size1;
    dataGridView8_2.Size = size58;
    ...
    this.Name = nameof (frmReportMemberBillRegisterNew);
  ...
  internal virtual ComboBox cmbSortType
  {
    ...
    [DebuggerNonUserCode, MethodImpl(MethodImplOptions.Synchronized)] set
    {
      KeyEventHandler keyEventHandler = new KeyEventHandler(this.cmbSortType_KeyDown);
      if (this._cmbSortType != null)
        this._cmbSortType.KeyDown -= keyEventHandler;
  ...
  internal virtual System.Windows.Forms.CheckBox chkArrBifurcation
  {
  ...
  internal virtual ComboBox cmbShowGrid
  {
    ...
    [DebuggerNonUserCode, MethodImpl(MethodImplOptions.Synchronized)] set
    {
      EventHandler eventHandler = new EventHandler(this.cmbShowGrid_SelectedIndexChanged);
      if (this._cmbShowGrid != null)
        this._cmbShowGrid.SelectedIndexChanged -= eventHandler;
  ...
  private void frmReportMemberBillRegisterNew_KeyDown(object sender, KeyEventArgs e)
  {
  ...
  private void frmReportMemberBillRegisterNew_Load(object sender, EventArgs e)
  {
  ...
  private void btnPrint_Click(object sender, EventArgs e)
  {
    ...
    if (Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.cmbReportType.Text, "Data Sheet", false) == 0 | Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.cmbReportType.Text, "Excel Export", false) == 0)
    {
      ...
      this.cmbShowGrid.Enabled = false;
    }
    else
    {
      this.cmbShowArrears.Enabled = true;
      if (Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.cmbShowGrid.Text, "No", false) == 0)
      {
  ...
  public DataSet GetFillGrid()
  {
    ...
    selectConnection.Close();
    OleDbDataAdapter oleDbDataAdapter6 = new OleDbDataAdapter("SELECT SocBillSetting.SocBSAccId, SocBillSetting.SocAccountMainId, SocBillSetting.AccIndex, SocBillSetting.AccShortName, SocBillSetting.IsGST, SocBillSetting.IsGSTLimit, SocAccount.AccName FROM SocBillSetting INNER JOIN SocAccount ON SocBillSetting.SocAccountMainId = SocAccount.SocAccountMainId ORDER BY SocBillSetting.AccIndex", selectConnection);
    ...
    this.DataGridView4.ColumnCount = 43;
    this.DataGridView5.ReadOnly = true;
    this.DataGridView5.RowHeadersVisible = false;
    this.DataGridView5.AllowUserToAddRows = false;
    this.DataGridView5.RowCount = 0;
    this.DataGridView5.ColumnCount = 43;
    ...
    while (index1 <= num1)
    {
      this.DataGridView5.Columns[checked (index1 + 6)].HeaderText = Conversions.ToString(this.DataGridView6.Rows[index1].Cells[3].Value);
    ...
    if (this.chkArrBifurcation.Checked)
    {
      this.DataGridView5.Columns[checked (9 + this.DataGridView6.RowCount)].HeaderText = "Arrears Prin";
      this.DataGridView5.Columns[checked (10 + this.DataGridView6.RowCount)].HeaderText = "Arrears Int";
      this.DataGridView5.Columns[checked (11 + this.DataGridView6.RowCount)].HeaderText = "Total Bill";
    }
    else
    {
      this.DataGridView5.Columns[checked (9 + this.DataGridView6.RowCount)].HeaderText = "Arrears";
      this.DataGridView5.Columns[checked (10 + this.DataGridView6.RowCount)].HeaderText = "Total Bill";
      this.DataGridView5.Columns[checked (11 + this.DataGridView6.RowCount)].HeaderText = "";
    }
    ...
    if (this.chkArrBifurcation.Checked)
    {
      int index2 = checked (17 + this.DataGridView6.RowCount);
      while (index2 <= 41)
      {
    ...
    {
      int index3 = checked (16 /*0x10*/ + this.DataGridView6.RowCount);
      while (index3 <= 40)
      {
    ...
    while (index5 <= num4)
    {
      num2 = 0.0;
      num3 = 0.0;
      double Expression1 = Conversions.ToDouble(this.DataGridView2.Rows[index5].Cells[23].Value);
      double Expression2 = Conversions.ToDouble(this.DataGridView2.Rows[index5].Cells[24].Value);
      int num5 = checked (this.DataGridView3.RowCount - 1);
      int index6 = 0;
      while (index6 <= num5)
      {
        if (Microsoft.VisualBasic.CompilerServices.Operators.ConditionalCompareObjectEqual(this.DataGridView3.Rows[index6].Cells[0].Value, this.DataGridView2.Rows[index5].Cells[1].Value, false))
        {
          Expression1 += Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView3.Rows[index6].Cells[3].Value));
          Expression2 += Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView3.Rows[index6].Cells[2].Value));
        }
        checked { ++index6; }
      }
      ...
      while (index7 <= num6)
      {
        if (Microsoft.VisualBasic.CompilerServices.Operators.ConditionalCompareObjectEqual(this.DataGridView1.Rows[index7].Cells[1].Value, this.DataGridView2.Rows[index5].Cells[1].Value, false))
        {
          if (Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.DataGridView1.Rows[index7].Cells[6].Value.ToString().Trim(), this.lblType.Text, false) == 0 & Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView1.Rows[index7].Cells[7].Value)) >= Conversion.Val(this.txtNoFrom.Text) & Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView1.Rows[index7].Cells[7].Value)) <= Conversion.Val(this.txtNoTo.Text))
          {
            checked { ++index4; }
            this.DataGridView4.Rows.Add();
            this.DataGridView4.Rows[checked ((int) index4)].Cells[2].Value = (object) this.DataGridView2.Rows[index5].Cells[2].Value.ToString().Trim();
            this.DataGridView4.Rows[checked ((int) index4)].Cells[3].Value = RuntimeHelpers.GetObjectValue(this.DataGridView2.Rows[index5].Cells[9].Value);
            this.DataGridView4.Rows[checked ((int) index4)].Cells[1].Value = (object) this.DataGridView1.Rows[index7].Cells[5].Value.ToString().Substring(0, 10);
            this.DataGridView4.Rows[checked ((int) index4)].Cells[0].Value = (object) Conversion.Val(this.DataGridView1.Rows[index7].Cells[7].Value.ToString());
            this.DataGridView4.Rows[checked ((int) index4)].Cells[4].Value = RuntimeHelpers.GetObjectValue(this.DataGridView1.Rows[index7].Cells[18].Value);
            this.DataGridView4.Rows[checked ((int) index4)].Cells[40].Value = RuntimeHelpers.GetObjectValue(this.DataGridView2.Rows[index5].Cells[8].Value);
            ...
            while (num8 <= num7)
            {
              ...
              {
                this.DataGridView4.Rows[checked ((int) index4)].Cells[checked (5 + num8)].Value = (object) Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView1.Rows[index7].Cells[checked (num8 + 22)].Value));
                numArray[checked (5 + num8)] = Conversion.Val((object) numArray[checked (5 + num8)]) + Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView1.Rows[index7].Cells[checked (num8 + 22)].Value));
              }
              else
              {
                this.DataGridView4.Rows[checked ((int) index4)].Cells[checked (5 + num8)].Value = (object) -Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView1.Rows[index7].Cells[checked (num8 + 22)].Value));
            ...
            if (Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.lblType.Text, "MCrn", false) != 0)
            {
              this.DataGridView4.Rows[checked ((int) index4)].Cells[checked (5 + this.DataGridView6.RowCount)].Value = (object) Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView1.Rows[index7].Cells[10].Value));
              this.DataGridView4.Rows[checked ((int) index4)].Cells[checked (6 + this.DataGridView6.RowCount)].Value = (object) Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView1.Rows[index7].Cells[11].Value));
              this.DataGridView4.Rows[checked ((int) index4)].Cells[checked (7 + this.DataGridView6.RowCount)].Value = (object) Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView1.Rows[index7].Cells[12].Value));
              this.DataGridView4.Rows[checked ((int) index4)].Cells[checked (8 + this.DataGridView6.RowCount)].Value = (object) Conversion.Val((object) Expression3);
              this.DataGridView4.Rows[checked ((int) index4)].Cells[checked (9 + this.DataGridView6.RowCount)].Value = (object) (Conversion.Val((object) Expression3) + Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView1.Rows[index7].Cells[12].Value)));
              this.DataGridView4.Rows[checked ((int) index4)].Cells[41].Value = (object) Conversion.Val((object) Expression1);
              this.DataGridView4.Rows[checked ((int) index4)].Cells[42].Value = (object) Conversion.Val((object) Expression2);
              numArray[41] = Conversion.Val((object) numArray[41]) + Conversion.Val((object) Expression1);
              numArray[42] = Conversion.Val((object) numArray[42]) + Conversion.Val((object) Expression2);
              Expression3 = Expression3 + Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView1.Rows[index7].Cells[12].Value)) - Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView1.Rows[index7].Cells[13].Value));
              Expression1 += Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView1.Rows[index7].Cells[10].Value));
              Expression2 += Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView1.Rows[index7].Cells[11].Value));
            }
            else
            {
              this.DataGridView4.Rows[checked ((int) index4)].Cells[checked (5 + this.DataGridView6.RowCount)].Value = (object) -Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView1.Rows[index7].Cells[10].Value));
              this.DataGridView4.Rows[checked ((int) index4)].Cells[checked (6 + this.DataGridView6.RowCount)].Value = (object) -Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView1.Rows[index7].Cells[11].Value));
              this.DataGridView4.Rows[checked ((int) index4)].Cells[checked (7 + this.DataGridView6.RowCount)].Value = (object) -Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView1.Rows[index7].Cells[13].Value));
              this.DataGridView4.Rows[checked ((int) index4)].Cells[checked (8 + this.DataGridView6.RowCount)].Value = (object) Conversion.Val((object) Expression3);
              this.DataGridView4.Rows[checked ((int) index4)].Cells[checked (9 + this.DataGridView6.RowCount)].Value = (object) (Conversion.Val((object) Expression3) + Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView1.Rows[index7].Cells[13].Value)));
              this.DataGridView4.Rows[checked ((int) index4)].Cells[41].Value = (object) Conversion.Val((object) Expression1);
              this.DataGridView4.Rows[checked ((int) index4)].Cells[42].Value = (object) Conversion.Val((object) Expression2);
              numArray[41] = Conversion.Val((object) numArray[41]) + Conversion.Val((object) Expression1);
              numArray[42] = Conversion.Val((object) numArray[42]) + Conversion.Val((object) Expression2);
            ...
            this.DataGridView4.Rows[checked ((int) index4)].Cells[checked (10 + this.DataGridView6.RowCount)].Value = RuntimeHelpers.GetObjectValue(this.DataGridView1.Rows[index7].Cells[14].Value);
            this.DataGridView4.Rows[checked ((int) index4)].Cells[checked (11 + this.DataGridView6.RowCount)].Value = RuntimeHelpers.GetObjectValue(this.DataGridView1.Rows[index7].Cells[15].Value);
            this.DataGridView4.Rows[checked ((int) index4)].Cells[checked (12 + this.DataGridView6.RowCount)].Value = RuntimeHelpers.GetObjectValue(this.DataGridView1.Rows[index7].Cells[16 /*0x10*/].Value);
            this.DataGridView4.Rows[checked ((int) index4)].Cells[checked (13 + this.DataGridView6.RowCount)].Value = RuntimeHelpers.GetObjectValue(this.DataGridView1.Rows[index7].Cells[19].Value);
            this.DataGridView4.Rows[checked ((int) index4)].Cells[checked (14 + this.DataGridView6.RowCount)].Value = RuntimeHelpers.GetObjectValue(this.DataGridView1.Rows[index7].Cells[20].Value);
            this.DataGridView4.Rows[checked ((int) index4)].Cells[checked (15 + this.DataGridView6.RowCount)].Value = RuntimeHelpers.GetObjectValue(this.DataGridView1.Rows[index7].Cells[21].Value);
            DateTime date = Conversions.ToDate(this.DataGridView1.Rows[index7].Cells[5].Value);
            this.DataGridView4.Rows[checked ((int) index4)].Cells[checked (16 /*0x10*/ + this.DataGridView6.RowCount)].Value = (object) date;
            if (Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.lblType.Text, "MCrn", false) != 0)
            {
              numArray[checked (5 + this.DataGridView6.RowCount)] = Conversion.Val((object) numArray[checked (5 + this.DataGridView6.RowCount)]) + Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView1.Rows[index7].Cells[10].Value));
              ...
              numArray[checked (7 + this.DataGridView6.RowCount)] = Conversion.Val((object) numArray[checked (7 + this.DataGridView6.RowCount)]) + Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView1.Rows[index7].Cells[12].Value));
              numArray[checked (8 + this.DataGridView6.RowCount)] = Conversion.Val((object) numArray[checked (8 + this.DataGridView6.RowCount)]) + Conversion.Val((object) Expression3) - Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView1.Rows[index7].Cells[12].Value));
            ...
            else
            {
              ...
              numArray[checked (8 + this.DataGridView6.RowCount)] = Conversion.Val((object) numArray[checked (8 + this.DataGridView6.RowCount)]) + Conversion.Val((object) Expression3) + Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView1.Rows[index7].Cells[13].Value));
              numArray[checked (9 + this.DataGridView6.RowCount)] = Conversion.Val((object) numArray[checked (9 + this.DataGridView6.RowCount)]) + Conversion.Val((object) Expression3);
            }
            if (this.chkArrBifurcation.Checked)
              numArray[checked (12 + this.DataGridView6.RowCount)] = Conversion.Val((object) numArray[checked (12 + this.DataGridView6.RowCount)]) + Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView1.Rows[index7].Cells[14].Value));
            else
              numArray[checked (10 + this.DataGridView6.RowCount)] = Conversion.Val((object) numArray[checked (10 + this.DataGridView6.RowCount)]) + Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView1.Rows[index7].Cells[14].Value));
          }
          else
          {
            Expression3 = Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.DataGridView1.Rows[index7].Cells[6].Value.ToString(), "MCrn", false) == 0 ? Expression3 - Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView1.Rows[index7].Cells[12].Value)) + Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView1.Rows[index7].Cells[13].Value)) : Expression3 + Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView1.Rows[index7].Cells[12].Value)) - Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView1.Rows[index7].Cells[13].Value));
            if (Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.DataGridView1.Rows[index7].Cells[6].Value.ToString(), "MBil", false) == 0 | Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.DataGridView1.Rows[index7].Cells[6].Value.ToString(), "MDbn", false) == 0 | Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.DataGridView1.Rows[index7].Cells[6].Value.ToString(), "MCrn", false) == 0)
            {
              Expression1 += Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView1.Rows[index7].Cells[10].Value));
              Expression2 += Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView1.Rows[index7].Cells[11].Value));
            }
    ...
    if (Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.cmbSortType.Text, "No", false) == 0)
      this.DataGridView4.Sort(this.DataGridView4.Columns[0], ListSortDirection.Ascending);
    if (Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.cmbSortType.Text, "Date", false) == 0)
      this.DataGridView4.Sort(this.DataGridView4.Columns[checked (16 /*0x10*/ + this.DataGridView6.RowCount)], ListSortDirection.Ascending);
    if (Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.cmbSortType.Text, "Code", false) == 0)
      this.DataGridView4.Sort(this.DataGridView4.Columns[2], ListSortDirection.Ascending);
    long index8 = checked (index4 + 1L);
    this.DataGridView4.Rows.Add();
    int num9 = checked (this.DataGridView6.RowCount + 4);
    int num10 = 0;
    while (num10 <= num9)
    {
      this.DataGridView4.Rows[checked ((int) index8)].Cells[checked (5 + num10)].Value = (object) numArray[checked (5 + num10)];
      checked { ++num10; }
    }
    this.DataGridView4.Rows[checked ((int) index8)].Cells[3].Value = (object) "TOTAL";
    this.DataGridView4.Rows[checked ((int) index8)].Cells[checked (17 + this.DataGridView6.RowCount)].Value = (object) "C";
    this.DataGridView4.Rows[checked ((int) index8)].Cells[41].Value = (object) numArray[41];
    this.DataGridView4.Rows[checked ((int) index8)].Cells[42].Value = (object) numArray[42];
    int num11 = checked (this.DataGridView4.RowCount - 1);
    int index9 = 0;
    while (index9 <= num11)
    {
      this.DataGridView5.Rows.Add();
      this.DataGridView5.Rows[index9].Cells[0].Value = RuntimeHelpers.GetObjectValue(this.DataGridView4.Rows[index9].Cells[0].Value);
      this.DataGridView5.Rows[index9].Cells[1].Value = RuntimeHelpers.GetObjectValue(this.DataGridView4.Rows[index9].Cells[1].Value);
      this.DataGridView5.Rows[index9].Cells[2].Value = RuntimeHelpers.GetObjectValue(this.DataGridView4.Rows[index9].Cells[2].Value);
      this.DataGridView5.Rows[index9].Cells[3].Value = RuntimeHelpers.GetObjectValue(this.DataGridView4.Rows[index9].Cells[3].Value);
      this.DataGridView5.Rows[index9].Cells[4].Value = RuntimeHelpers.GetObjectValue(this.DataGridView4.Rows[index9].Cells[40].Value);
      if (this.chkArrBifurcation.Checked)
      {
        int num12 = checked (8 + this.DataGridView6.RowCount);
        int index10 = 5;
        while (index10 <= num12)
        {
          this.DataGridView5.Rows[index9].Cells[index10].Value = RuntimeHelpers.GetObjectValue(this.DataGridView4.Rows[index9].Cells[checked (index10 - 1)].Value);
          checked { ++index10; }
        }
        this.DataGridView5.Rows[index9].Cells[checked (9 + this.DataGridView6.RowCount)].Value = RuntimeHelpers.GetObjectValue(this.DataGridView4.Rows[index9].Cells[41].Value);
        this.DataGridView5.Rows[index9].Cells[checked (10 + this.DataGridView6.RowCount)].Value = RuntimeHelpers.GetObjectValue(this.DataGridView4.Rows[index9].Cells[42].Value);
        int index11 = checked (11 + this.DataGridView6.RowCount);
        while (index11 <= 40)
        {
          this.DataGridView5.Rows[index9].Cells[index11].Value = RuntimeHelpers.GetObjectValue(this.DataGridView4.Rows[index9].Cells[checked (index11 - 2)].Value);
          checked { ++index11; }
        }
        if (Microsoft.VisualBasic.CompilerServices.Operators.ConditionalCompareObjectEqual(this.DataGridView4.Rows[index9].Cells[checked (17 + this.DataGridView6.RowCount)].Value, (object) "C", false))
        {
      ...
      else
      {
        ...
        do
        {
          this.DataGridView5.Rows[index9].Cells[index12].Value = RuntimeHelpers.GetObjectValue(this.DataGridView4.Rows[index9].Cells[checked (index12 - 1)].Value);
          checked { ++index12; }
        }
        while (index12 <= 40);
        if (Microsoft.VisualBasic.CompilerServices.Operators.ConditionalCompareObjectEqual(this.DataGridView4.Rows[index9].Cells[checked (17 + this.DataGridView6.RowCount)].Value, (object) "C", false))
  ...
  {
    if (!(!Versioned.IsNumeric((object) this.txtNoFrom.Text) | Conversion.Val(this.txtNoFrom.Text) <= 0.0))
      return;
    this.txtNoFrom.Focus();
  }
  ...
  private void txtNoTo_KeyDown(object sender, KeyEventArgs e)
  {
    if (e.KeyCode != Keys.Return)
      return;
    this.cmbSortType.Focus();
  }

  private void txtNoTo_LostFocus(object sender, EventArgs e)
  {
    if (!(!Versioned.IsNumeric((object) this.txtNoTo.Text) | Conversion.Val(this.txtNoTo.Text) <= 0.0))
      return;
    this.txtNoTo.Focus();
  }
  ...
  private void btnPrintRegister_Click(object sender, EventArgs e)
  {
    ...
    this.DataGridView7.ColumnCount = 43;
    this.DataGridView8.ReadOnly = true;
    this.DataGridView8.RowHeadersVisible = false;
    this.DataGridView8.AllowUserToAddRows = false;
    this.DataGridView8.RowCount = 0;
    this.DataGridView8.ColumnCount = 43;
  ...
  public DataSet GetExport()
  {
    ...
    this.DataGridView7.Rows.Add();
    this.DataGridView7.Rows[1].Cells[0].Value = (object) $"Bill Register for period : {this.mtxtDateFrom.Text} - {this.mtxtDateTo.Text}";
    this.DataGridView7.Rows.Add();
    int num1 = checked (this.DataGridView6.RowCount + 16 /*0x10*/);
    int index1 = 0;
    while (index1 <= num1)
    {
    ...
    int rowCount = this.DataGridView6.RowCount;
    int index2 = 6;
    while (index2 <= rowCount)
    {
      this.DataGridView7.Rows[checked (this.DataGridView7.RowCount - 1)].Cells[index2].Value = (object) this.DataGridView6.Rows[checked (index2 - 6)].Cells[6].Value.ToString().Trim();
      checked { ++index2; }
    }
    ...
    {
      this.DataGridView7.Rows.Add();
      int num3 = checked (this.DataGridView6.RowCount + 16 /*0x10*/);
      int index4 = 0;
      while (index4 <= num3)
      {
        this.DataGridView7.Rows[checked (this.DataGridView7.RowCount - 1)].Cells[index4].Value = RuntimeHelpers.GetObjectValue(this.DataGridView5.Rows[index3].Cells[index4].Value);
        checked { ++index4; }
      }
      checked { ++index3; }
    }
    ...
    while (index5 <= num5)
    {
      if (Microsoft.VisualBasic.CompilerServices.Operators.ConditionalCompareObjectEqual(this.DataGridView7.Rows[index5].Cells[checked (19 + this.DataGridView6.RowCount)].Value, (object) "C", false))
      {
        num4 = checked ((short) index5);
        break;
      }
      checked { ++index5; }
    }
    ...
    try
    {
      ...
      short num8 = num6;
      short index6 = 0;
      while ((int) index6 <= (int) num8)
      {
        short num9 = num7;
        short index7 = 0;
        while ((int) index7 <= (int) num9)
        {
          NewLateBinding.LateSetComplex(worksheet2.Cells[(object) checked ((int) index6 + 1), (object) checked ((int) index7 + 1)], (System.Type) null, "value", new object[1]
          {
            RuntimeHelpers.GetObjectValue(this.DataGridView7.Rows[(int) index6].Cells[(int) index7].Value)
      ...
      worksheet2.get_Range(RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) 1, (object) 1]), RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) 1, (object) checked (this.DataGridView6.RowCount + 16 /*0x10*/)])).Merge((object) Missing.Value);
      worksheet2.get_Range(RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) 2, (object) 1]), RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) 2, (object) checked (this.DataGridView6.RowCount + 16 /*0x10*/)])).Merge((object) Missing.Value);
      worksheet2.get_Range(RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) 1, (object) 1]), RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) 3, (object) checked (this.DataGridView6.RowCount + 16 /*0x10*/)])).HorizontalAlignment = (object) XlVAlign.xlVAlignCenter;
      worksheet2.get_Range(RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) 1, (object) 1]), RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) 3, (object) checked (this.DataGridView6.RowCount + 16 /*0x10*/)])).Font.FontStyle = (object) "Bold";
      worksheet2.get_Range(RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) 1, (object) 1]), RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) 3, (object) checked (this.DataGridView6.RowCount + 16 /*0x10*/)])).Font.Size = (object) 10;
      ...
      worksheet2.get_Range(RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) 1, (object) 7]), RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) 1, (object) checked (this.DataGridView6.RowCount + 16 /*0x10*/)])).ColumnWidth = (object) 10;
      worksheet2.get_Range(RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) 1, (object) checked (this.DataGridView6.RowCount + 13)]), RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) 1, (object) checked (this.DataGridView6.RowCount + 16 /*0x10*/)])).ColumnWidth = (object) 25;
      worksheet2.get_Range(RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) 3, (object) 1]), RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) 3, (object) checked (this.DataGridView6.RowCount + 16 /*0x10*/)])).WrapText = (object) true;
      worksheet2.get_Range(RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) 3, (object) checked (this.DataGridView6.RowCount + 11)]), RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) checked ((int) num6 + 1), (object) checked (this.DataGridView6.RowCount + 16 /*0x10*/)])).WrapText = (object) true;
      Microsoft.Office.Interop.Excel.Border border1 = worksheet1.get_Range(RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) 1, (object) 1]), RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) 3, (object) checked (this.DataGridView6.RowCount + 16 /*0x10*/)])).Borders[XlBordersIndex.xlEdgeBottom];
      border1.LineStyle = (object) XlLineStyle.xlContinuous;
      border1.Weight = (object) XlBorderWeight.xlThin;
      Microsoft.Office.Interop.Excel.Border border2 = worksheet1.get_Range(RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) checked ((int) num4 + 2), (object) 1]), RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) checked ((int) num4 + 1), (object) checked (this.DataGridView6.RowCount + 16 /*0x10*/)])).Borders[XlBordersIndex.xlEdgeBottom];
      border2.LineStyle = (object) XlLineStyle.xlContinuous;
      border2.Weight = (object) XlBorderWeight.xlThin;
      Microsoft.Office.Interop.Excel.Border border3 = worksheet1.get_Range(RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) checked ((int) num6 + 1), (object) 1]), RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) checked ((int) num6 + 1), (object) checked (this.DataGridView6.RowCount + 16 /*0x10*/)])).Borders[XlBordersIndex.xlEdgeTop];
      border3.LineStyle = (object) XlLineStyle.xlContinuous;
      border3.Weight = (object) XlBorderWeight.xlThin;
      Microsoft.Office.Interop.Excel.Border border4 = worksheet1.get_Range(RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) checked ((int) num6 + 1), (object) 1]), RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) checked ((int) num6 + 1), (object) checked (this.DataGridView6.RowCount + 16 /*0x10*/)])).Borders[XlBordersIndex.xlEdgeBottom];
      border4.LineStyle = (object) XlLineStyle.xlContinuous;
      border4.Weight = (object) XlBorderWeight.xlThin;
      Microsoft.Office.Interop.Excel.Border border5 = worksheet1.get_Range(RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) 1, (object) 1]), RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) checked ((int) num6 + 2), (object) checked (this.DataGridView6.RowCount + 16 /*0x10*/)])).Borders[XlBordersIndex.xlEdgeTop];
      border5.LineStyle = (object) XlLineStyle.xlContinuous;
      border5.Weight = (object) XlBorderWeight.xlThin;
      Microsoft.Office.Interop.Excel.Border border6 = worksheet1.get_Range(RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) 1, (object) 1]), RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) checked ((int) num6 + 2), (object) checked (this.DataGridView6.RowCount + 16 /*0x10*/)])).Borders[XlBordersIndex.xlEdgeBottom];
      border6.LineStyle = (object) XlLineStyle.xlContinuous;
      border6.Weight = (object) XlBorderWeight.xlThin;
      Microsoft.Office.Interop.Excel.Border border7 = worksheet1.get_Range(RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) 1, (object) 1]), RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) checked ((int) num6 + 2), (object) checked (this.DataGridView6.RowCount + 16 /*0x10*/)])).Borders[XlBordersIndex.xlEdgeLeft];
      border7.LineStyle = (object) XlLineStyle.xlContinuous;
      border7.Weight = (object) XlBorderWeight.xlThin;
      Microsoft.Office.Interop.Excel.Border border8 = worksheet1.get_Range(RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) 1, (object) 1]), RuntimeHelpers.GetObjectValue(worksheet1.Cells[(object) checked ((int) num6 + 2), (object) checked (this.DataGridView6.RowCount + 16 /*0x10*/)])).Borders[XlBordersIndex.xlEdgeRight];
  ...
  private void cmbShowGrid_SelectedIndexChanged(object sender, EventArgs e)
  {
    if (Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.cmbShowGrid.Text, "No", false) == 0)
    {
      this.cmbNarration.Enabled = true;
  ...
  public DataSet PrintBOAmbr()
  {
      ...
      while (index5 <= num5)
      {
        if (Microsoft.VisualBasic.CompilerServices.Operators.ConditionalCompareObjectNotEqual(this.DataGridView4.Rows[index5].Cells[checked (17 + this.DataGridView6.RowCount)].Value, (object) "C", false))
        {
          ...
          if (Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.cmbShowArrears.Text, "Yes", false) == 0)
          {
            if (this.chkArrBifurcation.Checked)
            {
              this.DataGridView8.Columns[checked (index6 + 2)].HeaderText = "Arr. Prin.";
              this.DataGridView8.Columns[checked (index6 + 3)].HeaderText = "Arr. Int.";
              this.DataGridView8.Columns[checked (index6 + 4)].HeaderText = "Total Dues";
            }
            else
            {
              ...
              this.DataGridView8.Columns[checked (index6 + 4)].HeaderText = "";
            }
          }
          ...
          if (this.chkArrBifurcation.Checked)
          {
            ...
            DataGridViewCell cell2 = this.DataGridView4.Rows[index5].Cells[41];
            ...
            DataGridViewCell cell4 = this.DataGridView4.Rows[index5].Cells[42];
            ...
            DataGridViewCell cell5 = this.DataGridView7.Rows[index1].Cells[checked (15 + index6)];
            System.Type Type3 = typeof (Math);
            object[] objArray7 = new object[2];
            object[] objArray8 = objArray7;
            DataGridViewCell cell6 = this.DataGridView4.Rows[index5].Cells[checked (9 + this.DataGridView6.RowCount)];
          ...
          {
            DataGridViewCell cell7 = this.DataGridView7.Rows[index1].Cells[checked (13 + index6)];
            System.Type Type4 = typeof (Math);
            object[] objArray10 = new object[2];
            object[] objArray11 = objArray10;
            DataGridViewCell cell8 = this.DataGridView4.Rows[index5].Cells[checked (8 + this.DataGridView6.RowCount)];
            ...
            DataGridViewCell cell9 = this.DataGridView7.Rows[index1].Cells[checked (14 + index6)];
            System.Type Type5 = typeof (Math);
            object[] objArray13 = new object[2];
            object[] objArray14 = objArray13;
            DataGridViewCell cell10 = this.DataGridView4.Rows[index5].Cells[checked (9 + this.DataGridView6.RowCount)];
            object objectValue9 = RuntimeHelpers.GetObjectValue(cell10.Value);
            objArray14[0] = objectValue9;
            objArray13[1] = (object) 2;
            object[] objArray15 = objArray13;
            object[] Arguments5 = objArray15;
            bool[] flagArray5 = new bool[2]{ true, false };
            bool[] CopyBack5 = flagArray5;
            object obj5 = NewLateBinding.LateGet((object) null, Type5, "Round", Arguments5, (string[]) null, (System.Type[]) null, CopyBack5);
            if (flagArray5[0])
              cell10.Value = RuntimeHelpers.GetObjectValue(objArray15[0]);
            object objectValue10 = RuntimeHelpers.GetObjectValue(obj5);
            cell9.Value = objectValue10;
          }
          checked { ++index1; }
        }
        checked { ++index5; }
    ...
    else
    {
      ...
      while (index8 <= num)
      {
        if (Microsoft.VisualBasic.CompilerServices.Operators.ConditionalCompareObjectNotEqual(this.DataGridView4.Rows[index8].Cells[checked (17 + this.DataGridView6.RowCount)].Value, (object) "C", false))
        {
          ...
          DataGridViewCell cell11 = this.DataGridView7.Rows[checked (this.DataGridView7.RowCount - 1)].Cells[13];
          System.Type Type6 = typeof (Math);
          object[] objArray16 = new object[2];
          object[] objArray17 = objArray16;
          DataGridViewCell cell12 = this.DataGridView4.Rows[index8].Cells[checked (8 + this.DataGridView6.RowCount)];
          object objectValue11 = RuntimeHelpers.GetObjectValue(cell12.Value);
          objArray17[0] = objectValue11;
          objArray16[1] = (object) 2;
          object[] objArray18 = objArray16;
          object[] Arguments6 = objArray18;
          bool[] flagArray6 = new bool[2]{ true, false };
          bool[] CopyBack6 = flagArray6;
          object obj6 = NewLateBinding.LateGet((object) null, Type6, "Round", Arguments6, (string[]) null, (System.Type[]) null, CopyBack6);
          if (flagArray6[0])
            cell12.Value = RuntimeHelpers.GetObjectValue(objArray18[0]);
          object objectValue12 = RuntimeHelpers.GetObjectValue(obj6);
          cell11.Value = objectValue12;
          DataGridViewCell cell13 = this.DataGridView7.Rows[checked (this.DataGridView7.RowCount - 1)].Cells[14];
          System.Type Type7 = typeof (Math);
          object[] objArray19 = new object[2];
          object[] objArray20 = objArray19;
          DataGridViewCell cell14 = this.DataGridView4.Rows[index8].Cells[checked (9 + this.DataGridView6.RowCount)];
          object objectValue13 = RuntimeHelpers.GetObjectValue(cell14.Value);
          objArray20[0] = objectValue13;
          objArray19[1] = (object) 2;
          object[] objArray21 = objArray19;
          object[] Arguments7 = objArray21;
          bool[] flagArray7 = new bool[2]{ true, false };
          bool[] CopyBack7 = flagArray7;
          object obj7 = NewLateBinding.LateGet((object) null, Type7, "Round", Arguments7, (string[]) null, (System.Type[]) null, CopyBack7);
          if (flagArray7[0])
            cell14.Value = RuntimeHelpers.GetObjectValue(objArray21[0]);
          object objectValue14 = RuntimeHelpers.GetObjectValue(obj7);
          cell13.Value = objectValue14;
        }
        checked { ++index8; }
      }
    }
    ...
    if (Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.cmbArea.Text, "No", false) == 0)
    {
      if (Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.cmbReportType.Text, "14 Head", false) == 0)
      {
        if (Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.cmbVertical.Text, "No", false) == 0)
        {
          if (Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.cmbShowName.Text, "No", false) == 0)
            reportDocument = Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.cmbShowGrid.Text, "No", false) != 0 ? (ReportDocument) new CReportBillRegister14headLine() : (ReportDocument) new CReportBillRegister14head();
          if (Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.cmbShowName.Text, "Yes", false) == 0)
            reportDocument = Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.cmbShowGrid.Text, "No", false) != 0 ? (ReportDocument) new CReportBillRegister14headWithNameLine() : (ReportDocument) new CReportBillRegister14headWithName();
        }
        else
        {
          if (Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.cmbShowName.Text, "No", false) == 0)
            reportDocument = Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.cmbShowGrid.Text, "No", false) != 0 ? (ReportDocument) new CReportBillRegister14headVerticalLine() : (ReportDocument) new CReportBillRegister14headVertical();
          if (Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.cmbShowName.Text, "Yes", false) == 0)
      ...
      if (Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.cmbReportType.Text, "21 Head", false) == 0 & Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.cmbShowName.Text, "No", false) == 0)
        reportDocument = Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.cmbShowGrid.Text, "No", false) != 0 ? (ReportDocument) new CReportBillRegisterLine() : (ReportDocument) new CReportBillRegister();
    }
    else
    {
      if (Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.cmbReportType.Text, "14 Head", false) == 0)
      {
        ...
        {
          if (Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.cmbShowName.Text, "No", false) == 0)
            reportDocument = Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.cmbShowGrid.Text, "No", false) != 0 ? (ReportDocument) new CReportBillRegister14headsqftLine() : (ReportDocument) new CReportBillRegister14headsqft();
          if (Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.cmbShowName.Text, "Yes", false) == 0)
        ...
        {
          if (Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.cmbShowName.Text, "No", false) == 0)
            reportDocument = Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.cmbShowGrid.Text, "No", false) != 0 ? (ReportDocument) new CReportBillRegister14headVerticalsqftLine() : (ReportDocument) new CReportBillRegister14headVerticalsqft();
          if (Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.cmbShowName.Text, "Yes", false) == 0)
