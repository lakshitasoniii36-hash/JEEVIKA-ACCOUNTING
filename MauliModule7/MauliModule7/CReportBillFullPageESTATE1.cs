...
// Type: MauliModule7.CReportBillFullPageESTATE1
...
public class CReportBillFullPageESTATE1 : ReportClass
{
  private static List<WeakReference> __ENCList = new List<WeakReference>();

  [DebuggerNonUserCode]
  static CReportBillFullPageESTATE1()
  {
  }
  ...
  {
    lock (CReportBillFullPageESTATE1.__ENCList)
    {
      if (CReportBillFullPageESTATE1.__ENCList.Count == CReportBillFullPageESTATE1.__ENCList.Capacity)
      {
        int index1 = 0;
        int num = checked (CReportBillFullPageESTATE1.__ENCList.Count - 1);
        int index2 = 0;
        while (index2 <= num)
        {
          if (CReportBillFullPageESTATE1.__ENCList[index2].IsAlive)
          {
            if (index2 != index1)
              CReportBillFullPageESTATE1.__ENCList[index1] = CReportBillFullPageESTATE1.__ENCList[index2];
            checked { ++index1; }
          }
          checked { ++index2; }
        }
        CReportBillFullPageESTATE1.__ENCList.RemoveRange(index1, checked (CReportBillFullPageESTATE1.__ENCList.Count - index1));
        CReportBillFullPageESTATE1.__ENCList.Capacity = CReportBillFullPageESTATE1.__ENCList.Count;
      }
      CReportBillFullPageESTATE1.__ENCList.Add(new WeakReference(RuntimeHelpers.GetObjectValue(value)));
    }
  }

  public CReportBillFullPageESTATE1() => CReportBillFullPageESTATE1.__ENCAddToList((object) this);

  public override string ResourceName
  {
    get => "CReportBillFullPageESTATE1.rpt";
    set
    {
    }
  }
  ...
  {
    get => "MauliModule7.CReportBillFullPageESTATE1.rpt";
    set
    {
    }
  }
