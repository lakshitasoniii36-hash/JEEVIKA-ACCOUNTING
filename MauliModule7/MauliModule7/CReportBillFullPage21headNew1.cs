...
// Type: MauliModule7.CReportBillFullPage21headNew1
...
public class CReportBillFullPage21headNew1 : ReportClass
{
  private static List<WeakReference> __ENCList = new List<WeakReference>();

  [DebuggerNonUserCode]
  static CReportBillFullPage21headNew1()
  {
  }
  ...
  {
    lock (CReportBillFullPage21headNew1.__ENCList)
    {
      if (CReportBillFullPage21headNew1.__ENCList.Count == CReportBillFullPage21headNew1.__ENCList.Capacity)
      {
        int index1 = 0;
        int num = checked (CReportBillFullPage21headNew1.__ENCList.Count - 1);
        int index2 = 0;
        while (index2 <= num)
        {
          if (CReportBillFullPage21headNew1.__ENCList[index2].IsAlive)
          {
            if (index2 != index1)
              CReportBillFullPage21headNew1.__ENCList[index1] = CReportBillFullPage21headNew1.__ENCList[index2];
            checked { ++index1; }
          }
          checked { ++index2; }
        }
        CReportBillFullPage21headNew1.__ENCList.RemoveRange(index1, checked (CReportBillFullPage21headNew1.__ENCList.Count - index1));
        CReportBillFullPage21headNew1.__ENCList.Capacity = CReportBillFullPage21headNew1.__ENCList.Count;
      }
      CReportBillFullPage21headNew1.__ENCList.Add(new WeakReference(RuntimeHelpers.GetObjectValue(value)));
    }
  }

  public CReportBillFullPage21headNew1()
  {
    CReportBillFullPage21headNew1.__ENCAddToList((object) this);
  }

  public override string ResourceName
  {
    get => "CReportBillFullPage21headNew1.rpt";
    set
    {
    }
  }
  ...
  {
    get => "MauliModule7.CReportBillFullPage21headNew1.rpt";
    set
    {
    }
  }
