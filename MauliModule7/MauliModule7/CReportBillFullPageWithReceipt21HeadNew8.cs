...
// Type: MauliModule7.CReportBillFullPageWithReceipt21HeadNew8
...
public class CReportBillFullPageWithReceipt21HeadNew8 : ReportClass
{
  private static List<WeakReference> __ENCList = new List<WeakReference>();

  [DebuggerNonUserCode]
  static CReportBillFullPageWithReceipt21HeadNew8()
  {
  }
  ...
  {
    lock (CReportBillFullPageWithReceipt21HeadNew8.__ENCList)
    {
      if (CReportBillFullPageWithReceipt21HeadNew8.__ENCList.Count == CReportBillFullPageWithReceipt21HeadNew8.__ENCList.Capacity)
      {
        int index1 = 0;
        int num = checked (CReportBillFullPageWithReceipt21HeadNew8.__ENCList.Count - 1);
        int index2 = 0;
        while (index2 <= num)
        {
          if (CReportBillFullPageWithReceipt21HeadNew8.__ENCList[index2].IsAlive)
          {
            if (index2 != index1)
              CReportBillFullPageWithReceipt21HeadNew8.__ENCList[index1] = CReportBillFullPageWithReceipt21HeadNew8.__ENCList[index2];
            checked { ++index1; }
          }
          checked { ++index2; }
        }
        CReportBillFullPageWithReceipt21HeadNew8.__ENCList.RemoveRange(index1, checked (CReportBillFullPageWithReceipt21HeadNew8.__ENCList.Count - index1));
        CReportBillFullPageWithReceipt21HeadNew8.__ENCList.Capacity = CReportBillFullPageWithReceipt21HeadNew8.__ENCList.Count;
      }
      CReportBillFullPageWithReceipt21HeadNew8.__ENCList.Add(new WeakReference(RuntimeHelpers.GetObjectValue(value)));
    }
  }

  public CReportBillFullPageWithReceipt21HeadNew8()
  {
    CReportBillFullPageWithReceipt21HeadNew8.__ENCAddToList((object) this);
  }

  public override string ResourceName
  {
    get => "CReportBillFullPageWithReceipt21HeadNew8.rpt";
    set
    {
    }
  }
  ...
  {
    get => "MauliModule7.CReportBillFullPageWithReceipt21HeadNew8.rpt";
    set
    {
    }
  }
