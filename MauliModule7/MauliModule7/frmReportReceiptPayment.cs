...
// Type: MauliModule7.frmReportReceiptPayment
...
[DesignerGenerated]
public class frmReportReceiptPayment : Form
{
  ...
  [DebuggerNonUserCode]
  static frmReportReceiptPayment()
  {
  }

  [DebuggerNonUserCode]
  public frmReportReceiptPayment()
  {
    this.KeyDown += new KeyEventHandler(this.frmReportReceiptPayment_KeyDown);
    this.Load += new EventHandler(this.frmReportReceiptPayment_Load);
    frmReportReceiptPayment.__ENCAddToList((object) this);
  ...
  {
    lock (frmReportReceiptPayment.__ENCList)
    {
      if (frmReportReceiptPayment.__ENCList.Count == frmReportReceiptPayment.__ENCList.Capacity)
      {
        int index1 = 0;
        int num = checked (frmReportReceiptPayment.__ENCList.Count - 1);
        int index2 = 0;
        while (index2 <= num)
        {
          if (frmReportReceiptPayment.__ENCList[index2].IsAlive)
          {
            if (index2 != index1)
              frmReportReceiptPayment.__ENCList[index1] = frmReportReceiptPayment.__ENCList[index2];
            checked { ++index1; }
          }
          checked { ++index2; }
        }
        frmReportReceiptPayment.__ENCList.RemoveRange(index1, checked (frmReportReceiptPayment.__ENCList.Count - index1));
        frmReportReceiptPayment.__ENCList.Capacity = frmReportReceiptPayment.__ENCList.Count;
      }
      frmReportReceiptPayment.__ENCList.Add(new WeakReference(RuntimeHelpers.GetObjectValue(value)));
    }
  }
  ...
  {
    ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (frmReportReceiptPayment));
    ...
    this.Name = nameof (frmReportReceiptPayment);
  ...
  private void frmReportReceiptPayment_KeyDown(object sender, KeyEventArgs e)
  {
  ...
  private void frmReportReceiptPayment_Load(object sender, EventArgs e)
  {
  ...
  public DataSet GetFillGrid()
  {
    ...
    while (index5 <= num5)
    {
      ...
      {
        this.DataGridView3.Rows.Add();
        this.DataGridView3.Rows[checked (this.DataGridView3.RowCount - 1)].Cells[5].Value = (object) "Member Contribution-Receipt";
      ...
      {
        this.DataGridView3.Rows.Add();
        this.DataGridView3.Rows[checked (this.DataGridView3.RowCount - 1)].Cells[5].Value = (object) "Member Contribution-Cheque Return";
        this.DataGridView3.Rows[checked (this.DataGridView3.RowCount - 1)].Cells[6].Value = RuntimeHelpers.GetObjectValue(this.DataGridView4.Rows[index5].Cells[2].Value);
      }
      checked { ++index5; }
    }
    ...
    while (index9 <= num9)
    {
      if (Microsoft.VisualBasic.CompilerServices.Operators.ConditionalCompareObjectGreaterEqual(this.DataGridView3.Rows[index9].Cells[6].Value, (object) 0, false))
      {
        ...
        if (Microsoft.VisualBasic.CompilerServices.Operators.ConditionalCompareObjectNotEqual(this.DataGridView3.Rows[index9].Cells[5].Value, (object) "Member Contribution-Receipt", false))
        {
    ...
    while (index11 <= num10)
    {
      if (Microsoft.VisualBasic.CompilerServices.Operators.ConditionalCompareObjectLess(this.DataGridView3.Rows[index11].Cells[6].Value, (object) 0, false))
      {
        ...
        if (Microsoft.VisualBasic.CompilerServices.Operators.ConditionalCompareObjectNotEqual(this.DataGridView3.Rows[index11].Cells[5].Value, (object) "Member Contribution-Cheque Return", false))
        {
    ...
    if (index10 >= this.DataGridView6.RowCount)
      this.DataGridView6.Rows.Add();
    this.DataGridView6.Rows[index10].Cells[3].Value = (object) "TOTAL PAYMENT";
    ...
    if (index12 >= this.DataGridView6.RowCount)
      this.DataGridView6.Rows.Add();
    this.DataGridView6.Rows[index12].Cells[3].Value = (object) "CLOSING BALANCE";
    ...
    if (index14 >= this.DataGridView6.RowCount)
      this.DataGridView6.Rows.Add();
    this.DataGridView6.Rows[index14].Cells[3].Value = (object) "TOTAL CLOSING BALANCE";
