...
// Type: MauliModule7.frmCalculate
...
[DesignerGenerated]
public class frmCalculate : Form
{
  ...
  public frmCalculate()
  {
    ...
    this.KeyDown += new KeyEventHandler(this.frmCalculate_KeyDown);
    frmCalculate.__ENCAddToList((object) this);
  ...
  {
    lock (frmCalculate.__ENCList)
    {
      if (frmCalculate.__ENCList.Count == frmCalculate.__ENCList.Capacity)
      {
        int index1 = 0;
        int num = checked (frmCalculate.__ENCList.Count - 1);
        int index2 = 0;
        while (index2 <= num)
        {
          if (frmCalculate.__ENCList[index2].IsAlive)
          {
            if (index2 != index1)
              frmCalculate.__ENCList[index1] = frmCalculate.__ENCList[index2];
            checked { ++index1; }
          }
          checked { ++index2; }
        }
        frmCalculate.__ENCList.RemoveRange(index1, checked (frmCalculate.__ENCList.Count - index1));
        frmCalculate.__ENCList.Capacity = frmCalculate.__ENCList.Count;
      }
      frmCalculate.__ENCList.Add(new WeakReference(RuntimeHelpers.GetObjectValue(value)));
    }
  }
  ...
  {
    ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (frmCalculate));
    ...
    this.Label1.Text = "Calculate Date";
  ...
  private void frmCalculate_KeyDown(object sender, KeyEventArgs e)
  {
  ...
  private void btnCalculate_Click(object sender, EventArgs e)
  {
    ...
    else
    {
      ...
      while (index1 <= num1)
      {
        OleDbCommand oleDbCommand1 = new OleDbCommand(Conversions.ToString(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject((object) "update SocBillMaster set AmtInt = 0 where SocBillMasteId =", this.DataGridView1.Rows[index1].Cells[0].Value), (object) "")), connection);
        connection.Open();
        ...
        this.varrint = 0.0;
        this.vint = 0.0;
        this.varrint = Conversions.ToDouble(this.DataGridView1.Rows[index1].Cells[4].Value);
        this.varrprin = Conversions.ToDouble(this.DataGridView1.Rows[index1].Cells[3].Value);
        int num2 = checked (this.DataGridView2.RowCount - 1);
        int index2 = 0;
        while (index2 <= num2)
        {
          if (Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.DataGridView1.Rows[index1].Cells[2].Value.ToString().Trim(), this.DataGridView2.Rows[index2].Cells[0].Value.ToString().Trim(), false) == 0)
          {
            this.varrint = Conversions.ToDouble(Microsoft.VisualBasic.CompilerServices.Operators.AddObject((object) this.varrint, this.DataGridView2.Rows[index2].Cells[1].Value));
            this.varrprin = Conversions.ToDouble(Microsoft.VisualBasic.CompilerServices.Operators.AddObject((object) this.varrprin, this.DataGridView2.Rows[index2].Cells[2].Value));
          }
          checked { ++index2; }
        }
        if (Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.vinttype, "Simple", false) == 0)
          this.vint = Math.Round(this.varrprin * this.vintrate / 1200.0, this.vround);
        if (Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.vinttype, "Compound", false) == 0)
          this.vint = Math.Round((this.varrprin + this.varrint) * this.vintrate / 1200.0, this.vround);
        if (this.vint > 0.0)
        {
          OleDbCommand oleDbCommand2 = new OleDbCommand(Conversions.ToString(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject((object) ("update SocBillMaster set AmtInt = " + Conversions.ToString(this.vint) + " where SocBillMasteId ="), this.DataGridView1.Rows[index1].Cells[0].Value), (object) "")), connection);
          connection.Open();
