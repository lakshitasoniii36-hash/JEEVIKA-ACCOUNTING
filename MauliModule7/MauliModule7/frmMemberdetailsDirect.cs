...
// Type: MauliModule7.frmMemberdetailsDirect
...
[DesignerGenerated]
public class frmMemberdetailsDirect : Form
{
  ...
  [AccessedThroughProperty("lblMemberCode")]
  private Label _lblMemberCode;
  ...
  [DebuggerNonUserCode]
  static frmMemberdetailsDirect()
  {
  }

  [DebuggerNonUserCode]
  public frmMemberdetailsDirect()
  {
    this.KeyDown += new KeyEventHandler(this.frmMemberdetailsDirect_KeyDown);
    this.Load += new EventHandler(this.frmMemberdetailsDirect_Load);
    frmMemberdetailsDirect.__ENCAddToList((object) this);
  ...
  {
    lock (frmMemberdetailsDirect.__ENCList)
    {
      if (frmMemberdetailsDirect.__ENCList.Count == frmMemberdetailsDirect.__ENCList.Capacity)
      {
        int index1 = 0;
        int num = checked (frmMemberdetailsDirect.__ENCList.Count - 1);
        int index2 = 0;
        while (index2 <= num)
        {
          if (frmMemberdetailsDirect.__ENCList[index2].IsAlive)
          {
            if (index2 != index1)
              frmMemberdetailsDirect.__ENCList[index1] = frmMemberdetailsDirect.__ENCList[index2];
            checked { ++index1; }
          }
          checked { ++index2; }
        }
        frmMemberdetailsDirect.__ENCList.RemoveRange(index1, checked (frmMemberdetailsDirect.__ENCList.Count - index1));
        frmMemberdetailsDirect.__ENCList.Capacity = frmMemberdetailsDirect.__ENCList.Count;
      }
      frmMemberdetailsDirect.__ENCList.Add(new WeakReference(RuntimeHelpers.GetObjectValue(value)));
    }
  }
  ...
  private void InitializeComponent()
  {
    ...
    ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (frmMemberdetailsDirect));
    ...
    Point point1 = new Point(141, 234);
    Point point2 = point1;
    ...
    this.Label17.Text = "Servant Detail";
    ...
    this.GrpVisible.Controls.Add((Control) this.lblMemberCode);
    ...
    Label lblMemberCode1 = this.lblMemberCode;
    point1 = new Point(16 /*0x10*/, 125);
    Point point66 = point1;
    lblMemberCode1.Location = point66;
    this.lblMemberCode.Name = "lblMemberCode";
    Label lblMemberCode2 = this.lblMemberCode;
    size1 = new Size(13, 13);
    Size size66 = size1;
    lblMemberCode2.Size = size66;
    this.lblMemberCode.TabIndex = 136;
    this.lblMemberCode.Text = "0";
    TextBox txtMemNameOld1 = this.txtMemNameOld;
    point1 = new Point(16 /*0x10*/, 121);
    Point point67 = point1;
    txtMemNameOld1.Location = point67;
    this.txtMemNameOld.Name = "txtMemNameOld";
    TextBox txtMemNameOld2 = this.txtMemNameOld;
    size1 = new Size(13, 20);
    Size size67 = size1;
    txtMemNameOld2.Size = size67;
    ...
    point1 = new Point(309, 372);
    Point point79 = point1;
    label29_1.Location = point79;
    this.Label29.Name = "Label29";
    Label label29_2 = this.Label29;
    size1 = new Size(66, 16 /*0x10*/);
    Size size79 = size1;
    label29_2.Size = size79;
    ...
    point1 = new Point(49, 372);
    Point point81 = point1;
    label27_1.Location = point81;
    this.Label27.Name = "Label27";
    Label label27_2 = this.Label27;
    size1 = new Size(84, 16 /*0x10*/);
    Size size81 = size1;
    label27_2.Size = size81;
    ...
    this.Name = nameof (frmMemberdetailsDirect);
  ...
  internal virtual Label lblMemberCode
  {
    [DebuggerNonUserCode] get => this._lblMemberCode;
    [DebuggerNonUserCode, MethodImpl(MethodImplOptions.Synchronized)] set
    {
      this._lblMemberCode = value;
    }
  }
  ...
  private void frmMemberdetailsDirect_KeyDown(object sender, KeyEventArgs e)
  {
  ...
  private void frmMemberdetailsDirect_Load(object sender, EventArgs e)
  {
  ...
  public DataSet GetFillGrid()
  {
    ...
    if (Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.btnSave.Text.Trim(), "&Save", false) != 0)
    {
      ...
      while (index <= num)
      {
        if (Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.lblMemberCode.Text.Trim(), MyProject.Forms.frmConstantGrid.DataGridViewMember.Rows[index].Cells[7].Value.ToString().Trim(), false) == 0)
        {
  ...
  private void btnSave_Click(object sender, EventArgs e)
  {
    ...
    else
    {
      if (Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.btnSave.Text, "&Save", false) == 0)
      {
        ...
        oleDbConnection.Close();
        OleDbCommand oleDbCommand5 = new OleDbCommand($"Insert Into SocBillMaster (SocMemId) values ('{this.lblAccountId.Text.Trim()}')", oleDbConnection);
        oleDbConnection.Open();
      ...
      if (Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.btnSave.Text, "&Delete", false) == 0)
      {
        ...
        if (Conversions.ToDouble(MyProject.Forms.DeleteDialog.lblResult.Text) == 1.0)
        {
          ...
          {
            OleDbCommand oleDbCommand10 = new OleDbCommand($"Delete From SocMember where SocMemId ={Conversions.ToString(Conversion.Val(this.lblAccountId.Text.Trim()))}", oleDbConnection);
            oleDbConnection.Open();
            oleDbCommand10.ExecuteNonQuery();
            oleDbConnection.Close();
            OleDbCommand oleDbCommand11 = new OleDbCommand($"Delete From SocAccountMain where SocAccountMainId ={Conversions.ToString(Conversion.Val(this.lblAccountMainId.Text.Trim()))}", oleDbConnection);
            oleDbConnection.Open();
            oleDbCommand11.ExecuteNonQuery();
            oleDbConnection.Close();
            OleDbCommand oleDbCommand12 = new OleDbCommand($"Delete From SocBillMaster where SocMemId ={Conversions.ToString(Conversion.Val(this.lblAccountId.Text.Trim()))}", oleDbConnection);
            oleDbConnection.Open();
            oleDbCommand12.ExecuteNonQuery();
            oleDbConnection.Close();
            OleDbCommand oleDbCommand13 = new OleDbCommand($"Delete From SocDescRep where AccId ={Conversions.ToString(Conversion.Val(this.lblAccountMainId.Text.Trim()))}", oleDbConnection);
            oleDbConnection.Open();
