...
// Type: MauliModule7.CReportBillRegister14headWithNamesqft
...
public class CReportBillRegister14headWithNamesqft : ReportClass
{
  private static List<WeakReference> __ENCList = new List<WeakReference>();

  [DebuggerNonUserCode]
  static CReportBillRegister14headWithNamesqft()
  {
  }
  ...
  {
    lock (CReportBillRegister14headWithNamesqft.__ENCList)
    {
      if (CReportBillRegister14headWithNamesqft.__ENCList.Count == CReportBillRegister14headWithNamesqft.__ENCList.Capacity)
      {
        int index1 = 0;
        int num = checked (CReportBillRegister14headWithNamesqft.__ENCList.Count - 1);
        int index2 = 0;
        while (index2 <= num)
        {
          if (CReportBillRegister14headWithNamesqft.__ENCList[index2].IsAlive)
          {
            if (index2 != index1)
              CReportBillRegister14headWithNamesqft.__ENCList[index1] = CReportBillRegister14headWithNamesqft.__ENCList[index2];
            checked { ++index1; }
          }
          checked { ++index2; }
        }
        CReportBillRegister14headWithNamesqft.__ENCList.RemoveRange(index1, checked (CReportBillRegister14headWithNamesqft.__ENCList.Count - index1));
        CReportBillRegister14headWithNamesqft.__ENCList.Capacity = CReportBillRegister14headWithNamesqft.__ENCList.Count;
      }
      CReportBillRegister14headWithNamesqft.__ENCList.Add(new WeakReference(RuntimeHelpers.GetObjectValue(value)));
    }
  }

  public CReportBillRegister14headWithNamesqft()
  {
    CReportBillRegister14headWithNamesqft.__ENCAddToList((object) this);
  }

  public override string ResourceName
  {
    get => "CReportBillRegister14headWithNamesqft.rpt";
    set
    {
    }
  }
  ...
  {
    get => "MauliModule7.CReportBillRegister14headWithNamesqft.rpt";
    set
    {
    }
  }
