...
// Type: MauliModule7.CReprotCashBankNewGroup
...
public class CReprotCashBankNewGroup : ReportClass
{
  private static List<WeakReference> __ENCList = new List<WeakReference>();

  [DebuggerNonUserCode]
  static CReprotCashBankNewGroup()
  {
  }
  ...
  {
    lock (CReprotCashBankNewGroup.__ENCList)
    {
      if (CReprotCashBankNewGroup.__ENCList.Count == CReprotCashBankNewGroup.__ENCList.Capacity)
      {
        int index1 = 0;
        int num = checked (CReprotCashBankNewGroup.__ENCList.Count - 1);
        int index2 = 0;
        while (index2 <= num)
        {
          if (CReprotCashBankNewGroup.__ENCList[index2].IsAlive)
          {
            if (index2 != index1)
              CReprotCashBankNewGroup.__ENCList[index1] = CReprotCashBankNewGroup.__ENCList[index2];
            checked { ++index1; }
          }
          checked { ++index2; }
        }
        CReprotCashBankNewGroup.__ENCList.RemoveRange(index1, checked (CReprotCashBankNewGroup.__ENCList.Count - index1));
        CReprotCashBankNewGroup.__ENCList.Capacity = CReprotCashBankNewGroup.__ENCList.Count;
      }
      CReprotCashBankNewGroup.__ENCList.Add(new WeakReference(RuntimeHelpers.GetObjectValue(value)));
    }
  }

  public CReprotCashBankNewGroup() => CReprotCashBankNewGroup.__ENCAddToList((object) this);

  public override string ResourceName
  {
    get => "CReprotCashBankNewGroup.rpt";
    set
    {
    }
  }
  ...
  {
    get => "MauliModule7.CReprotCashBankNewGroup.rpt";
    set
    {
    }
  }
