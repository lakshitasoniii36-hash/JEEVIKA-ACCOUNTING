...
// Type: MauliModule7.CReportBillFullPage21headNewSR
...
public class CReportBillFullPage21headNewSR : ReportClass
{
  private static List<WeakReference> __ENCList = new List<WeakReference>();

  [DebuggerNonUserCode]
  static CReportBillFullPage21headNewSR()
  {
  }
  ...
  {
    lock (CReportBillFullPage21headNewSR.__ENCList)
    {
      if (CReportBillFullPage21headNewSR.__ENCList.Count == CReportBillFullPage21headNewSR.__ENCList.Capacity)
      {
        int index1 = 0;
        int num = checked (CReportBillFullPage21headNewSR.__ENCList.Count - 1);
        int index2 = 0;
        while (index2 <= num)
        {
          if (CReportBillFullPage21headNewSR.__ENCList[index2].IsAlive)
          {
            if (index2 != index1)
              CReportBillFullPage21headNewSR.__ENCList[index1] = CReportBillFullPage21headNewSR.__ENCList[index2];
            checked { ++index1; }
          }
          checked { ++index2; }
        }
        CReportBillFullPage21headNewSR.__ENCList.RemoveRange(index1, checked (CReportBillFullPage21headNewSR.__ENCList.Count - index1));
        CReportBillFullPage21headNewSR.__ENCList.Capacity = CReportBillFullPage21headNewSR.__ENCList.Count;
      }
      CReportBillFullPage21headNewSR.__ENCList.Add(new WeakReference(RuntimeHelpers.GetObjectValue(value)));
    }
  }

  public CReportBillFullPage21headNewSR()
  {
    CReportBillFullPage21headNewSR.__ENCAddToList((object) this);
  }

  public override string ResourceName
  {
    get => "CReportBillFullPage21headNewSR.rpt";
    set
    {
    }
  }
  ...
  {
    get => "MauliModule7.CReportBillFullPage21headNewSR.rpt";
    set
    {
    }
  }
