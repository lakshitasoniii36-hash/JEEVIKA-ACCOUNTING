...
// Type: MauliModule7.frmMemberShowdetails
...
[DesignerGenerated]
public class frmMemberShowdetails : Form
{
  ...
  [DebuggerNonUserCode]
  static frmMemberShowdetails()
  {
  }

  [DebuggerNonUserCode]
  public frmMemberShowdetails()
  {
    this.KeyDown += new KeyEventHandler(this.frmMemberShowdetails_KeyDown);
    this.Load += new EventHandler(this.frmMemberShowdetails_Load);
    frmMemberShowdetails.__ENCAddToList((object) this);
  ...
  {
    lock (frmMemberShowdetails.__ENCList)
    {
      if (frmMemberShowdetails.__ENCList.Count == frmMemberShowdetails.__ENCList.Capacity)
      {
        int index1 = 0;
        int num = checked (frmMemberShowdetails.__ENCList.Count - 1);
        int index2 = 0;
        while (index2 <= num)
        {
          if (frmMemberShowdetails.__ENCList[index2].IsAlive)
          {
            if (index2 != index1)
              frmMemberShowdetails.__ENCList[index1] = frmMemberShowdetails.__ENCList[index2];
            checked { ++index1; }
          }
          checked { ++index2; }
        }
        frmMemberShowdetails.__ENCList.RemoveRange(index1, checked (frmMemberShowdetails.__ENCList.Count - index1));
        frmMemberShowdetails.__ENCList.Capacity = frmMemberShowdetails.__ENCList.Count;
      }
      frmMemberShowdetails.__ENCList.Add(new WeakReference(RuntimeHelpers.GetObjectValue(value)));
    }
  }
  ...
  private void InitializeComponent()
  {
    ...
    ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (frmMemberShowdetails));
    ...
    Point point1 = new Point(200, 101);
    Point point2 = point1;
    ...
    this.GrpVisible.Controls.Add((Control) this.btnSave);
    GroupBox grpVisible1 = this.GrpVisible;
    point1 = new Point(391, 3);
    Point point65 = point1;
    grpVisible1.Location = point65;
    this.GrpVisible.Name = "GrpVisible";
    GroupBox grpVisible2 = this.GrpVisible;
    size1 = new Size(31 /*0x1F*/, 33);
    Size size65 = size1;
    ...
    point1 = new Point(497, 132);
    Point point70 = point1;
    btnTotal1.Location = point70;
    this.btnTotal.Name = "btnTotal";
    Button btnTotal2 = this.btnTotal;
    size1 = new Size(100, 22);
    Size size70 = size1;
    btnTotal2.Size = size70;
    ...
    point1 = new Point(654, 187);
    Point point74 = point1;
    label27_1.Location = point74;
    this.Label27.Name = "Label27";
    Label label27_2 = this.Label27;
    size1 = new Size(84, 16 /*0x10*/);
    Size size74 = size1;
    label27_2.Size = size74;
    ...
    point1 = new Point(913, 187);
    Point point76 = point1;
    label29_1.Location = point76;
    this.Label29.Name = "Label29";
    Label label29_2 = this.Label29;
    size1 = new Size(66, 16 /*0x10*/);
    Size size76 = size1;
    label29_2.Size = size76;
    ...
    point1 = new Point(141, 159);
    Point point80 = point1;
    label31_1.Location = point80;
    ...
    this.DataGridView6.ColumnHeadersDefaultCellStyle = gridViewCellStyle12;
    ...
    this.DataGridView6.DefaultCellStyle = gridViewCellStyle13;
    DataGridView dataGridView6_1 = this.DataGridView6;
    point1 = new Point(28, 206);
    Point point81 = point1;
    dataGridView6_1.Location = point81;
    ...
    this.DataGridView6.RowHeadersDefaultCellStyle = gridViewCellStyle14;
    DataGridView dataGridView6_2 = this.DataGridView6;
    size1 = new Size(13, 36);
    Size size81 = size1;
    dataGridView6_2.Size = size81;
    ...
    this.DataGridView7.ColumnHeadersDefaultCellStyle = gridViewCellStyle15;
    ...
    this.DataGridView7.DefaultCellStyle = gridViewCellStyle16;
    DataGridView dataGridView7_1 = this.DataGridView7;
    point1 = new Point(0, 240 /*0xF0*/);
    Point point82 = point1;
    dataGridView7_1.Location = point82;
    ...
    this.DataGridView7.RowHeadersDefaultCellStyle = gridViewCellStyle17;
    DataGridView dataGridView7_2 = this.DataGridView7;
    size1 = new Size(1251, 282);
    Size size82 = size1;
    dataGridView7_2.Size = size82;
    ...
    this.DataGridView8.ColumnHeadersDefaultCellStyle = gridViewCellStyle18;
    ...
    gridViewCellStyle19.ForeColor = SystemColors.ControlText;
    ...
    this.DataGridView8.DefaultCellStyle = gridViewCellStyle19;
    DataGridView dataGridView8_1 = this.DataGridView8;
    point1 = new Point(22, 235);
    Point point83 = point1;
    dataGridView8_1.Location = point83;
    ...
    this.DataGridView8.RowHeadersDefaultCellStyle = gridViewCellStyle20;
    DataGridView dataGridView8_2 = this.DataGridView8;
    size1 = new Size(13, 36);
    Size size83 = size1;
    dataGridView8_2.Size = size83;
    this.DataGridView8.TabIndex = 137;
    ...
    this.DataGridView9.ColumnHeadersDefaultCellStyle = gridViewCellStyle21;
    ...
    this.DataGridView9.DefaultCellStyle = gridViewCellStyle22;
    DataGridView dataGridView9_1 = this.DataGridView9;
    point1 = new Point(16 /*0x10*/, 167);
    Point point84 = point1;
    dataGridView9_1.Location = point84;
    ...
    this.DataGridView9.RowHeadersDefaultCellStyle = gridViewCellStyle23;
    DataGridView dataGridView9_2 = this.DataGridView9;
    size1 = new Size(13, 36);
    Size size84 = size1;
    dataGridView9_2.Size = size84;
    this.DataGridView9.TabIndex = 138;
    this.AutoScaleDimensions = new SizeF(6f, 13f);
    this.AutoScaleMode = AutoScaleMode.Font;
    size1 = new Size(1250, 566);
    ...
    this.Name = nameof (frmMemberShowdetails);
  ...
  private void frmMemberShowdetails_KeyDown(object sender, KeyEventArgs e)
  {
  ...
  private void frmMemberShowdetails_Load(object sender, EventArgs e)
  {
  ...
  public DataSet GetFillGrid()
  {
    ...
    while (index <= num)
    {
      if (Microsoft.VisualBasic.CompilerServices.Operators.ConditionalCompareObjectEqual(MyProject.Forms.frmMember.DataGridView2.CurrentRow.Cells[0].Value, MyProject.Forms.frmConstantGrid.DataGridViewMember.Rows[index].Cells[0].Value, false))
      {
        this.lblAccountMainId.Text = Conversions.ToString(MyProject.Forms.frmConstantGrid.DataGridViewMember.Rows[index].Cells[0].Value);
        this.lblAccountId.Text = Conversions.ToString(MyProject.Forms.frmConstantGrid.DataGridViewMember.Rows[index].Cells[5].Value);
        this.cmbGroup.SelectedValue = RuntimeHelpers.GetObjectValue(MyProject.Forms.frmConstantGrid.DataGridViewMember.Rows[index].Cells[2].Value);
        this.txtMemCode.Text = MyProject.Forms.frmConstantGrid.DataGridViewMember.Rows[index].Cells[7].Value.ToString();
        this.txtMemCodeOld.Text = MyProject.Forms.frmConstantGrid.DataGridViewMember.Rows[index].Cells[7].Value.ToString();
        this.txtBldg.Text = MyProject.Forms.frmConstantGrid.DataGridViewMember.Rows[index].Cells[8].Value.ToString();
        this.txtWing.Text = MyProject.Forms.frmConstantGrid.DataGridViewMember.Rows[index].Cells[9].Value.ToString();
        this.txtFlatType.Text = MyProject.Forms.frmConstantGrid.DataGridViewMember.Rows[index].Cells[10].Value.ToString();
        this.txtFlatNo.Text = MyProject.Forms.frmConstantGrid.DataGridViewMember.Rows[index].Cells[11].Value.ToString();
        this.txtFloor.Text = MyProject.Forms.frmConstantGrid.DataGridViewMember.Rows[index].Cells[12].Value.ToString();
        this.txtSqft.Text = MyProject.Forms.frmConstantGrid.DataGridViewMember.Rows[index].Cells[13].Value.ToString();
        this.txtMemNameOld.Text = MyProject.Forms.frmConstantGrid.DataGridViewMember.Rows[index].Cells[14].Value.ToString();
        this.txtMemName.Text = MyProject.Forms.frmConstantGrid.DataGridViewMember.Rows[index].Cells[14].Value.ToString();
        this.txtMemName1.Text = MyProject.Forms.frmConstantGrid.DataGridViewMember.Rows[index].Cells[15].Value.ToString();
        this.txtMemName2.Text = MyProject.Forms.frmConstantGrid.DataGridViewMember.Rows[index].Cells[16 /*0x10*/].Value.ToString();
        this.txtMemName3.Text = MyProject.Forms.frmConstantGrid.DataGridViewMember.Rows[index].Cells[17].Value.ToString();
        this.txtNocDetail.Text = MyProject.Forms.frmConstantGrid.DataGridViewMember.Rows[index].Cells[18].Value.ToString();
        this.txtParkDetail.Text = MyProject.Forms.frmConstantGrid.DataGridViewMember.Rows[index].Cells[19].Value.ToString();
        this.txtLoanDetail.Text = MyProject.Forms.frmConstantGrid.DataGridViewMember.Rows[index].Cells[20].Value.ToString();
        this.txtPoss_Date.Text = MyProject.Forms.frmConstantGrid.DataGridViewMember.Rows[index].Cells[21].Value.ToString();
        this.txtMemEmail.Text = MyProject.Forms.frmConstantGrid.DataGridViewMember.Rows[index].Cells[22].Value.ToString();
        this.txtMemEmail1.Text = MyProject.Forms.frmConstantGrid.DataGridViewMember.Rows[index].Cells[40].Value.ToString();
        this.txtMemEmail2.Text = MyProject.Forms.frmConstantGrid.DataGridViewMember.Rows[index].Cells[41].Value.ToString();
        this.txtMemMobile.Text = MyProject.Forms.frmConstantGrid.DataGridViewMember.Rows[index].Cells[23].Value.ToString();
        this.txtMemMobile1.Text = MyProject.Forms.frmConstantGrid.DataGridViewMember.Rows[index].Cells[38].Value.ToString();
        this.txtMemMobile2.Text = MyProject.Forms.frmConstantGrid.DataGridViewMember.Rows[index].Cells[39].Value.ToString();
        this.txtFamilyDetail.Text = MyProject.Forms.frmConstantGrid.DataGridViewMember.Rows[index].Cells[24].Value.ToString();
        this.txtServantDetail.Text = MyProject.Forms.frmConstantGrid.DataGridViewMember.Rows[index].Cells[25].Value.ToString();
        this.txtBankName.Text = MyProject.Forms.frmConstantGrid.DataGridViewMember.Rows[index].Cells[26].Value.ToString();
        this.txtDefaPart.Text = MyProject.Forms.frmConstantGrid.DataGridViewMember.Rows[index].Cells[27].Value.ToString();
        this.txtOp_Prin.Text = MyProject.Forms.frmConstantGrid.DataGridViewMember.Rows[index].Cells[28].Value.ToString();
        this.txtOp_Int.Text = MyProject.Forms.frmConstantGrid.DataGridViewMember.Rows[index].Cells[29].Value.ToString();
        this.txtOp_PrinOld.Text = MyProject.Forms.frmConstantGrid.DataGridViewMember.Rows[index].Cells[28].Value.ToString();
        this.txtOp_IntOld.Text = MyProject.Forms.frmConstantGrid.DataGridViewMember.Rows[index].Cells[29].Value.ToString();
        this.btnTotal.Text = (Conversion.Val(MyProject.Forms.frmConstantGrid.DataGridViewMember.Rows[index].Cells[28].Value.ToString()) + Conversion.Val(MyProject.Forms.frmConstantGrid.DataGridViewMember.Rows[index].Cells[29].Value.ToString())).ToString();
        this.txtCl_Prin.Text = MyProject.Forms.frmConstantGrid.DataGridViewMember.Rows[index].Cells[34].Value.ToString();
        this.txtCl_Int.Text = MyProject.Forms.frmConstantGrid.DataGridViewMember.Rows[index].Cells[35].Value.ToString();
        this.txtTransfer.Text = MyProject.Forms.frmConstantGrid.DataGridViewMember.Rows[index].Cells[36].Value.ToString();
        this.txtAddress.Text = MyProject.Forms.frmConstantGrid.DataGridViewMember.Rows[index].Cells[37].Value.ToString();
  ...
  public DataSet GetFillMemberac()
  {
    Constant.dateRangeFrom = Conversions.ToString(Constant.socFYSTART);
    Constant.dateRangeto = Conversions.ToString(Constant.socFYEND);
    OleDbConnection selectConnection = new OleDbConnection($"Provider=Microsoft.ACE.OLEDB.12.0;Data Source={Constant.socDataPath}{Constant.SocDataFile}");
    ...
    this.DataGridView9.DataSource = (object) dataTable1;
    this.DataGridView9.ReadOnly = true;
    this.DataGridView9.RowHeadersVisible = false;
    this.DataGridView9.AllowUserToAddRows = false;
    selectConnection.Close();
    OleDbDataAdapter oleDbDataAdapter3 = new OleDbDataAdapter($"SELECT SocMember.SocAccountMainId, SocMember.MemCode, Sum(SocTran.SocTranInt) AS SumOfSocTranInt, Sum(SocTran.SocTranPrin) AS SumOfSocTranPrin, Sum(SocTran.SocTranAmount) AS SumOfSocTranAmount FROM SocTran INNER JOIN SocMember ON SocTran.SocAccountMainId = SocMember.SocAccountMainId WHERE(((SocTran.SocTranDate) < #{Constant.dateRangeFrom}#)) GROUP BY SocMember.SocAccountMainId, SocMember.MemCode ORDER BY SocMember.MemCode asc", selectConnection);
    ...
    selectConnection.Close();
    OleDbDataAdapter oleDbDataAdapter4 = new OleDbDataAdapter("SELECT SocBillSetting.SocBSAccId, SocBillSetting.SocAccountMainId, SocBillSetting.AccIndex, SocBillSetting.AccShortName FROM SocBillSetting ORDER BY SocBillSetting.AccIndex", selectConnection);
    ...
    this.DataGridView8.ColumnCount = 48 /*0x30*/;
    this.DataGridView7.ReadOnly = true;
    this.DataGridView7.RowHeadersVisible = false;
    this.DataGridView7.AllowUserToAddRows = false;
    this.DataGridView7.RowCount = 0;
    this.DataGridView7.ColumnCount = 44;
    this.DataGridView7.Columns[0].HeaderText = "Code1";
    this.DataGridView7.Columns[1].HeaderText = "Name";
    this.DataGridView7.Columns[2].HeaderText = "Type-No";
    this.DataGridView7.Columns[3].HeaderText = "Date";
    this.DataGridView7.Columns[4].HeaderText = "Period";
    int num1 = checked (this.DataGridView6.RowCount - 1);
    int index1 = 0;
    while (index1 <= num1)
    {
      this.DataGridView7.Columns[checked (index1 + 5)].HeaderText = Conversions.ToString(this.DataGridView6.Rows[index1].Cells[3].Value);
      this.DataGridView7.Columns[checked (index1 + 5)].DefaultCellStyle.Format = "N2";
      this.DataGridView7.Columns[checked (index1 + 5)].ValueType = typeof (double);
      this.DataGridView7.Columns[checked (index1 + 5)].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
      checked { ++index1; }
    }
    this.DataGridView7.Columns[checked (5 + this.DataGridView6.RowCount)].HeaderText = "Interest";
    this.DataGridView7.Columns[checked (6 + this.DataGridView6.RowCount)].HeaderText = "Total Debit";
    this.DataGridView7.Columns[checked (7 + this.DataGridView6.RowCount)].HeaderText = "Total Credit";
    this.DataGridView7.Columns[checked (8 + this.DataGridView6.RowCount)].HeaderText = "Balance";
    this.DataGridView7.Columns[checked (9 + this.DataGridView6.RowCount)].HeaderText = "Chq.No.";
    this.DataGridView7.Columns[checked (10 + this.DataGridView6.RowCount)].HeaderText = "Chq.Date";
    this.DataGridView7.Columns[checked (11 + this.DataGridView6.RowCount)].HeaderText = "Bank";
    this.DataGridView7.Columns[checked (12 + this.DataGridView6.RowCount)].HeaderText = "Narration1";
    this.DataGridView7.Columns[checked (13 + this.DataGridView6.RowCount)].HeaderText = "Narration2";
    this.DataGridView7.Columns[checked (14 + this.DataGridView6.RowCount)].HeaderText = "Narration3";
    this.DataGridView7.Columns[checked (5 + this.DataGridView6.RowCount)].DefaultCellStyle.Format = "N2";
    this.DataGridView7.Columns[checked (6 + this.DataGridView6.RowCount)].DefaultCellStyle.Format = "N2";
    this.DataGridView7.Columns[checked (7 + this.DataGridView6.RowCount)].DefaultCellStyle.Format = "N2";
    this.DataGridView7.Columns[checked (8 + this.DataGridView6.RowCount)].DefaultCellStyle.Format = "N2";
    this.DataGridView7.Columns[checked (5 + this.DataGridView6.RowCount)].ValueType = typeof (double);
    this.DataGridView7.Columns[checked (6 + this.DataGridView6.RowCount)].ValueType = typeof (double);
    this.DataGridView7.Columns[checked (7 + this.DataGridView6.RowCount)].ValueType = typeof (double);
    this.DataGridView7.Columns[checked (8 + this.DataGridView6.RowCount)].ValueType = typeof (double);
    this.DataGridView7.Columns[checked (5 + this.DataGridView6.RowCount)].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
    this.DataGridView7.Columns[checked (6 + this.DataGridView6.RowCount)].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
    this.DataGridView7.Columns[checked (7 + this.DataGridView6.RowCount)].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
    this.DataGridView7.Columns[checked (8 + this.DataGridView6.RowCount)].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
    this.DataGridView7.Columns[0].Width = 80 /*0x50*/;
    this.DataGridView7.Columns[1].Width = 100;
    this.DataGridView7.Columns[2].Width = 100;
    this.DataGridView7.Columns[3].Width = 80 /*0x50*/;
    ...
    this.DataGridView7.Columns[8].Width = 100;
    this.DataGridView7.Columns[9].Width = 100;
    this.DataGridView7.Columns[10].Width = 100;
    this.DataGridView7.Columns[11].Width = 100;
    this.DataGridView7.Columns[12].Width = 100;
    this.DataGridView7.Columns[13].Width = 100;
    this.DataGridView7.Columns[14].Width = 100;
    this.DataGridView7.Columns[15].Width = 100;
    this.DataGridView7.Columns[0].Frozen = true;
    this.DataGridView7.Columns[2].Frozen = true;
    this.DataGridView7.Columns[3].Frozen = true;
    this.DataGridView7.Columns[1].Visible = false;
    int index2 = checked (15 + this.DataGridView6.RowCount);
    while (index2 <= 43)
    {
      this.DataGridView7.Columns[index2].Visible = false;
      checked { ++index2; }
    }
    long num2 = -1;
    double num3 = 0.0;
    ...
    num3 = 0.0;
    num4 = 0.0;
    double num5 = Conversion.Val(this.txtOp_Prin.Text);
    double num6 = Conversion.Val(this.txtOp_Int.Text);
    int num7 = checked (this.DataGridView3.RowCount - 1);
    int index3 = 0;
    while (index3 <= num7)
    {
      if (Microsoft.VisualBasic.CompilerServices.Operators.ConditionalCompareObjectEqual(this.DataGridView3.Rows[index3].Cells[0].Value, (object) Conversion.Val(this.lblAccountMainId.Text), false))
      {
        num5 += Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView3.Rows[index3].Cells[3].Value));
        num6 += Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView3.Rows[index3].Cells[2].Value));
      }
      checked { ++index3; }
    }
    double Expression = num5 + num6;
    long index4 = checked (num2 + 1L);
    this.DataGridView8.Rows.Add();
    this.DataGridView8.Rows[checked ((int) index4)].Cells[2].Value = (object) "Opening";
    this.DataGridView8.Rows[checked ((int) index4)].Cells[3].Value = (object) "";
    this.DataGridView8.Rows[checked ((int) index4)].Cells[0].Value = (object) this.txtMemCode.Text.Trim();
    this.DataGridView8.Rows[checked ((int) index4)].Cells[1].Value = (object) this.txtMemName.Text.Trim();
    this.DataGridView8.Rows[checked ((int) index4)].Cells[45].Value = (object) this.txtMemName1.Text.Trim();
    this.DataGridView8.Rows[checked ((int) index4)].Cells[46].Value = (object) this.txtMemName2.Text.Trim();
    this.DataGridView8.Rows[checked ((int) index4)].Cells[47].Value = (object) this.txtMemName3.Text.Trim();
    this.DataGridView8.Rows[checked ((int) index4)].Cells[44].Value = (object) Conversion.Val(this.txtSqft.Text.Trim());
    this.DataGridView8.Rows[checked ((int) index4)].Cells[checked (8 + this.DataGridView6.RowCount)].Value = (object) Conversion.Val((object) Expression);
    this.DataGridView8.Rows[checked ((int) index4)].Cells[40].Value = (object) Conversion.Val((object) Expression);
    this.DataGridView8.Rows[checked ((int) index4)].Cells[37].Value = (object) "O";
    this.DataGridView8.Rows[checked ((int) index4)].Cells[41].Value = (object) "O";
    int num8 = checked (this.DataGridView9.RowCount - 1);
    int index5 = 0;
    while (index5 <= num8)
    {
      if (Microsoft.VisualBasic.CompilerServices.Operators.ConditionalCompareObjectEqual(this.DataGridView9.Rows[index5].Cells[1].Value, (object) Conversion.Val(this.lblAccountMainId.Text), false))
      {
        if (Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.DataGridView9.Rows[index5].Cells[6].Value.ToString().Trim(), "MBil", false) == 0 | Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.DataGridView9.Rows[index5].Cells[6].Value.ToString().Trim(), "MDbn", false) == 0 | Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.DataGridView9.Rows[index5].Cells[6].Value.ToString().Trim(), "MCrn", false) == 0)
        {
          checked { ++index4; }
          this.DataGridView8.Rows.Add();
          this.DataGridView8.Rows[checked ((int) index4)].Cells[2].Value = (object) $"{this.DataGridView9.Rows[index5].Cells[6].Value.ToString()}-{this.DataGridView9.Rows[index5].Cells[7].Value.ToString()}";
          this.DataGridView8.Rows[checked ((int) index4)].Cells[41].Value = (object) "T";
          this.DataGridView8.Rows[checked ((int) index4)].Cells[42].Value = RuntimeHelpers.GetObjectValue(this.DataGridView9.Rows[index5].Cells[6].Value);
          this.DataGridView8.Rows[checked ((int) index4)].Cells[43].Value = RuntimeHelpers.GetObjectValue(this.DataGridView9.Rows[index5].Cells[7].Value);
          this.DataGridView8.Rows[checked ((int) index4)].Cells[3].Value = (object) this.DataGridView9.Rows[index5].Cells[5].Value.ToString().Substring(0, 10);
          this.DataGridView8.Rows[checked ((int) index4)].Cells[0].Value = (object) this.txtMemCode.Text;
          this.DataGridView8.Rows[checked ((int) index4)].Cells[1].Value = (object) this.txtMemName.Text.Trim();
          this.DataGridView8.Rows[checked ((int) index4)].Cells[45].Value = (object) this.txtMemName1.Text.Trim();
          this.DataGridView8.Rows[checked ((int) index4)].Cells[46].Value = (object) this.txtMemName2.Text.Trim();
          this.DataGridView8.Rows[checked ((int) index4)].Cells[47].Value = (object) this.txtMemName3.Text.Trim();
          this.DataGridView8.Rows[checked ((int) index4)].Cells[4].Value = RuntimeHelpers.GetObjectValue(this.DataGridView9.Rows[index5].Cells[18].Value);
          this.DataGridView8.Rows[checked ((int) index4)].Cells[37].Value = RuntimeHelpers.GetObjectValue(this.DataGridView9.Rows[index5].Cells[6].Value);
          if (Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.DataGridView9.Rows[index5].Cells[6].Value.ToString().Trim(), "MBil", false) == 0 | Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.DataGridView9.Rows[index5].Cells[6].Value.ToString().Trim(), "MDbn", false) == 0)
          {
            int num9 = checked (this.DataGridView6.RowCount - 1);
            int num10 = 0;
            while (num10 <= num9)
            {
              this.DataGridView8.Rows[checked ((int) index4)].Cells[checked (5 + num10)].Value = (object) Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView9.Rows[index5].Cells[checked (num10 + 22)].Value));
              numArray[checked (5 + num10)] = Conversion.Val((object) numArray[checked (5 + num10)]) + Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView9.Rows[index5].Cells[checked (num10 + 22)].Value));
              checked { ++num10; }
            }
            this.DataGridView8.Rows[checked ((int) index4)].Cells[checked (5 + this.DataGridView6.RowCount)].Value = (object) Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView9.Rows[index5].Cells[11].Value));
            this.DataGridView8.Rows[checked ((int) index4)].Cells[checked (6 + this.DataGridView6.RowCount)].Value = (object) Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView9.Rows[index5].Cells[12].Value));
            this.DataGridView8.Rows[checked ((int) index4)].Cells[checked (8 + this.DataGridView6.RowCount)].Value = (object) (Conversion.Val((object) Expression) + Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView9.Rows[index5].Cells[12].Value)));
            this.DataGridView8.Rows[checked ((int) index4)].Cells[38].Value = (object) Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView9.Rows[index5].Cells[12].Value));
            this.DataGridView8.Rows[checked ((int) index4)].Cells[40].Value = (object) (Conversion.Val((object) Expression) + Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView9.Rows[index5].Cells[12].Value)));
            Expression = Expression + Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView9.Rows[index5].Cells[12].Value)) - Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView9.Rows[index5].Cells[13].Value));
          }
          else
          {
            ...
            while (num12 <= num11)
            {
              this.DataGridView8.Rows[checked ((int) index4)].Cells[checked (5 + num12)].Value = (object) -Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView9.Rows[index5].Cells[checked (num12 + 22)].Value));
              numArray[checked (5 + num12)] = Conversion.Val((object) numArray[checked (5 + num12)]) + Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView9.Rows[index5].Cells[checked (num12 + 22)].Value));
              checked { ++num12; }
            }
            this.DataGridView8.Rows[checked ((int) index4)].Cells[checked (5 + this.DataGridView6.RowCount)].Value = (object) -Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView9.Rows[index5].Cells[11].Value));
            numArray[checked (6 + this.DataGridView6.RowCount)] = Conversion.Val((object) numArray[checked (6 + this.DataGridView6.RowCount)]) + Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView9.Rows[index5].Cells[11].Value));
            this.DataGridView8.Rows[checked ((int) index4)].Cells[checked (7 + this.DataGridView6.RowCount)].Value = (object) -Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView9.Rows[index5].Cells[13].Value));
            this.DataGridView8.Rows[checked ((int) index4)].Cells[checked (8 + this.DataGridView6.RowCount)].Value = (object) (Conversion.Val((object) Expression) + Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView9.Rows[index5].Cells[13].Value)));
            this.DataGridView8.Rows[checked ((int) index4)].Cells[39].Value = (object) -Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView9.Rows[index5].Cells[13].Value));
            this.DataGridView8.Rows[checked ((int) index4)].Cells[40].Value = (object) (Conversion.Val((object) Expression) + Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView9.Rows[index5].Cells[13].Value)));
            Expression = Expression + Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView9.Rows[index5].Cells[12].Value)) + Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView9.Rows[index5].Cells[13].Value));
          }
          this.DataGridView8.Rows[checked ((int) index4)].Cells[checked (9 + this.DataGridView6.RowCount)].Value = RuntimeHelpers.GetObjectValue(this.DataGridView9.Rows[index5].Cells[14].Value);
          this.DataGridView8.Rows[checked ((int) index4)].Cells[checked (10 + this.DataGridView6.RowCount)].Value = RuntimeHelpers.GetObjectValue(this.DataGridView9.Rows[index5].Cells[15].Value);
          this.DataGridView8.Rows[checked ((int) index4)].Cells[checked (11 + this.DataGridView6.RowCount)].Value = RuntimeHelpers.GetObjectValue(this.DataGridView9.Rows[index5].Cells[16 /*0x10*/].Value);
          this.DataGridView8.Rows[checked ((int) index4)].Cells[checked (12 + this.DataGridView6.RowCount)].Value = RuntimeHelpers.GetObjectValue(this.DataGridView9.Rows[index5].Cells[19].Value);
          this.DataGridView8.Rows[checked ((int) index4)].Cells[checked (13 + this.DataGridView6.RowCount)].Value = RuntimeHelpers.GetObjectValue(this.DataGridView9.Rows[index5].Cells[20].Value);
          this.DataGridView8.Rows[checked ((int) index4)].Cells[checked (14 + this.DataGridView6.RowCount)].Value = RuntimeHelpers.GetObjectValue(this.DataGridView9.Rows[index5].Cells[21].Value);
          DateTime date = Conversions.ToDate(this.DataGridView9.Rows[index5].Cells[5].Value);
          this.DataGridView8.Rows[checked ((int) index4)].Cells[checked (15 + this.DataGridView6.RowCount)].Value = (object) date;
          numArray[checked (5 + this.DataGridView6.RowCount)] = Conversion.Val((object) numArray[checked (5 + this.DataGridView6.RowCount)]) + Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView9.Rows[index5].Cells[11].Value));
          numArray[checked (6 + this.DataGridView6.RowCount)] = Conversion.Val((object) numArray[checked (6 + this.DataGridView6.RowCount)]) + Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView9.Rows[index5].Cells[12].Value));
          numArray[checked (7 + this.DataGridView6.RowCount)] = !(Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.DataGridView9.Rows[index5].Cells[6].Value.ToString().Trim(), "MBil", false) == 0 | Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.DataGridView9.Rows[index5].Cells[6].Value.ToString().Trim(), "MDbn", false) == 0) ? Conversion.Val((object) numArray[checked (7 + this.DataGridView6.RowCount)]) - Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView9.Rows[index5].Cells[13].Value)) : Conversion.Val((object) numArray[checked (7 + this.DataGridView6.RowCount)]) + Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView9.Rows[index5].Cells[13].Value));
          ...
          numArray[checked (9 + this.DataGridView6.RowCount)] = Conversion.Val((object) numArray[checked (9 + this.DataGridView6.RowCount)]) + Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView9.Rows[index5].Cells[14].Value));
        }
        else
        {
          checked { ++index4; }
          ...
          this.DataGridView8.Rows[checked ((int) index4)].Cells[4].Value = RuntimeHelpers.GetObjectValue(this.DataGridView9.Rows[index5].Cells[18].Value);
          this.DataGridView8.Rows[checked ((int) index4)].Cells[37].Value = RuntimeHelpers.GetObjectValue(this.DataGridView9.Rows[index5].Cells[6].Value);
          if (Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.DataGridView9.Rows[index5].Cells[6].Value.ToString().Trim(), "MRct", false) == 0)
          {
            this.DataGridView8.Rows[checked ((int) index4)].Cells[checked (7 + this.DataGridView6.RowCount)].Value = (object) Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView9.Rows[index5].Cells[13].Value));
            this.DataGridView8.Rows[checked ((int) index4)].Cells[39].Value = (object) Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView9.Rows[index5].Cells[13].Value));
          }
          ...
          this.DataGridView8.Rows[checked ((int) index4)].Cells[checked (15 + this.DataGridView6.RowCount)].Value = (object) date;
          if (Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.DataGridView9.Rows[index5].Cells[6].Value.ToString().Trim(), "MRct", false) == 0)
            numArray[checked (7 + this.DataGridView6.RowCount)] = Conversion.Val((object) numArray[checked (7 + this.DataGridView6.RowCount)]) + Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView9.Rows[index5].Cells[13].Value));
          else
            numArray[checked (6 + this.DataGridView6.RowCount)] = Conversion.Val((object) numArray[checked (6 + this.DataGridView6.RowCount)]) + Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView9.Rows[index5].Cells[12].Value));
          numArray[checked (8 + this.DataGridView6.RowCount)] = Conversion.Val((object) numArray[checked (8 + this.DataGridView6.RowCount)]) + Conversion.Val((object) Expression);
          numArray[checked (9 + this.DataGridView6.RowCount)] = Conversion.Val((object) numArray[checked (9 + this.DataGridView6.RowCount)]) + Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView9.Rows[index5].Cells[14].Value));
    ...
    long index6 = checked (index4 + 1L);
    this.DataGridView8.Rows.Add();
    this.DataGridView8.Rows[checked ((int) index6)].Cells[checked (8 + this.DataGridView6.RowCount)].Value = (object) Expression;
    this.DataGridView8.Rows[checked ((int) index6)].Cells[40].Value = (object) Expression;
    int num13 = checked (this.DataGridView6.RowCount + 2);
    int num14 = 0;
    while (num14 <= num13)
    {
      this.DataGridView8.Rows[checked ((int) index6)].Cells[checked (5 + num14)].Value = (object) numArray[checked (5 + num14)];
      numArray[checked (5 + num14)] = 0.0;
      checked { ++num14; }
    }
    this.DataGridView8.Rows[checked ((int) index6)].Cells[2].Value = (object) "Closing";
    this.DataGridView8.Rows[checked ((int) index6)].Cells[0].Value = (object) this.txtMemCode.Text.Trim();
    this.DataGridView8.Rows[checked ((int) index6)].Cells[1].Value = (object) this.txtMemName.Text.Trim();
    this.DataGridView8.Rows[checked ((int) index6)].Cells[45].Value = (object) this.txtMemName1.Text.Trim();
    this.DataGridView8.Rows[checked ((int) index6)].Cells[46].Value = (object) this.txtMemName2.Text.Trim();
    this.DataGridView8.Rows[checked ((int) index6)].Cells[47].Value = (object) this.txtMemName3.Text.Trim();
    this.DataGridView8.Rows[checked ((int) index6)].Cells[37].Value = (object) "C";
    this.DataGridView8.Rows[checked ((int) index6)].Cells[41].Value = (object) "C";
    int num15 = checked (this.DataGridView8.RowCount - 1);
    int index7 = 0;
    while (index7 <= num15)
    {
      ...
      do
      {
        this.DataGridView7.Rows[index7].Cells[index8].Value = RuntimeHelpers.GetObjectValue(this.DataGridView8.Rows[index7].Cells[index8].Value);
        checked { ++index8; }
      }
      while (index8 <= 43);
      if (Microsoft.VisualBasic.CompilerServices.Operators.ConditionalCompareObjectEqual(this.DataGridView8.Rows[index7].Cells[41].Value, (object) "O", false))
      {
        ...
        this.DataGridView7.Rows[checked (this.DataGridView7.RowCount - 1)].DefaultCellStyle.Font = new Font("Arial", 9f, FontStyle.Regular);
      }
      if (Microsoft.VisualBasic.CompilerServices.Operators.ConditionalCompareObjectEqual(this.DataGridView8.Rows[index7].Cells[41].Value, (object) "C", false))
      {
