...
// Type: MauliModule7.WarningDialog
...
public class WarningDialog : Form
{
  ...
  [AccessedThroughProperty("lblWarnMessage")]
  private Label _lblWarnMessage;
  ...
  {
    this.Load += new EventHandler(this.WarningDialog_Load);
    WarningDialog.__ENCAddToList((object) this);
  ...
  {
    lock (WarningDialog.__ENCList)
    {
      if (WarningDialog.__ENCList.Count == WarningDialog.__ENCList.Capacity)
      {
        int index1 = 0;
        int num = checked (WarningDialog.__ENCList.Count - 1);
        int index2 = 0;
        while (index2 <= num)
        {
          if (WarningDialog.__ENCList[index2].IsAlive)
          {
            if (index2 != index1)
              WarningDialog.__ENCList[index1] = WarningDialog.__ENCList[index2];
            checked { ++index1; }
          }
          checked { ++index2; }
        }
        WarningDialog.__ENCList.RemoveRange(index1, checked (WarningDialog.__ENCList.Count - index1));
        WarningDialog.__ENCList.Capacity = WarningDialog.__ENCList.Count;
      }
      WarningDialog.__ENCList.Add(new WeakReference(RuntimeHelpers.GetObjectValue(value)));
    }
  }
  ...
  private void InitializeComponent()
  {
    ...
    this.lblWarnMessage.Font = new Font("Microsoft Sans Serif", 9.75f, FontStyle.Bold, GraphicsUnit.Point, (byte) 0);
    Label lblWarnMessage1 = this.lblWarnMessage;
    point1 = new Point(21, 25);
    Point point5 = point1;
    lblWarnMessage1.Location = point5;
    this.lblWarnMessage.Name = "lblWarnMessage";
    Label lblWarnMessage2 = this.lblWarnMessage;
    size1 = new Size(186, 16 /*0x10*/);
    Size size5 = size1;
    lblWarnMessage2.Size = size5;
    this.lblWarnMessage.TabIndex = 4;
    this.lblWarnMessage.Text = "Sure to Auto Generate Bill";
    this.lblResult.AutoSize = true;
    Label lblResult1 = this.lblResult;
    point1 = new Point(13, 12);
    Point point6 = point1;
    lblResult1.Location = point6;
    this.lblResult.Name = "lblResult";
    Label lblResult2 = this.lblResult;
    size1 = new Size(13, 13);
    Size size6 = size1;
    lblResult2.Size = size6;
    ...
    size1 = new Size(219, 98);
    this.ClientSize = size1;
    this.Controls.Add((Control) this.lblWarnMessage);
    this.Controls.Add((Control) this.lblResult);
    this.Controls.Add((Control) this.TableLayoutPanel1);
    this.FormBorderStyle = FormBorderStyle.FixedDialog;
    this.MaximizeBox = false;
    this.MinimizeBox = false;
    this.Name = nameof (WarningDialog);
  ...
  internal virtual Label lblWarnMessage
  {
    [DebuggerNonUserCode] get => this._lblWarnMessage;
    [DebuggerNonUserCode, MethodImpl(MethodImplOptions.Synchronized)] set
    {
      this._lblWarnMessage = value;
    }
  }
  ...
  private void WarningDialog_Load(object sender, EventArgs e) => this.lblResult.Text = "1";
}
