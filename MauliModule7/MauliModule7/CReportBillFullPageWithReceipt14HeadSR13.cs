...
// Type: MauliModule7.CReportBillFullPageWithReceipt14HeadSR13
...
public class CReportBillFullPageWithReceipt14HeadSR13 : ReportClass
{
  private static List<WeakReference> __ENCList = new List<WeakReference>();

  [DebuggerNonUserCode]
  static CReportBillFullPageWithReceipt14HeadSR13()
  {
  }
  ...
  {
    lock (CReportBillFullPageWithReceipt14HeadSR13.__ENCList)
    {
      if (CReportBillFullPageWithReceipt14HeadSR13.__ENCList.Count == CReportBillFullPageWithReceipt14HeadSR13.__ENCList.Capacity)
      {
        int index1 = 0;
        int num = checked (CReportBillFullPageWithReceipt14HeadSR13.__ENCList.Count - 1);
        int index2 = 0;
        while (index2 <= num)
        {
          if (CReportBillFullPageWithReceipt14HeadSR13.__ENCList[index2].IsAlive)
          {
            if (index2 != index1)
              CReportBillFullPageWithReceipt14HeadSR13.__ENCList[index1] = CReportBillFullPageWithReceipt14HeadSR13.__ENCList[index2];
            checked { ++index1; }
          }
          checked { ++index2; }
        }
        CReportBillFullPageWithReceipt14HeadSR13.__ENCList.RemoveRange(index1, checked (CReportBillFullPageWithReceipt14HeadSR13.__ENCList.Count - index1));
        CReportBillFullPageWithReceipt14HeadSR13.__ENCList.Capacity = CReportBillFullPageWithReceipt14HeadSR13.__ENCList.Count;
      }
      CReportBillFullPageWithReceipt14HeadSR13.__ENCList.Add(new WeakReference(RuntimeHelpers.GetObjectValue(value)));
    }
  }

  public CReportBillFullPageWithReceipt14HeadSR13()
  {
    CReportBillFullPageWithReceipt14HeadSR13.__ENCAddToList((object) this);
  }

  public override string ResourceName
  {
    get => "CReportBillFullPageWithReceipt14HeadSR13.rpt";
    set
    {
    }
  }
  ...
  {
    get => "MauliModule7.CReportBillFullPageWithReceipt14HeadSR13.rpt";
    set
    {
    }
  }
  ...
  [Browsable(false)]
  [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
  public IParameterField Parameter_PB => (IParameterField) this.DataDefinition.ParameterFields[23];
  ...
  [Browsable(false)]
  [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
  public IParameterField Parameter_RecDateFrom
  {
  ...
  [Browsable(false)]
  [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
  public IParameterField Parameter_RecDateTo
  {
