...
// Type: MauliModule7.frmReportIncomeExpenditureMarathi
...
[DesignerGenerated]
public class frmReportIncomeExpenditureMarathi : Form
{
  ...
  [AccessedThroughProperty("mtxtStartDate")]
  private MaskedTextBox _mtxtStartDate;
  private int rk;
  private int fk;
  ...
  [DebuggerNonUserCode]
  static frmReportIncomeExpenditureMarathi()
  {
  }

  [DebuggerNonUserCode]
  public frmReportIncomeExpenditureMarathi()
  {
    this.KeyDown += new KeyEventHandler(this.frmReportIncomeExpenditureMarathi_KeyDown);
    this.Load += new EventHandler(this.frmReportIncomeExpenditureMarathi_Load);
    frmReportIncomeExpenditureMarathi.__ENCAddToList((object) this);
  ...
  {
    lock (frmReportIncomeExpenditureMarathi.__ENCList)
    {
      if (frmReportIncomeExpenditureMarathi.__ENCList.Count == frmReportIncomeExpenditureMarathi.__ENCList.Capacity)
      {
        int index1 = 0;
        int num = checked (frmReportIncomeExpenditureMarathi.__ENCList.Count - 1);
        int index2 = 0;
        while (index2 <= num)
        {
          if (frmReportIncomeExpenditureMarathi.__ENCList[index2].IsAlive)
          {
            if (index2 != index1)
              frmReportIncomeExpenditureMarathi.__ENCList[index1] = frmReportIncomeExpenditureMarathi.__ENCList[index2];
            checked { ++index1; }
          }
          checked { ++index2; }
        }
        frmReportIncomeExpenditureMarathi.__ENCList.RemoveRange(index1, checked (frmReportIncomeExpenditureMarathi.__ENCList.Count - index1));
        frmReportIncomeExpenditureMarathi.__ENCList.Capacity = frmReportIncomeExpenditureMarathi.__ENCList.Count;
      }
      frmReportIncomeExpenditureMarathi.__ENCList.Add(new WeakReference(RuntimeHelpers.GetObjectValue(value)));
    }
  }
  ...
  private void InitializeComponent()
  {
    ...
    ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (frmReportIncomeExpenditureMarathi));
    ...
    this.mtxtStartDate = new MaskedTextBox();
    ...
    this.grpvisible.Controls.Add((Control) this.mtxtStartDate);
    ...
    point1 = new System.Drawing.Point(947, 434);
    ...
    size1 = new Size(38, 52);
    Size size11 = size1;
    grpvisible2.Size = size11;
    this.grpvisible.TabIndex = 26;
    this.grpvisible.TabStop = false;
    this.grpvisible.Text = "GroupBox1";
    this.mtxtStartDate.Font = new System.Drawing.Font("Microsoft Sans Serif", 9.75f, FontStyle.Regular, GraphicsUnit.Point, (byte) 0);
    this.mtxtStartDate.InsertKeyMode = InsertKeyMode.Overwrite;
    MaskedTextBox mtxtStartDate1 = this.mtxtStartDate;
    point1 = new System.Drawing.Point(6, 30);
    System.Drawing.Point point12 = point1;
    mtxtStartDate1.Location = point12;
    this.mtxtStartDate.Mask = "00/00/0000";
    this.mtxtStartDate.Name = "mtxtStartDate";
    MaskedTextBox mtxtStartDate2 = this.mtxtStartDate;
    size1 = new Size(30, 22);
    Size size12 = size1;
    mtxtStartDate2.Size = size12;
    this.mtxtStartDate.TabIndex = 85;
    this.mtxtStartDate.ValidatingType = typeof (DateTime);
    ...
    this.txtTitle.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25f, FontStyle.Regular, GraphicsUnit.Point, (byte) 0);
    ...
    this.Name = nameof (frmReportIncomeExpenditureMarathi);
  ...
  internal virtual MaskedTextBox mtxtStartDate
  {
    [DebuggerNonUserCode] get => this._mtxtStartDate;
    [DebuggerNonUserCode, MethodImpl(MethodImplOptions.Synchronized)] set
    {
      this._mtxtStartDate = value;
    }
  }

  private void frmReportIncomeExpenditureMarathi_KeyDown(object sender, KeyEventArgs e)
  {
  ...
  private void frmReportIncomeExpenditureMarathi_Load(object sender, EventArgs e)
  {
    ...
    this.mtxtStartDate.Text = Conversions.ToString(Constant.socFYSTART);
    this.txtTitle.Text = $"जमा व खर्च कालावधी {this.mtxtStartDate.Text.Trim()} ते {this.mtxtDate.Text.Trim()}";
      ...
      if (Conversions.ToBoolean(Microsoft.VisualBasic.CompilerServices.Operators.OrObject(Microsoft.VisualBasic.CompilerServices.Operators.CompareObjectNotEqual(this.DataGridView3.Rows[index6].Cells[7].Value, (object) 0, false), Microsoft.VisualBasic.CompilerServices.Operators.CompareObjectNotEqual(this.DataGridView3.Rows[index6].Cells[11].Value, (object) 0, false))))
      {
        ...
        else
        {
          ...
          if (Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.DataGridView3.Rows[index6].Cells[9].Value.ToString().Trim(), "False", false) == 0)
          {
            ...
            this.DataGridView2.Rows[this.rk].Cells[5].Value = (object) Math.Round(-Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView3.Rows[index6].Cells[7].Value)), 2);
            this.DataGridView2.Rows[this.rk].Cells[6].Value = RuntimeHelpers.GetObjectValue(this.DataGridView3.Rows[index6].Cells[6].Value);
            this.DataGridView2.Rows[this.rk].Cells[7].Value = (object) Math.Round(-Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView3.Rows[index6].Cells[10].Value)), 2);
            this.DataGridView2.Rows[this.rk].Cells[9].Value = (object) "A";
            this.DataGridView2.Rows[this.rk].Cells[11].Value = RuntimeHelpers.GetObjectValue(this.DataGridView3.Rows[index6].Cells[5].Value);
            this.DataGridView2.Rows[this.rk].Cells[12].Value = RuntimeHelpers.GetObjectValue(this.DataGridView3.Rows[index6].Cells[9].Value);
            this.vgptotal = Conversions.ToDouble(Microsoft.VisualBasic.CompilerServices.Operators.AddObject((object) this.vgptotal, this.DataGridView3.Rows[index6].Cells[11].Value));
  ...
  public DataSet Showreport()
  {
    ...
    this.DataGridView7.Columns[0].HeaderText = "मागील वर्ष";
    this.DataGridView7.Columns[1].HeaderText = "खर्च";
    this.DataGridView7.Columns[3].HeaderText = "चालू वर्ष";
    this.DataGridView7.Columns[6].HeaderText = "मागील वर्ष";
    this.DataGridView7.Columns[7].HeaderText = "जमा";
    this.DataGridView7.Columns[9].HeaderText = "चालू वर्ष";
    ...
    if (Expression2 > Expression1)
    {
      ...
      this.DataGridView7.Rows[checked (this.DataGridView7.RowCount - 1)].Cells[1].Value = (object) "खर्चापेक्षा उत्पन अधिक ";
    ...
    else
    {
      ...
      this.DataGridView7.Rows[checked (this.DataGridView7.RowCount - 1)].Cells[7].Value = (object) "उत्पनापेक्षा खर्च अधिक";
    ...
    this.DataGridView7.Rows[checked (this.DataGridView7.RowCount - 1)].Cells[1].Value = (object) "एकूण";
    ...
    this.DataGridView7.Rows[checked (this.DataGridView7.RowCount - 1)].Cells[7].Value = (object) "एकूण";
  ...
  private void DataGridView7_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
  {
    ...
    if (this.DataGridView7.CurrentCell.ColumnIndex <= 4 && Microsoft.VisualBasic.CompilerServices.Operators.ConditionalCompareObjectEqual(this.DataGridView7.CurrentRow.Cells[4].Value, (object) "G", false))
    {
      ...
      groupDetailDirect.Text = "Update Marathi Group";
