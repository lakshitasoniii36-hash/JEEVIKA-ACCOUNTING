...
// Type: MauliModule7.frmRenumberConfirmDialog
...
[DesignerGenerated]
public class frmRenumberConfirmDialog : Form
{
  ...
  [DebuggerNonUserCode]
  static frmRenumberConfirmDialog()
  {
  }

  [DebuggerNonUserCode]
  public frmRenumberConfirmDialog()
  {
    this.Load += new EventHandler(this.frmRenumberConfirmDialog_Load);
    frmRenumberConfirmDialog.__ENCAddToList((object) this);
  ...
  {
    lock (frmRenumberConfirmDialog.__ENCList)
    {
      if (frmRenumberConfirmDialog.__ENCList.Count == frmRenumberConfirmDialog.__ENCList.Capacity)
      {
        int index1 = 0;
        int num = checked (frmRenumberConfirmDialog.__ENCList.Count - 1);
        int index2 = 0;
        while (index2 <= num)
        {
          if (frmRenumberConfirmDialog.__ENCList[index2].IsAlive)
          {
            if (index2 != index1)
              frmRenumberConfirmDialog.__ENCList[index1] = frmRenumberConfirmDialog.__ENCList[index2];
            checked { ++index1; }
          }
          checked { ++index2; }
        }
        frmRenumberConfirmDialog.__ENCList.RemoveRange(index1, checked (frmRenumberConfirmDialog.__ENCList.Count - index1));
        frmRenumberConfirmDialog.__ENCList.Capacity = frmRenumberConfirmDialog.__ENCList.Count;
      }
      frmRenumberConfirmDialog.__ENCList.Add(new WeakReference(RuntimeHelpers.GetObjectValue(value)));
    }
  }
  ...
  private void InitializeComponent()
  {
    ...
    point1 = new Point(37, 19);
    Point point5 = point1;
    label1_1.Location = point5;
    this.Label1.Name = "Label1";
    Label label1_2 = this.Label1;
    size1 = new Size(144 /*0x90*/, 16 /*0x10*/);
    Size size5 = size1;
    label1_2.Size = size5;
    this.Label1.TabIndex = 4;
    this.Label1.Text = "Sure to Renumber ?";
    this.lblResult.AutoSize = true;
    Label lblResult1 = this.lblResult;
    point1 = new Point(12, 2);
    Point point6 = point1;
    ...
    this.Name = nameof (frmRenumberConfirmDialog);
  ...
  private void frmRenumberConfirmDialog_Load(object sender, EventArgs e)
  {
    this.lblResult.Text = "1";
  }
}
