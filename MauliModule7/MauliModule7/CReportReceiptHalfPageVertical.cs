...
// Type: MauliModule7.CReportReceiptHalfPageVertical
...
public class CReportReceiptHalfPageVertical : ReportClass
{
  private static List<WeakReference> __ENCList = new List<WeakReference>();

  [DebuggerNonUserCode]
  static CReportReceiptHalfPageVertical()
  {
  }
  ...
  {
    lock (CReportReceiptHalfPageVertical.__ENCList)
    {
      if (CReportReceiptHalfPageVertical.__ENCList.Count == CReportReceiptHalfPageVertical.__ENCList.Capacity)
      {
        int index1 = 0;
        int num = checked (CReportReceiptHalfPageVertical.__ENCList.Count - 1);
        int index2 = 0;
        while (index2 <= num)
        {
          if (CReportReceiptHalfPageVertical.__ENCList[index2].IsAlive)
          {
            if (index2 != index1)
              CReportReceiptHalfPageVertical.__ENCList[index1] = CReportReceiptHalfPageVertical.__ENCList[index2];
            checked { ++index1; }
          }
          checked { ++index2; }
        }
        CReportReceiptHalfPageVertical.__ENCList.RemoveRange(index1, checked (CReportReceiptHalfPageVertical.__ENCList.Count - index1));
        CReportReceiptHalfPageVertical.__ENCList.Capacity = CReportReceiptHalfPageVertical.__ENCList.Count;
      }
      CReportReceiptHalfPageVertical.__ENCList.Add(new WeakReference(RuntimeHelpers.GetObjectValue(value)));
    }
  }

  public CReportReceiptHalfPageVertical()
  {
    CReportReceiptHalfPageVertical.__ENCAddToList((object) this);
  }

  public override string ResourceName
  {
    get => "CReportReceiptHalfPageVertical.rpt";
    set
    {
    }
  }
  ...
  {
    get => "MauliModule7.CReportReceiptHalfPageVertical.rpt";
    set
    {
    }
  }
