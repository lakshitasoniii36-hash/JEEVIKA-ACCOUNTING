...
// Type: MauliModule7.frmDigPeriodRange
...
[DesignerGenerated]
public class frmDigPeriodRange : Form
{
  ...
  [DebuggerNonUserCode]
  static frmDigPeriodRange()
  {
  }

  [DebuggerNonUserCode]
  public frmDigPeriodRange()
  {
    this.Load += new EventHandler(this.frmDigPeriodRange_Load);
    frmDigPeriodRange.__ENCAddToList((object) this);
  ...
  {
    lock (frmDigPeriodRange.__ENCList)
    {
      if (frmDigPeriodRange.__ENCList.Count == frmDigPeriodRange.__ENCList.Capacity)
      {
        int index1 = 0;
        int num = checked (frmDigPeriodRange.__ENCList.Count - 1);
        int index2 = 0;
        while (index2 <= num)
        {
          if (frmDigPeriodRange.__ENCList[index2].IsAlive)
          {
            if (index2 != index1)
              frmDigPeriodRange.__ENCList[index1] = frmDigPeriodRange.__ENCList[index2];
            checked { ++index1; }
          }
          checked { ++index2; }
        }
        frmDigPeriodRange.__ENCList.RemoveRange(index1, checked (frmDigPeriodRange.__ENCList.Count - index1));
        frmDigPeriodRange.__ENCList.Capacity = frmDigPeriodRange.__ENCList.Count;
      }
      frmDigPeriodRange.__ENCList.Add(new WeakReference(RuntimeHelpers.GetObjectValue(value)));
    }
  }
  ...
  private void InitializeComponent()
  {
    ...
    this.Name = nameof (frmDigPeriodRange);
  ...
  private void frmDigPeriodRange_Load(object sender, EventArgs e)
  {
