...
// Type: MauliModule7.CReprotMemControl
...
public class CReprotMemControl : ReportClass
{
  private static List<WeakReference> __ENCList = new List<WeakReference>();

  [DebuggerNonUserCode]
  static CReprotMemControl()
  {
  }
  ...
  {
    lock (CReprotMemControl.__ENCList)
    {
      if (CReprotMemControl.__ENCList.Count == CReprotMemControl.__ENCList.Capacity)
      {
        int index1 = 0;
        int num = checked (CReprotMemControl.__ENCList.Count - 1);
        int index2 = 0;
        while (index2 <= num)
        {
          if (CReprotMemControl.__ENCList[index2].IsAlive)
          {
            if (index2 != index1)
              CReprotMemControl.__ENCList[index1] = CReprotMemControl.__ENCList[index2];
            checked { ++index1; }
          }
          checked { ++index2; }
        }
        CReprotMemControl.__ENCList.RemoveRange(index1, checked (CReprotMemControl.__ENCList.Count - index1));
        CReprotMemControl.__ENCList.Capacity = CReprotMemControl.__ENCList.Count;
      }
      CReprotMemControl.__ENCList.Add(new WeakReference(RuntimeHelpers.GetObjectValue(value)));
    }
  }

  public CReprotMemControl() => CReprotMemControl.__ENCAddToList((object) this);

  public override string ResourceName
  {
    get => "CReprotMemControl.rpt";
    set
    {
    }
  }
  ...
  {
    get => "MauliModule7.CReprotMemControl.rpt";
    set
    {
    }
  }
  ...
  [Browsable(false)]
  [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
  public Section PageHeaderSection4 => this.ReportDefinition.Sections[3];
  ...
  [Browsable(false)]
  [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
  public Section DetailSection5 => this.ReportDefinition.Sections[6];
  ...
  [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
  [Browsable(false)]
  public Section GroupFooterSection3 => this.ReportDefinition.Sections[9];
  ...
  [Browsable(false)]
  [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
  public Section ReportFooterSection4 => this.ReportDefinition.Sections[11];

  [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
  [Browsable(false)]
  public Section ReportFooterSection2 => this.ReportDefinition.Sections[12];

  [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
  [Browsable(false)]
  public Section ReportFooterSection5 => this.ReportDefinition.Sections[13];
