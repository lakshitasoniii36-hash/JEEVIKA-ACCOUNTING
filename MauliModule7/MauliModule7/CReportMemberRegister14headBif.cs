...
// Type: MauliModule7.CReportMemberRegister14headBif
...
public class CReportMemberRegister14headBif : ReportClass
{
  private static List<WeakReference> __ENCList = new List<WeakReference>();

  [DebuggerNonUserCode]
  static CReportMemberRegister14headBif()
  {
  }
  ...
  {
    lock (CReportMemberRegister14headBif.__ENCList)
    {
      if (CReportMemberRegister14headBif.__ENCList.Count == CReportMemberRegister14headBif.__ENCList.Capacity)
      {
        int index1 = 0;
        int num = checked (CReportMemberRegister14headBif.__ENCList.Count - 1);
        int index2 = 0;
        while (index2 <= num)
        {
          if (CReportMemberRegister14headBif.__ENCList[index2].IsAlive)
          {
            if (index2 != index1)
              CReportMemberRegister14headBif.__ENCList[index1] = CReportMemberRegister14headBif.__ENCList[index2];
            checked { ++index1; }
          }
          checked { ++index2; }
        }
        CReportMemberRegister14headBif.__ENCList.RemoveRange(index1, checked (CReportMemberRegister14headBif.__ENCList.Count - index1));
        CReportMemberRegister14headBif.__ENCList.Capacity = CReportMemberRegister14headBif.__ENCList.Count;
      }
      CReportMemberRegister14headBif.__ENCList.Add(new WeakReference(RuntimeHelpers.GetObjectValue(value)));
    }
  }

  public CReportMemberRegister14headBif()
  {
    CReportMemberRegister14headBif.__ENCAddToList((object) this);
  }

  public override string ResourceName
  {
    get => "CReportMemberRegister14headBif.rpt";
    set
    {
    }
  }
  ...
  {
    get => "MauliModule7.CReportMemberRegister14headBif.rpt";
    set
    {
    }
  }
