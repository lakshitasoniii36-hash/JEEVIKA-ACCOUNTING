...
// Type: MauliModule7.CReportReceiptRegister14head
...
public class CReportReceiptRegister14head : ReportClass
{
  private static List<WeakReference> __ENCList = new List<WeakReference>();

  [DebuggerNonUserCode]
  static CReportReceiptRegister14head()
  {
  }
  ...
  {
    lock (CReportReceiptRegister14head.__ENCList)
    {
      if (CReportReceiptRegister14head.__ENCList.Count == CReportReceiptRegister14head.__ENCList.Capacity)
      {
        int index1 = 0;
        int num = checked (CReportReceiptRegister14head.__ENCList.Count - 1);
        int index2 = 0;
        while (index2 <= num)
        {
          if (CReportReceiptRegister14head.__ENCList[index2].IsAlive)
          {
            if (index2 != index1)
              CReportReceiptRegister14head.__ENCList[index1] = CReportReceiptRegister14head.__ENCList[index2];
            checked { ++index1; }
          }
          checked { ++index2; }
        }
        CReportReceiptRegister14head.__ENCList.RemoveRange(index1, checked (CReportReceiptRegister14head.__ENCList.Count - index1));
        CReportReceiptRegister14head.__ENCList.Capacity = CReportReceiptRegister14head.__ENCList.Count;
      }
      CReportReceiptRegister14head.__ENCList.Add(new WeakReference(RuntimeHelpers.GetObjectValue(value)));
    }
  }

  public CReportReceiptRegister14head()
  {
    CReportReceiptRegister14head.__ENCAddToList((object) this);
  }

  public override string ResourceName
  {
    get => "CReportReceiptRegister14head.rpt";
    set
    {
    }
  }
  ...
  {
    get => "MauliModule7.CReportReceiptRegister14head.rpt";
    set
    {
    }
  }
