...
// Type: MauliModule7.CReportMemberControlAccount
...
public class CReportMemberControlAccount : ReportClass
{
  private static List<WeakReference> __ENCList = new List<WeakReference>();

  [DebuggerNonUserCode]
  static CReportMemberControlAccount()
  {
  }
  ...
  {
    lock (CReportMemberControlAccount.__ENCList)
    {
      if (CReportMemberControlAccount.__ENCList.Count == CReportMemberControlAccount.__ENCList.Capacity)
      {
        int index1 = 0;
        int num = checked (CReportMemberControlAccount.__ENCList.Count - 1);
        int index2 = 0;
        while (index2 <= num)
        {
          if (CReportMemberControlAccount.__ENCList[index2].IsAlive)
          {
            if (index2 != index1)
              CReportMemberControlAccount.__ENCList[index1] = CReportMemberControlAccount.__ENCList[index2];
            checked { ++index1; }
          }
          checked { ++index2; }
        }
        CReportMemberControlAccount.__ENCList.RemoveRange(index1, checked (CReportMemberControlAccount.__ENCList.Count - index1));
        CReportMemberControlAccount.__ENCList.Capacity = CReportMemberControlAccount.__ENCList.Count;
      }
      CReportMemberControlAccount.__ENCList.Add(new WeakReference(RuntimeHelpers.GetObjectValue(value)));
    }
  }

  public CReportMemberControlAccount() => CReportMemberControlAccount.__ENCAddToList((object) this);

  public override string ResourceName
  {
    get => "CReportMemberControlAccount.rpt";
    set
    {
    }
  }
  ...
  {
    get => "MauliModule7.CReportMemberControlAccount.rpt";
    set
    {
    }
  }
