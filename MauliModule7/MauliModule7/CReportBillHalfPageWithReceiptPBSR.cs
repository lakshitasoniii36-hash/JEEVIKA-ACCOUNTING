...
// Type: MauliModule7.CReportBillHalfPageWithReceiptPBSR
...
public class CReportBillHalfPageWithReceiptPBSR : ReportClass
{
  private static List<WeakReference> __ENCList = new List<WeakReference>();

  [DebuggerNonUserCode]
  static CReportBillHalfPageWithReceiptPBSR()
  {
  }
  ...
  {
    lock (CReportBillHalfPageWithReceiptPBSR.__ENCList)
    {
      if (CReportBillHalfPageWithReceiptPBSR.__ENCList.Count == CReportBillHalfPageWithReceiptPBSR.__ENCList.Capacity)
      {
        int index1 = 0;
        int num = checked (CReportBillHalfPageWithReceiptPBSR.__ENCList.Count - 1);
        int index2 = 0;
        while (index2 <= num)
        {
          if (CReportBillHalfPageWithReceiptPBSR.__ENCList[index2].IsAlive)
          {
            if (index2 != index1)
              CReportBillHalfPageWithReceiptPBSR.__ENCList[index1] = CReportBillHalfPageWithReceiptPBSR.__ENCList[index2];
            checked { ++index1; }
          }
          checked { ++index2; }
        }
        CReportBillHalfPageWithReceiptPBSR.__ENCList.RemoveRange(index1, checked (CReportBillHalfPageWithReceiptPBSR.__ENCList.Count - index1));
        CReportBillHalfPageWithReceiptPBSR.__ENCList.Capacity = CReportBillHalfPageWithReceiptPBSR.__ENCList.Count;
      }
      CReportBillHalfPageWithReceiptPBSR.__ENCList.Add(new WeakReference(RuntimeHelpers.GetObjectValue(value)));
    }
  }

  public CReportBillHalfPageWithReceiptPBSR()
  {
    CReportBillHalfPageWithReceiptPBSR.__ENCAddToList((object) this);
  }

  public override string ResourceName
  {
    get => "CReportBillHalfPageWithReceiptPBSR.rpt";
    set
    {
    }
  }
  ...
  {
    get => "MauliModule7.CReportBillHalfPageWithReceiptPBSR.rpt";
    set
    {
    }
  }
