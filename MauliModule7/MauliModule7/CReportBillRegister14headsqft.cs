...
// Type: MauliModule7.CReportBillRegister14headsqft
...
public class CReportBillRegister14headsqft : ReportClass
{
  private static List<WeakReference> __ENCList = new List<WeakReference>();

  [DebuggerNonUserCode]
  static CReportBillRegister14headsqft()
  {
  }
  ...
  {
    lock (CReportBillRegister14headsqft.__ENCList)
    {
      if (CReportBillRegister14headsqft.__ENCList.Count == CReportBillRegister14headsqft.__ENCList.Capacity)
      {
        int index1 = 0;
        int num = checked (CReportBillRegister14headsqft.__ENCList.Count - 1);
        int index2 = 0;
        while (index2 <= num)
        {
          if (CReportBillRegister14headsqft.__ENCList[index2].IsAlive)
          {
            if (index2 != index1)
              CReportBillRegister14headsqft.__ENCList[index1] = CReportBillRegister14headsqft.__ENCList[index2];
            checked { ++index1; }
          }
          checked { ++index2; }
        }
        CReportBillRegister14headsqft.__ENCList.RemoveRange(index1, checked (CReportBillRegister14headsqft.__ENCList.Count - index1));
        CReportBillRegister14headsqft.__ENCList.Capacity = CReportBillRegister14headsqft.__ENCList.Count;
      }
      CReportBillRegister14headsqft.__ENCList.Add(new WeakReference(RuntimeHelpers.GetObjectValue(value)));
    }
  }

  public CReportBillRegister14headsqft()
  {
    CReportBillRegister14headsqft.__ENCAddToList((object) this);
  }

  public override string ResourceName
  {
    get => "CReportBillRegister14headsqft.rpt";
    set
    {
    }
  }
  ...
  {
    get => "MauliModule7.CReportBillRegister14headsqft.rpt";
    set
    {
    }
  }
