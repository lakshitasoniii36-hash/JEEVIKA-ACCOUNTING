...
// Type: MauliModule7.CReportBillRegister14headWithNameVertical
...
public class CReportBillRegister14headWithNameVertical : ReportClass
{
  private static List<WeakReference> __ENCList = new List<WeakReference>();

  [DebuggerNonUserCode]
  static CReportBillRegister14headWithNameVertical()
  {
  }
  ...
  {
    lock (CReportBillRegister14headWithNameVertical.__ENCList)
    {
      if (CReportBillRegister14headWithNameVertical.__ENCList.Count == CReportBillRegister14headWithNameVertical.__ENCList.Capacity)
      {
        int index1 = 0;
        int num = checked (CReportBillRegister14headWithNameVertical.__ENCList.Count - 1);
        int index2 = 0;
        while (index2 <= num)
        {
          if (CReportBillRegister14headWithNameVertical.__ENCList[index2].IsAlive)
          {
            if (index2 != index1)
              CReportBillRegister14headWithNameVertical.__ENCList[index1] = CReportBillRegister14headWithNameVertical.__ENCList[index2];
            checked { ++index1; }
          }
          checked { ++index2; }
        }
        CReportBillRegister14headWithNameVertical.__ENCList.RemoveRange(index1, checked (CReportBillRegister14headWithNameVertical.__ENCList.Count - index1));
        CReportBillRegister14headWithNameVertical.__ENCList.Capacity = CReportBillRegister14headWithNameVertical.__ENCList.Count;
      }
      CReportBillRegister14headWithNameVertical.__ENCList.Add(new WeakReference(RuntimeHelpers.GetObjectValue(value)));
    }
  }

  public CReportBillRegister14headWithNameVertical()
  {
    CReportBillRegister14headWithNameVertical.__ENCAddToList((object) this);
  }

  public override string ResourceName
  {
    get => "CReportBillRegister14headWithNameVertical.rpt";
    set
    {
    }
  }
  ...
  {
    get => "MauliModule7.CReportBillRegister14headWithNameVertical.rpt";
    set
    {
    }
  }
