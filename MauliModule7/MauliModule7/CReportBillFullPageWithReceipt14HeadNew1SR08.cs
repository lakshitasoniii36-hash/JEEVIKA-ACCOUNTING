...
// Type: MauliModule7.CReportBillFullPageWithReceipt14HeadNew1SR08
...
public class CReportBillFullPageWithReceipt14HeadNew1SR08 : ReportClass
{
  private static List<WeakReference> __ENCList = new List<WeakReference>();

  [DebuggerNonUserCode]
  static CReportBillFullPageWithReceipt14HeadNew1SR08()
  {
  }
  ...
  {
    lock (CReportBillFullPageWithReceipt14HeadNew1SR08.__ENCList)
    {
      if (CReportBillFullPageWithReceipt14HeadNew1SR08.__ENCList.Count == CReportBillFullPageWithReceipt14HeadNew1SR08.__ENCList.Capacity)
      {
        int index1 = 0;
        int num = checked (CReportBillFullPageWithReceipt14HeadNew1SR08.__ENCList.Count - 1);
        int index2 = 0;
        while (index2 <= num)
        {
          if (CReportBillFullPageWithReceipt14HeadNew1SR08.__ENCList[index2].IsAlive)
          {
            if (index2 != index1)
              CReportBillFullPageWithReceipt14HeadNew1SR08.__ENCList[index1] = CReportBillFullPageWithReceipt14HeadNew1SR08.__ENCList[index2];
            checked { ++index1; }
          }
          checked { ++index2; }
        }
        CReportBillFullPageWithReceipt14HeadNew1SR08.__ENCList.RemoveRange(index1, checked (CReportBillFullPageWithReceipt14HeadNew1SR08.__ENCList.Count - index1));
        CReportBillFullPageWithReceipt14HeadNew1SR08.__ENCList.Capacity = CReportBillFullPageWithReceipt14HeadNew1SR08.__ENCList.Count;
      }
      CReportBillFullPageWithReceipt14HeadNew1SR08.__ENCList.Add(new WeakReference(RuntimeHelpers.GetObjectValue(value)));
    }
  }

  public CReportBillFullPageWithReceipt14HeadNew1SR08()
  {
    CReportBillFullPageWithReceipt14HeadNew1SR08.__ENCAddToList((object) this);
  }

  public override string ResourceName
  {
    get => "CReportBillFullPageWithReceipt14HeadNew1SR08.rpt";
    set
    {
    }
  }
  ...
  {
    get => "MauliModule7.CReportBillFullPageWithReceipt14HeadNew1SR08.rpt";
    set
    {
    }
  }
  ...
  [Browsable(false)]
  [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
  public Section GroupFooterSection4 => this.ReportDefinition.Sections[12];

  [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
  [Browsable(false)]
  public Section GroupFooterSection3 => this.ReportDefinition.Sections[13];
