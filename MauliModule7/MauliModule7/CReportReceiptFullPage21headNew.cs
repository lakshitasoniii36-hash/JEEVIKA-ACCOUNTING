...
// Type: MauliModule7.CReportReceiptFullPage21headNew
...
public class CReportReceiptFullPage21headNew : ReportClass
{
  private static List<WeakReference> __ENCList = new List<WeakReference>();

  [DebuggerNonUserCode]
  static CReportReceiptFullPage21headNew()
  {
  }
  ...
  {
    lock (CReportReceiptFullPage21headNew.__ENCList)
    {
      if (CReportReceiptFullPage21headNew.__ENCList.Count == CReportReceiptFullPage21headNew.__ENCList.Capacity)
      {
        int index1 = 0;
        int num = checked (CReportReceiptFullPage21headNew.__ENCList.Count - 1);
        int index2 = 0;
        while (index2 <= num)
        {
          if (CReportReceiptFullPage21headNew.__ENCList[index2].IsAlive)
          {
            if (index2 != index1)
              CReportReceiptFullPage21headNew.__ENCList[index1] = CReportReceiptFullPage21headNew.__ENCList[index2];
            checked { ++index1; }
          }
          checked { ++index2; }
        }
        CReportReceiptFullPage21headNew.__ENCList.RemoveRange(index1, checked (CReportReceiptFullPage21headNew.__ENCList.Count - index1));
        CReportReceiptFullPage21headNew.__ENCList.Capacity = CReportReceiptFullPage21headNew.__ENCList.Count;
      }
      CReportReceiptFullPage21headNew.__ENCList.Add(new WeakReference(RuntimeHelpers.GetObjectValue(value)));
    }
  }

  public CReportReceiptFullPage21headNew()
  {
    CReportReceiptFullPage21headNew.__ENCAddToList((object) this);
  }

  public override string ResourceName
  {
    get => "CReportReceiptFullPage21headNew.rpt";
    set
    {
    }
  }
  ...
  {
    get => "MauliModule7.CReportReceiptFullPage21headNew.rpt";
    set
    {
    }
  }
