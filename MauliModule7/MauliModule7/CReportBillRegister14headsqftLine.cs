...
// Type: MauliModule7.CReportBillRegister14headsqftLine
...
public class CReportBillRegister14headsqftLine : ReportClass
{
  private static List<WeakReference> __ENCList = new List<WeakReference>();

  [DebuggerNonUserCode]
  static CReportBillRegister14headsqftLine()
  {
  }
  ...
  {
    lock (CReportBillRegister14headsqftLine.__ENCList)
    {
      if (CReportBillRegister14headsqftLine.__ENCList.Count == CReportBillRegister14headsqftLine.__ENCList.Capacity)
      {
        int index1 = 0;
        int num = checked (CReportBillRegister14headsqftLine.__ENCList.Count - 1);
        int index2 = 0;
        while (index2 <= num)
        {
          if (CReportBillRegister14headsqftLine.__ENCList[index2].IsAlive)
          {
            if (index2 != index1)
              CReportBillRegister14headsqftLine.__ENCList[index1] = CReportBillRegister14headsqftLine.__ENCList[index2];
            checked { ++index1; }
          }
          checked { ++index2; }
        }
        CReportBillRegister14headsqftLine.__ENCList.RemoveRange(index1, checked (CReportBillRegister14headsqftLine.__ENCList.Count - index1));
        CReportBillRegister14headsqftLine.__ENCList.Capacity = CReportBillRegister14headsqftLine.__ENCList.Count;
      }
      CReportBillRegister14headsqftLine.__ENCList.Add(new WeakReference(RuntimeHelpers.GetObjectValue(value)));
    }
  }

  public CReportBillRegister14headsqftLine()
  {
    CReportBillRegister14headsqftLine.__ENCAddToList((object) this);
  }

  public override string ResourceName
  {
    get => "CReportBillRegister14headsqftLine.rpt";
    set
    {
    }
  }
  ...
  {
    get => "MauliModule7.CReportBillRegister14headsqftLine.rpt";
    set
    {
    }
  }
