...
// Type: MauliModule7.CReportBillRegister14headWithNameVerticalSqft
...
public class CReportBillRegister14headWithNameVerticalSqft : ReportClass
{
  private static List<WeakReference> __ENCList = new List<WeakReference>();

  [DebuggerNonUserCode]
  static CReportBillRegister14headWithNameVerticalSqft()
  {
  }
  ...
  {
    lock (CReportBillRegister14headWithNameVerticalSqft.__ENCList)
    {
      if (CReportBillRegister14headWithNameVerticalSqft.__ENCList.Count == CReportBillRegister14headWithNameVerticalSqft.__ENCList.Capacity)
      {
        int index1 = 0;
        int num = checked (CReportBillRegister14headWithNameVerticalSqft.__ENCList.Count - 1);
        int index2 = 0;
        while (index2 <= num)
        {
          if (CReportBillRegister14headWithNameVerticalSqft.__ENCList[index2].IsAlive)
          {
            if (index2 != index1)
              CReportBillRegister14headWithNameVerticalSqft.__ENCList[index1] = CReportBillRegister14headWithNameVerticalSqft.__ENCList[index2];
            checked { ++index1; }
          }
          checked { ++index2; }
        }
        CReportBillRegister14headWithNameVerticalSqft.__ENCList.RemoveRange(index1, checked (CReportBillRegister14headWithNameVerticalSqft.__ENCList.Count - index1));
        CReportBillRegister14headWithNameVerticalSqft.__ENCList.Capacity = CReportBillRegister14headWithNameVerticalSqft.__ENCList.Count;
      }
      CReportBillRegister14headWithNameVerticalSqft.__ENCList.Add(new WeakReference(RuntimeHelpers.GetObjectValue(value)));
    }
  }

  public CReportBillRegister14headWithNameVerticalSqft()
  {
    CReportBillRegister14headWithNameVerticalSqft.__ENCAddToList((object) this);
  }

  public override string ResourceName
  {
    get => "CReportBillRegister14headWithNameVerticalSqft.rpt";
    set
    {
    }
  }
  ...
  {
    get => "MauliModule7.CReportBillRegister14headWithNameVerticalSqft.rpt";
    set
    {
    }
  }
  ...
  [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
  [Browsable(false)]
  public Section ReportFooterSection1 => this.ReportDefinition.Sections[9];
