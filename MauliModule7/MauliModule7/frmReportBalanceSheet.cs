...
// Type: MauliModule7.frmReportBalanceSheet
...
[DesignerGenerated]
public class frmReportBalanceSheet : Form
{
  ...
  [DebuggerNonUserCode]
  static frmReportBalanceSheet()
  {
  }

  [DebuggerNonUserCode]
  public frmReportBalanceSheet()
  {
    this.KeyDown += new KeyEventHandler(this.frmReportBalanceSheet_KeyDown);
    this.Load += new EventHandler(this.frmReportBalanceSheet_Load);
    frmReportBalanceSheet.__ENCAddToList((object) this);
  ...
  {
    lock (frmReportBalanceSheet.__ENCList)
    {
      if (frmReportBalanceSheet.__ENCList.Count == frmReportBalanceSheet.__ENCList.Capacity)
      {
        int index1 = 0;
        int num = checked (frmReportBalanceSheet.__ENCList.Count - 1);
        int index2 = 0;
        while (index2 <= num)
        {
          if (frmReportBalanceSheet.__ENCList[index2].IsAlive)
          {
            if (index2 != index1)
              frmReportBalanceSheet.__ENCList[index1] = frmReportBalanceSheet.__ENCList[index2];
            checked { ++index1; }
          }
          checked { ++index2; }
        }
        frmReportBalanceSheet.__ENCList.RemoveRange(index1, checked (frmReportBalanceSheet.__ENCList.Count - index1));
        frmReportBalanceSheet.__ENCList.Capacity = frmReportBalanceSheet.__ENCList.Count;
      }
      frmReportBalanceSheet.__ENCList.Add(new WeakReference(RuntimeHelpers.GetObjectValue(value)));
    }
  }
  ...
  private void InitializeComponent()
  {
    ...
    ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (frmReportBalanceSheet));
    ...
    point1 = new System.Drawing.Point(12, 467);
    ...
    point1 = new System.Drawing.Point(17, 52);
    ...
    point1 = new System.Drawing.Point(9, 37);
    ...
    dataGridView7_1.Location = point16;
    this.DataGridView7.Name = "DataGridView7";
    DataGridView dataGridView7_2 = this.DataGridView7;
    size1 = new Size(10, 10);
    Size size16 = size1;
    dataGridView7_2.Size = size16;
    ...
    chkHeaderDate1.Location = point26;
    ...
    chkPrintFooter1.Location = point27;
    ...
    this.Name = nameof (frmReportBalanceSheet);
  ...
  private void frmReportBalanceSheet_KeyDown(object sender, KeyEventArgs e)
  {
  ...
  private void frmReportBalanceSheet_Load(object sender, EventArgs e)
  {
  ...
  private void btnPrint_Click(object sender, EventArgs e) => this.PrintBOABS();
  ...
  public DataSet GetFillGrid()
  {
    ...
    if (Microsoft.VisualBasic.CompilerServices.Operators.CompareString(Left, "0", false) == 0)
    {
      ...
      this.DataGridView2.Rows[this.rk].Cells[1].Value = (object) "Advance From Member";
      ...
      this.DataGridView2.Rows[this.rk].Cells[6].Value = (object) "Dues from Member";
  ...
  public DataSet Showreport()
  {
    ...
    this.DataGridView9.Columns[0].HeaderText = "Previous Year";
    this.DataGridView9.Columns[1].HeaderText = "Liabilities";
    this.DataGridView9.Columns[3].HeaderText = "Current Year";
    this.DataGridView9.Columns[6].HeaderText = "Previous Year";
    this.DataGridView9.Columns[7].HeaderText = "Assets";
    this.DataGridView9.Columns[9].HeaderText = "Current Year";
    ...
    this.DataGridView9.Rows[checked (this.DataGridView9.RowCount - 1)].Cells[1].Value = (object) "AUTHORISED SHARE CAPITAL";
    ...
    if (Expression2 > Expression1)
    {
      ...
      this.DataGridView9.Rows[checked (this.DataGridView9.RowCount - 1)].Cells[1].Value = (object) "To Surplus during the year";
    ...
    else
    {
      ...
      this.DataGridView9.Rows[checked (this.DataGridView9.RowCount - 1)].Cells[7].Value = (object) "By Deficit during the year";
    ...
    this.DataGridView9.Rows[checked (this.DataGridView9.RowCount - 1)].Cells[1].Value = (object) "Total";
    ...
    this.DataGridView9.Rows[checked (this.DataGridView9.RowCount - 1)].Cells[7].Value = (object) "Total";
    ...
    else if (Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.btnPrint.Text, "Mail to Committee", false) == 0)
    {
      ...
      if (Microsoft.VisualBasic.CompilerServices.Operators.CompareString(MyProject.Forms.frmEmailCommittee.txtSendStatus.Text, "Yes", false) == 0)
      {
        try
        {
          DiskFileDestinationOptions destinationOptions = new DiskFileDestinationOptions();
          PdfRtfWordFormatOptions wordFormatOptions = new PdfRtfWordFormatOptions();
          destinationOptions.DiskFileName = Constant.socDataPath.Trim() + "\\pdfemail\\BalanceSheet.pdf";
          ExportOptions exportOptions = reportDocument.ExportOptions;
          exportOptions.ExportDestinationType = ExportDestinationType.DiskFile;
          exportOptions.ExportFormatType = ExportFormatType.PortableDocFormat;
          exportOptions.DestinationOptions = (object) destinationOptions;
