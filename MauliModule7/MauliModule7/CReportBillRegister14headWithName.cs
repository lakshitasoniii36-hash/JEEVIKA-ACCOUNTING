...
// Type: MauliModule7.CReportBillRegister14headWithName
...
public class CReportBillRegister14headWithName : ReportClass
{
  private static List<WeakReference> __ENCList = new List<WeakReference>();

  [DebuggerNonUserCode]
  static CReportBillRegister14headWithName()
  {
  }
  ...
  {
    lock (CReportBillRegister14headWithName.__ENCList)
    {
      if (CReportBillRegister14headWithName.__ENCList.Count == CReportBillRegister14headWithName.__ENCList.Capacity)
      {
        int index1 = 0;
        int num = checked (CReportBillRegister14headWithName.__ENCList.Count - 1);
        int index2 = 0;
        while (index2 <= num)
        {
          if (CReportBillRegister14headWithName.__ENCList[index2].IsAlive)
          {
            if (index2 != index1)
              CReportBillRegister14headWithName.__ENCList[index1] = CReportBillRegister14headWithName.__ENCList[index2];
            checked { ++index1; }
          }
          checked { ++index2; }
        }
        CReportBillRegister14headWithName.__ENCList.RemoveRange(index1, checked (CReportBillRegister14headWithName.__ENCList.Count - index1));
        CReportBillRegister14headWithName.__ENCList.Capacity = CReportBillRegister14headWithName.__ENCList.Count;
      }
      CReportBillRegister14headWithName.__ENCList.Add(new WeakReference(RuntimeHelpers.GetObjectValue(value)));
    }
  }

  public CReportBillRegister14headWithName()
  {
    CReportBillRegister14headWithName.__ENCAddToList((object) this);
  }

  public override string ResourceName
  {
    get => "CReportBillRegister14headWithName.rpt";
    set
    {
    }
  }
  ...
  {
    get => "MauliModule7.CReportBillRegister14headWithName.rpt";
    set
    {
    }
  }
