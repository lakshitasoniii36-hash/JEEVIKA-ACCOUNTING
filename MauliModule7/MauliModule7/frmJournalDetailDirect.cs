...
// Type: MauliModule7.frmJournalDetailDirect
...
[DesignerGenerated]
public class frmJournalDetailDirect : Form
{
  ...
  [DebuggerNonUserCode]
  static frmJournalDetailDirect()
  {
  }

  [DebuggerNonUserCode]
  public frmJournalDetailDirect()
  {
    this.KeyDown += new KeyEventHandler(this.frmJournalDetailDirect_KeyDown);
    this.Load += new EventHandler(this.frmJournalDetailDirect_Load);
    frmJournalDetailDirect.__ENCAddToList((object) this);
  ...
  {
    lock (frmJournalDetailDirect.__ENCList)
    {
      if (frmJournalDetailDirect.__ENCList.Count == frmJournalDetailDirect.__ENCList.Capacity)
      {
        int index1 = 0;
        int num = checked (frmJournalDetailDirect.__ENCList.Count - 1);
        int index2 = 0;
        while (index2 <= num)
        {
          if (frmJournalDetailDirect.__ENCList[index2].IsAlive)
          {
            if (index2 != index1)
              frmJournalDetailDirect.__ENCList[index1] = frmJournalDetailDirect.__ENCList[index2];
            checked { ++index1; }
          }
          checked { ++index2; }
        }
        frmJournalDetailDirect.__ENCList.RemoveRange(index1, checked (frmJournalDetailDirect.__ENCList.Count - index1));
        frmJournalDetailDirect.__ENCList.Capacity = frmJournalDetailDirect.__ENCList.Count;
      }
      frmJournalDetailDirect.__ENCList.Add(new WeakReference(RuntimeHelpers.GetObjectValue(value)));
    }
  }
  ...
  private void InitializeComponent()
  {
    ...
    ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (frmJournalDetailDirect));
    ...
    dataGridView9_1.Location = point51;
    this.DataGridView9.Name = "DataGridView9";
    DataGridView dataGridView9_2 = this.DataGridView9;
    size1 = new Size(18, 19);
    Size size51 = size1;
    dataGridView9_2.Size = size51;
    this.DataGridView9.TabIndex = 133;
    ...
    dataGridView8_1.Location = point52;
    this.DataGridView8.Name = "DataGridView8";
    DataGridView dataGridView8_2 = this.DataGridView8;
    size1 = new Size(18, 19);
    Size size52 = size1;
    dataGridView8_2.Size = size52;
    ...
    point1 = new Point(436, 507);
    Point point54 = point1;
    btnPerson1.Location = point54;
    this.btnPerson.Name = "btnPerson";
    Button btnPerson2 = this.btnPerson;
    size1 = new Size(55, 26);
    Size size54 = size1;
    btnPerson2.Size = size54;
    this.btnPerson.TabIndex = 139;
    ...
    point1 = new Point(110, 509);
    Point point55 = point1;
    cmbPerson1.Location = point55;
    this.cmbPerson.Name = "cmbPerson";
    ComboBox cmbPerson2 = this.cmbPerson;
    size1 = new Size(325, 24);
    Size size55 = size1;
    cmbPerson2.Size = size55;
    this.cmbPerson.TabIndex = 138;
    ...
    point1 = new Point(495, 507);
    Point point59 = point1;
    btnDetail1.Location = point59;
    this.btnDetail.Name = "btnDetail";
    Button btnDetail2 = this.btnDetail;
    size1 = new Size(72, 26);
    Size size59 = size1;
    btnDetail2.Size = size59;
    this.btnDetail.TabIndex = 140;
    ...
    point1 = new Point(53, 64 /*0x40*/);
    Point point61 = point1;
    dataGridView6_1.Location = point61;
    this.DataGridView6.Name = "DataGridView6";
    DataGridView dataGridView6_2 = this.DataGridView6;
    size1 = new Size(18, 19);
    Size size61 = size1;
    dataGridView6_2.Size = size61;
    this.DataGridView6.TabIndex = 137;
    ...
    this.Name = nameof (frmJournalDetailDirect);
  ...
  private void frmJournalDetailDirect_KeyDown(object sender, KeyEventArgs e)
  {
  ...
  private void frmJournalDetailDirect_Load(object sender, EventArgs e)
  {
    ...
    OleDbDataAdapter oleDbDataAdapter1 = new OleDbDataAdapter($"SELECT * FROM SocTran WHERE SocTran.SocTranType='Jrnl' and SocTran.SocTranNo= {this.lblTranNo.Text} and SocTran.MainAccount='Y' order by SocTran.SocTranType,SocTran.SocTranNo asc", selectConnection);
    ...
    OleDbDataAdapter oleDbDataAdapter2 = new OleDbDataAdapter("SELECT * FROM SocTran WHERE SocTran.SocTranType='Jrnl' and SocTran.MainAccount='Y' order by SocTran.SocTranType,SocTran.SocTranNo asc", selectConnection);
