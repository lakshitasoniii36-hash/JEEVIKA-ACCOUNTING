...
// Type: MauliModule7.frmReportAccountLedgerNew
...
[DesignerGenerated]
public class frmReportAccountLedgerNew : Form
{
  ...
  [DebuggerNonUserCode]
  static frmReportAccountLedgerNew()
  {
  }

  [DebuggerNonUserCode]
  public frmReportAccountLedgerNew()
  {
    this.KeyDown += new KeyEventHandler(this.frmReportAccountLedgerNew_KeyDown);
    this.Load += new EventHandler(this.frmReportAccountLedgerNew_Load);
    frmReportAccountLedgerNew.__ENCAddToList((object) this);
  ...
  {
    lock (frmReportAccountLedgerNew.__ENCList)
    {
      if (frmReportAccountLedgerNew.__ENCList.Count == frmReportAccountLedgerNew.__ENCList.Capacity)
      {
        int index1 = 0;
        int num = checked (frmReportAccountLedgerNew.__ENCList.Count - 1);
        int index2 = 0;
        while (index2 <= num)
        {
          if (frmReportAccountLedgerNew.__ENCList[index2].IsAlive)
          {
            if (index2 != index1)
              frmReportAccountLedgerNew.__ENCList[index1] = frmReportAccountLedgerNew.__ENCList[index2];
            checked { ++index1; }
          }
          checked { ++index2; }
        }
        frmReportAccountLedgerNew.__ENCList.RemoveRange(index1, checked (frmReportAccountLedgerNew.__ENCList.Count - index1));
        frmReportAccountLedgerNew.__ENCList.Capacity = frmReportAccountLedgerNew.__ENCList.Count;
      }
      frmReportAccountLedgerNew.__ENCList.Add(new WeakReference(RuntimeHelpers.GetObjectValue(value)));
    }
  }
  ...
  {
    ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (frmReportAccountLedgerNew));
    ...
    dataGridView6_1.Location = point18;
    this.DataGridView6.Name = "DataGridView6";
    DataGridView dataGridView6_2 = this.DataGridView6;
    size1 = new Size(10, 10);
    Size size18 = size1;
    dataGridView6_2.Size = size18;
    ...
    lblDateFrom1.Location = point23;
    this.lblDateFrom.Name = "lblDateFrom";
    Label lblDateFrom2 = this.lblDateFrom;
    size1 = new Size(30, 13);
    Size size23 = size1;
    lblDateFrom2.Size = size23;
    ...
    label5_1.Location = point27;
    this.Label5.Name = "Label5";
    Label label5_2 = this.Label5;
    size1 = new Size(94, 28);
    Size size27 = size1;
    label5_2.Size = size27;
    ...
    point1 = new Point(41, 120);
    Point point50 = point1;
    txtTitle1.Location = point50;
    this.txtTitle.Name = "txtTitle";
    TextBox txtTitle2 = this.txtTitle;
    size1 = new Size(116, 20);
    Size size50 = size1;
    txtTitle2.Size = size50;
    ...
    this.Name = nameof (frmReportAccountLedgerNew);
  ...
  private void frmReportAccountLedgerNew_KeyDown(object sender, KeyEventArgs e)
  {
  ...
  private void frmReportAccountLedgerNew_Load(object sender, EventArgs e)
  {
  ...
  public DataSet GetFillGrid()
  {
    ...
    while (index3 <= num2)
    {
      ...
      if (num4 != 0.0)
      {
        ...
        this.DataGridView4.Rows[checked ((int) index6)].Cells[20].Value = (object) "";
