...
// Type: MauliModule7.frmImportPayment
...
[DesignerGenerated]
public class frmImportPayment : Form
{
  ...
  public frmImportPayment()
  {
    ...
    frmImportPayment.__ENCAddToList((object) this);
    this.vbtnaddclick = 0;
  ...
  {
    lock (frmImportPayment.__ENCList)
    {
      if (frmImportPayment.__ENCList.Count == frmImportPayment.__ENCList.Capacity)
      {
        int index1 = 0;
        int num = checked (frmImportPayment.__ENCList.Count - 1);
        int index2 = 0;
        while (index2 <= num)
        {
          if (frmImportPayment.__ENCList[index2].IsAlive)
          {
            if (index2 != index1)
              frmImportPayment.__ENCList[index1] = frmImportPayment.__ENCList[index2];
            checked { ++index1; }
          }
          checked { ++index2; }
        }
        frmImportPayment.__ENCList.RemoveRange(index1, checked (frmImportPayment.__ENCList.Count - index1));
        frmImportPayment.__ENCList.Capacity = frmImportPayment.__ENCList.Count;
      }
      frmImportPayment.__ENCList.Add(new WeakReference(RuntimeHelpers.GetObjectValue(value)));
    }
  }
  ...
  private void InitializeComponent()
  {
    ...
    ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (frmImportPayment));
    ...
    this.Name = nameof (frmImportPayment);
  ...
  private void Button1_Click(object sender, EventArgs e)
  {
    ...
    sheet.Cells[(object) 1, (object) 3] = (object) "CASH/BANK CODE/NAME (Cr.)";
  ...
  public DataSet OpenExcelFile()
  {
    object obj = (object) Missing.Value;
    Microsoft.Office.Interop.Excel.Application application = (Microsoft.Office.Interop.Excel.Application) new ApplicationClass();
    Worksheet sheet = (Worksheet) application.Workbooks.Open(Constant.socDataPath + "\\Paymentxls.xls", (object) Missing.Value, (object) false, (object) Missing.Value, (object) Missing.Value, (object) Missing.Value, (object) Missing.Value, (object) Missing.Value, (object) Missing.Value, (object) Missing.Value, (object) Missing.Value, (object) Missing.Value, (object) Missing.Value, (object) Missing.Value, (object) Missing.Value).Sheets[(object) "Sheet1"];
  ...
  private void btnAdd_Click(object sender, EventArgs e)
  {
    ...
    {
      OleDbConnection selectConnection = new OleDbConnection($"Provider=Microsoft.ACE.OLEDB.12.0;Data Source='{Constant.socDataPath}\\Paymentxls.xls';Extended Properties=Excel 8.0;");
  ...
  public DataSet VerifyData()
  {
    ...
    {
      OleDbConnection selectConnection = new OleDbConnection($"Provider=Microsoft.ACE.OLEDB.12.0;Data Source={Constant.socDataPath}{Constant.SocDataFile}");
      OleDbDataAdapter oleDbDataAdapter = new OleDbDataAdapter($"SELECT * FROM SocTran WHERE (((SocTran.SocTranType)='Pymt') AND ((SocTran.SubTranType)='{this.cmbSubTranType.Text.Trim()}') AND ((SocTran.MainAccount)='Y')) ORDER BY SocTran.SocTranNo", selectConnection);
      ...
      while (num5 <= num4)
      {
        ...
        if (num6 > 1)
        {
          int num8 = (int) Interaction.MsgBox((object) "Duplicate Payment No.", Title: (object) Constant.SIMsgInfo);
      ...
      while (num10 <= num9)
      {
        ...
        if (num11 > 0)
        {
          int num13 = (int) Interaction.MsgBox((object) "Duplicate Payment No.", Title: (object) Constant.SIMsgInfo);
          this.DataGridView4.Focus();
...
label_82:
  ...
  private void btnUpdate_Click(object sender, EventArgs e)
  {
    ...
    OleDbDataAdapter oleDbDataAdapter = new OleDbDataAdapter("SELECT * FROM SocTranType WHERE (SocTranType.Main_Abr= 'Pymt' ) order by Sub_Abr asc", oleDbConnection);
    ...
    else
    {
      ...
      while (index2 <= num4)
      {
        ...
        while (num8 <= 4);
        OleDbCommand oleDbCommand1 = new OleDbCommand($"Insert Into SocTran (SocTranClass, SocAccountMainId, SocSubGroupId, SocGroupId, GrpMainId, SocTranType, SocTranNo, SocTranDate, SocTranInt, SocTranPrin, SocTranAmount, ChqNo, ChqDt, BankName, PartyName, AccPart, AccPart1, AccPart2, AccName , SocTranAmountR, SubTranType, SubTranNo, MainAccount) values (1,'{integer1.ToString().Trim()}','{integer3.ToString().Trim()}','{integer4.ToString().Trim()}','{integer5.ToString().Trim()}','Pymt','{Conversions.ToString(Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView4.Rows[index2].Cells[0].Value)))}','{this.DataGridView4.Rows[index2].Cells[1].Value.ToString().Substring(0, 10)}','0','0','{Conversions.ToString(Math.Round(-Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView4.Rows[index2].Cells[10].Value)), 2))}','{this.DataGridView4.Rows[index2].Cells[4].Value.ToString()}','{this.DataGridView4.Rows[index2].Cells[5].Value.ToString()}','{this.DataGridView4.Rows[index2].Cells[6].Value.ToString()}','{this.DataGridView4.Rows[index2].Cells[7].Value.ToString()}','{this.DataGridView4.Rows[index2].Cells[8].Value.ToString()}','{this.DataGridView4.Rows[index2].Cells[9].Value.ToString()}','','{this.DataGridView4.Rows[index2].Cells[3].Value.ToString()}','{Conversions.ToString(Math.Round(Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView4.Rows[index2].Cells[10].Value)), 2))}','{this.cmbSubTranType.Text}','{Conversions.ToString(Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView4.Rows[index2].Cells[0].Value)))}','Y')", oleDbConnection);
        oleDbConnection.Open();
        oleDbCommand1.ExecuteNonQuery();
        oleDbConnection.Close();
        OleDbCommand oleDbCommand2 = new OleDbCommand($"update SocAccount set Cl_Bal = Cl_Bal - {Conversions.ToString(Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView4.Rows[index2].Cells[10].Value)))}, Tr_Db = Tr_Db + {Conversions.ToString(Math.Abs(Conversion.Val(num7.ToString().Trim())))}, Tr_Cr = Tr_Cr + {Conversions.ToString(Conversion.Val(num6.ToString().Trim()))} where SocAccountMainId ={integer1.ToString().Trim()}", oleDbConnection);
        oleDbConnection.Open();
        ...
        do
        {
          if (Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView4.Rows[index2].Cells[checked (13 + 3 * num9)].Value)) != 0.0)
          {
            ...
            OleDbCommand oleDbCommand3 = new OleDbCommand($"Insert Into SocTran (SocTranClass, SocAccountMainId, SocSubGroupId, SocGroupId, GrpMainId, SocTranType, SocTranNo, SocTranDate, SocTranInt, SocTranPrin, SocTranAmount, ChqNo, ChqDt, BankName, PartyName, AccPart, AccPart1, AccPart2, AccName , SocTranAmountR, SubTranType, SubTranNo, MainAccount ) values (1,'{integer1.ToString().Trim()}','{integer3.ToString().Trim()}','{integer4.ToString().Trim()}','{integer5.ToString().Trim()}','Pymt','{Conversions.ToString(Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView4.Rows[index2].Cells[0].Value)))}','{this.DataGridView4.Rows[index2].Cells[1].Value.ToString().Substring(0, 10)}','0','0','{Conversions.ToString(Math.Round(Conversion.Val(num10.ToString().Trim()) - Conversion.Val(num11.ToString().Trim()), 2))}','{this.DataGridView4.Rows[index2].Cells[4].Value.ToString()}','{this.DataGridView4.Rows[index2].Cells[5].Value.ToString()}','{this.DataGridView4.Rows[index2].Cells[6].Value.ToString()}','{this.DataGridView4.Rows[index2].Cells[7].Value.ToString()}','{this.DataGridView4.Rows[index2].Cells[8].Value.ToString()}','{this.DataGridView4.Rows[index2].Cells[9].Value.ToString()}','','{this.DataGridView4.Rows[index2].Cells[checked (12 + 3 * num9)].Value.ToString()}','{Conversions.ToString(Math.Round(Conversion.Val(num11.ToString().Trim()) - Conversion.Val(num10.ToString().Trim()), 2))}','{this.cmbSubTranType.Text}','{Conversions.ToString(Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView4.Rows[index2].Cells[0].Value)))}','N')", oleDbConnection);
            oleDbConnection.Open();
            oleDbCommand3.ExecuteNonQuery();
            oleDbConnection.Close();
            OleDbCommand oleDbCommand4 = new OleDbCommand($"update SocAccount set Cl_Bal = Cl_Bal + {Conversions.ToString(Conversion.Val(num10.ToString().Trim()) - Conversion.Val(num11.ToString().Trim()))}, Tr_Db = Tr_Db + {Conversions.ToString(Conversion.Val(num10.ToString().Trim()))}, Tr_Cr = Tr_Cr + {Conversions.ToString(Conversion.Val(num10.ToString().Trim()))} where SocAccountMainId ={integer1.ToString().Trim()}", oleDbConnection);
            oleDbConnection.Open();
            oleDbCommand4.ExecuteNonQuery();
            oleDbConnection.Close();
            OleDbCommand oleDbCommand5 = new OleDbCommand($"Insert Into SocCashBook (ledgerIndex, DateIndex, TranTypeIndex, TranNoIndex, LineNo, NarrationYN, Tran_Date, Tran_Type, Tran_No, Tran_AccCode, Tran_Particular, Tran_ChqNo, Amount_Debit, Amount_Credit,  Tran_Narration1, Tran_Narration2, Tran_Narration3, SubTranType, SubTranNo) values ('{integer2.ToString().Trim()} ','{this.DataGridView4.Rows[index2].Cells[1].Value.ToString().Substring(0, 10)}','4','{Conversions.ToString(Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView4.Rows[index2].Cells[0].Value)))}','{Conversions.ToString(Conversion.Val((object) Expression))}','N','{this.DataGridView4.Rows[index2].Cells[1].Value.ToString().Substring(0, 10)}','Pymt','{Conversions.ToString(Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView4.Rows[index2].Cells[0].Value)))}','{this.DataGridView4.Rows[index2].Cells[checked (11 + 3 * num9)].Value.ToString()}','{this.DataGridView4.Rows[index2].Cells[checked (12 + 3 * num9)].Value.ToString()}','{this.DataGridView4.Rows[index2].Cells[4].Value.ToString()}','{Conversions.ToString(Math.Round(Conversion.Val(num11.ToString().Trim()), 2))}','{Conversions.ToString(Math.Round(Conversion.Val(num10.ToString().Trim()), 2))}','{str1}','{str2}','{this.DataGridView4.Rows[index2].Cells[7].Value.ToString()}','{this.cmbSubTranType.Text}','{Conversions.ToString(Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView4.Rows[index2].Cells[0].Value)))}')", oleDbConnection);
            oleDbConnection.Open();
            oleDbCommand5.ExecuteNonQuery();
            oleDbConnection.Close();
            OleDbCommand oleDbCommand6 = new OleDbCommand($"Insert Into SocCashBook (ledgerIndex, DateIndex, TranTypeIndex, TranNoIndex, LineNo, NarrationYN, Tran_Date, Tran_Type, Tran_No, Tran_AccCode, Tran_Particular, Tran_ChqNo, Amount_Debit, Amount_Credit,  Tran_Narration1, Tran_Narration2, Tran_Narration3, SubTranType, SubTranNo) values ('{integer1.ToString().Trim()} ','{this.DataGridView4.Rows[index2].Cells[1].Value.ToString().Substring(0, 10)}','4','{Conversions.ToString(Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView4.Rows[index2].Cells[0].Value)))}','{Conversions.ToString(Conversion.Val((object) Expression))}','N','{this.DataGridView4.Rows[index2].Cells[1].Value.ToString().Substring(0, 10)}','Pymt','{Conversions.ToString(Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView4.Rows[index2].Cells[0].Value)))}','{this.DataGridView4.Rows[index2].Cells[2].Value.ToString()}','{this.DataGridView4.Rows[index2].Cells[3].Value.ToString()}','{this.DataGridView4.Rows[index2].Cells[4].Value.ToString()}','{Conversions.ToString(Math.Round(Conversion.Val(num10.ToString().Trim()), 2))}','{Conversions.ToString(Math.Round(Conversion.Val(num11.ToString().Trim()), 2))}','{str1}','{str2}','{this.DataGridView4.Rows[index2].Cells[7].Value.ToString()}','{this.cmbSubTranType.Text}','{Conversions.ToString(Conversion.Val(RuntimeHelpers.GetObjectValue(this.DataGridView4.Rows[index2].Cells[0].Value)))}')", oleDbConnection);
            oleDbConnection.Open();
  ...
  private void frmImportPayment_Load(object sender, EventArgs e)
  {
    ...
    this.vbtnaddclick = 0;
    OleDbConnection selectConnection = new OleDbConnection($"Provider=Microsoft.ACE.OLEDB.12.0;Data Source={Constant.socDataPath}{Constant.SocDataFile}");
    OleDbDataAdapter oleDbDataAdapter1 = new OleDbDataAdapter("SELECT * FROM SocTranType WHERE (SocTranType.Main_Abr= 'Pymt' ) order by Sub_Abr asc", selectConnection);
    ...
    OleDbDataAdapter oleDbDataAdapter2 = new OleDbDataAdapter($"SELECT * FROM SocTran WHERE SocTran.SocTranType='Pymt' and SubTranType='{this.cmbSubTranType.Text}' and SocTran.MainAccount='Y' order by SocTran.SocTranNo asc", selectConnection);
  ...
  {
    OleDbDataAdapter oleDbDataAdapter = new OleDbDataAdapter($"SELECT * FROM SocTran WHERE SocTran.SocTranType='Pymt' and SubTranType='{this.cmbSubTranType.Text}' and SocTran.MainAccount='Y' order by SocTran.SocTranNo asc", new OleDbConnection($"Provider=Microsoft.ACE.OLEDB.12.0;Data Source={Constant.socDataPath}{Constant.SocDataFile}"));
    System.Data.DataTable dataTable = new System.Data.DataTable("SocTran");
    oleDbDataAdapter.Fill(dataTable);
