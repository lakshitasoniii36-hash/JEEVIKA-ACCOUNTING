...
internal static class ZipOutput
{
    ...
    ZipContainer container)
  {
    ...
    else
    {
      ...
      int index13 = num18;
      int num20 = index13 + 1;
      int num21 = (int) (byte) ((num15 & 16711680L /*0xFF0000*/) >> 16 /*0x10*/);
      numArray12[index13] = (byte) num21;
      byte[] numArray13 = destinationArray;
      int index14 = num20;
      int num22 = index14 + 1;
      int num23 = (int) (byte) ((num15 & 4278190080L /*0xFF000000*/) >> 24);
      ...
      int index17 = num26;
      int num28 = index17 + 1;
      int num29 = (int) (byte) ((StartOfCentralDirectory & 16711680L /*0xFF0000*/) >> 16 /*0x10*/);
      numArray16[index17] = (byte) num29;
      byte[] numArray17 = destinationArray;
      int index18 = num28;
      num7 = index18 + 1;
      int num30 = (int) (byte) ((StartOfCentralDirectory & 4278190080L /*0xFF000000*/) >> 24);
