...
public class ZipEntry
{
  ...
  internal void VerifyCrcAfterExtract(int actualCrc32)
  {
    if (actualCrc32 != this._Crc32 && (this.Encryption != EncryptionAlgorithm.WinZipAes128 && this.Encryption != EncryptionAlgorithm.WinZipAes256 || this._WinZipAesMethod != (short) 2))
      throw new BadCrcException("CRC error: the file being extracted appears to be corrupted. " + $"Expected 0x{this._Crc32:X8}, Actual 0x{actualCrc32:X8}");
...
label_8:
    ...
    get
    {
      ...
      switch (this._UnsupportedAlgorithmId)
      {
        ...
        case 26625:
          ...
          break;
        default:
          unsupportedAlgorithm = $"Unknown (0x{this._UnsupportedAlgorithmId:X4})";
          break;
      }
    ...
    get
    {
      ...
      switch (this._CompressionMethod)
      {
        ...
        case 98:
          ...
          break;
        default:
          compressionMethod = $"Unknown (0x{this._CompressionMethod:X4})";
          break;
      }
  ...
  internal void ValidateEncryption()
  {
    ...
    if (this._UnsupportedAlgorithmId != 0U)
      throw new ZipException($"Cannot extract: Entry {this.FileName} is encrypted with an algorithm not supported by DotNetZip: {this.UnsupportedAlgorithm}");
    throw new ZipException($"Cannot extract: Entry {this.FileName} uses an unsupported encryption algorithm ({(int) this.Encryption:X2})");
  }
  ...
  private void ValidateCompression()
  {
    if (this._CompressionMethod_FromZipFile != (short) 0 && this._CompressionMethod_FromZipFile != (short) 8 && this._CompressionMethod_FromZipFile != (short) 12)
      throw new ZipException($"Entry {this.FileName} uses an unsupported compression method (0x{this._CompressionMethod_FromZipFile:X2}, {this.UnsupportedCompressionMethod})");
  }
  ...
  private int ProcessExtraFieldZip64(byte[] buffer, int j, short dataSize, long posn)
  {
    ...
    int remainingData = dataSize <= (short) 28 ? (int) dataSize : throw new BadReadException($"  Inconsistent size (0x{dataSize:X4}) for ZIP64 extra field at position 0x{posn:X16}");
  ...
  {
    int remainingData = dataSize == (short) 13 || dataSize == (short) 9 || dataSize == (short) 5 ? (int) dataSize : throw new BadReadException($"  Unexpected size (0x{dataSize:X4}) for Extended Timestamp extra field at position 0x{posn:X16}");
  ...
  internal void WriteCentralDirectoryEntry(Stream s)
  {
    ...
    if (count + num63 > numArray1.Length)
      count = numArray1.Length - num63;
    byte[] numArray36 = numArray1;
    int index36 = num63;
    int num65 = index36 + 1;
    int num66 = (int) (byte) (count & (int) byte.MaxValue);
    numArray36[index36] = (byte) num66;
    byte[] numArray37 = numArray1;
    int index37 = num65;
    int num67 = index37 + 1;
    int num68 = (int) (byte) ((count & 65280) >> 8);
    numArray37[index37] = (byte) num68;
    int num69;
    if (this._container.ZipFile != null && this._container.ZipFile.MaxOutputSegmentSize != 0)
    {
      ...
      int index38 = num67;
      int num70 = index38 + 1;
      int num71 = (int) (byte) (this._diskNumber & (uint) byte.MaxValue);
      numArray38[index38] = (byte) num71;
      byte[] numArray39 = numArray1;
      int index39 = num70;
      num69 = index39 + 1;
      int num72 = (int) (byte) ((this._diskNumber & 65280U) >> 8);
      numArray39[index39] = (byte) num72;
    }
    else
    {
    ...
    int index42 = num69;
    int num74 = index42 + 1;
    int num75 = this._IsText ? 1 : 0;
    numArray42[index42] = (byte) num75;
    ...
    int index44 = num76;
    int num77 = index44 + 1;
    int num78 = (int) (byte) (this._ExternalFileAttrs & (int) byte.MaxValue);
    numArray44[index44] = (byte) num78;
    byte[] numArray45 = numArray1;
    int index45 = num77;
    int num79 = index45 + 1;
    int num80 = (int) (byte) ((this._ExternalFileAttrs & 65280) >> 8);
    numArray45[index45] = (byte) num80;
    byte[] numArray46 = numArray1;
    int index46 = num79;
    int num81 = index46 + 1;
    int num82 = (int) (byte) ((this._ExternalFileAttrs & 16711680 /*0xFF0000*/) >> 16 /*0x10*/);
    numArray46[index46] = (byte) num82;
    byte[] numArray47 = numArray1;
    int index47 = num81;
    int num83 = index47 + 1;
    int num84 = (int) (byte) (((long) this._ExternalFileAttrs & 4278190080L /*0xFF000000*/) >> 24);
    numArray47[index47] = (byte) num84;
    int dstOffset;
    if (this._RelativeOffsetOfLocalHeader > (long) uint.MaxValue)
    {
    ...
    else
    {
      ...
      int index52 = num83;
      int num88 = index52 + 1;
      int num89 = (int) (byte) ((ulong) this._RelativeOffsetOfLocalHeader & (ulong) byte.MaxValue);
      numArray52[index52] = (byte) num89;
      byte[] numArray53 = numArray1;
      int index53 = num88;
      int num90 = index53 + 1;
      int num91 = (int) (byte) ((this._RelativeOffsetOfLocalHeader & 65280L) >> 8);
      numArray53[index53] = (byte) num91;
      byte[] numArray54 = numArray1;
      int index54 = num90;
      int num92 = index54 + 1;
      int num93 = (int) (byte) ((this._RelativeOffsetOfLocalHeader & 16711680L /*0xFF0000*/) >> 16 /*0x10*/);
      numArray54[index54] = (byte) num93;
      byte[] numArray55 = numArray1;
      int index55 = num92;
      dstOffset = index55 + 1;
      int num94 = (int) (byte) ((this._RelativeOffsetOfLocalHeader & 4278190080L /*0xFF000000*/) >> 24);
      numArray55[index55] = (byte) num94;
    }
    Buffer.BlockCopy((Array) encodedFileNameBytes, 0, (Array) numArray1, dstOffset, (int) length1);
    int num95 = dstOffset + (int) length1;
    if (this._Extra != null)
    {
      Buffer.BlockCopy((Array) this._Extra, 0, (Array) numArray1, num95, (int) length2);
      num95 += (int) length2;
    }
    if (count != 0)
    {
      Buffer.BlockCopy((Array) this._CommentBytes, 0, (Array) numArray1, num95, count);
      num95 += count;
    }
    s.Write(numArray1, 0, num95);
  }
  ...
  internal void PostProcessOutput(Stream s)
  {
    ...
    if (this.Encryption == EncryptionAlgorithm.WinZipAes128 || this.Encryption == EncryptionAlgorithm.WinZipAes256)
    {
      ...
      do
      {
        ushort num47 = (ushort) ((uint) this._EntryHeader[index26] + (uint) this._EntryHeader[index26 + 1] * 256U /*0x0100*/);
        short num48 = (short) ((int) this._EntryHeader[index26 + 2] + (int) this._EntryHeader[index26 + 3] * 256 /*0x0100*/);
        if (num47 != (ushort) 39169)
        {
          index26 += (int) num48 + 4;
        }
        else
