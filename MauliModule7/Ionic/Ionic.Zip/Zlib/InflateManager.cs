      ...
      switch (this.mode)
      {
        ...
        case InflateManager.InflateManagerMode.FLAG:
          if (this._codec.AvailableBytesIn != 0)
          {
            ...
            if (((this.method << 8) + num2) % 31 /*0x1F*/ != 0)
            {
              this.mode = InflateManager.InflateManagerMode.BAD;
            ...
            this.mode = (num2 & 32 /*0x20*/) == 0 ? InflateManager.InflateManagerMode.BLOCKS : InflateManager.InflateManagerMode.DICT4;
            continue;
          }
          goto label_12;
        case InflateManager.InflateManagerMode.DICT4:
          if (this._codec.AvailableBytesIn != 0)
          {
            ...
            --this._codec.AvailableBytesIn;
            ++this._codec.TotalBytesIn;
            this.expectedCheck = (uint) ((ulong) ((int) this._codec.InputBuffer[this._codec.NextIn++] << 24) & 4278190080UL /*0xFF000000*/);
        ...
        case InflateManager.InflateManagerMode.DICT3:
          if (this._codec.AvailableBytesIn != 0)
          {
            ...
            --this._codec.AvailableBytesIn;
            ++this._codec.TotalBytesIn;
            this.expectedCheck += (uint) ((int) this._codec.InputBuffer[this._codec.NextIn++] << 16 /*0x10*/ & 16711680 /*0xFF0000*/);
