...
internal sealed class DeflateManager
{
  ...
  private static readonly int PRESET_DICT = 32 /*0x20*/;
  ...
  private static readonly int Buf_size = 16 /*0x10*/;
  ...
  private static readonly int END_BLOCK = 256 /*0x0100*/;
  ...
  internal bool _tr_tally(int dist, int lc)
  {
    ...
    if ((this.last_lit & 8191 /*0x1FFF*/) == 0 && this.compressionLevel > CompressionLevel.Level2)
    {
      ...
      do
      {
        ...
        if (cur_match != 0 && this.prev_length < this.config.MaxLazy && (this.strstart - cur_match & (int) ushort.MaxValue) <= this.w_size - DeflateManager.MIN_LOOKAHEAD)
        {
          if (this.compressionStrategy != CompressionStrategy.HuffmanOnly)
            this.match_length = this.longest_match(cur_match);
          if (this.match_length <= 5 && (this.compressionStrategy == CompressionStrategy.Filtered || this.match_length == DeflateManager.MIN_MATCH && this.strstart - this.match_start > 4096 /*0x1000*/))
            this.match_length = DeflateManager.MIN_MATCH - 1;
        }
...
label_26:
  ...
  internal int Deflate(FlushType flush)
  {
    ...
    if (this.status == DeflateManager.INIT_STATE)
    {
      ...
      int num2 = (int) (this.compressionLevel - 1 & (CompressionLevel) 255 /*0xFF*/) >> 1;
      if (num2 > 3)
        num2 = 3;
      int num3 = num1 | num2 << 6;
      if (this.strstart != 0)
        num3 |= DeflateManager.PRESET_DICT;
      int num4 = num3 + (31 /*0x1F*/ - num3 % 31 /*0x1F*/);
      this.status = DeflateManager.BUSY_STATE;
      this.pending[this.pendingCount++] = (byte) (num4 >> 8);
      this.pending[this.pendingCount++] = (byte) num4;
      if (this.strstart != 0)
      {
        this.pending[this.pendingCount++] = (byte) ((this._codec._Adler32 & 4278190080U /*0xFF000000*/) >> 24);
        this.pending[this.pendingCount++] = (byte) ((this._codec._Adler32 & 16711680U /*0xFF0000*/) >> 16 /*0x10*/);
  ...
  internal class Config
  {
    ...
    private static readonly DeflateManager.Config[] Table = new DeflateManager.Config[10]
    {
      ...
      new DeflateManager.Config(4, 5, 16 /*0x10*/, 8, DeflateFlavor.Fast),
      new DeflateManager.Config(4, 6, 32 /*0x20*/, 32 /*0x20*/, DeflateFlavor.Fast),
      new DeflateManager.Config(4, 4, 16 /*0x10*/, 16 /*0x10*/, DeflateFlavor.Slow),
      new DeflateManager.Config(8, 16 /*0x10*/, 32 /*0x20*/, 32 /*0x20*/, DeflateFlavor.Slow),
      new DeflateManager.Config(8, 16 /*0x10*/, 128 /*0x80*/, 128 /*0x80*/, DeflateFlavor.Slow),
      new DeflateManager.Config(8, 32 /*0x20*/, 128 /*0x80*/, 256 /*0x0100*/, DeflateFlavor.Slow),
      new DeflateManager.Config(32 /*0x20*/, 128 /*0x80*/, 258, 1024 /*0x0400*/, DeflateFlavor.Slow),
      new DeflateManager.Config(32 /*0x20*/, 258, 258, 4096 /*0x1000*/, DeflateFlavor.Slow)
    };
