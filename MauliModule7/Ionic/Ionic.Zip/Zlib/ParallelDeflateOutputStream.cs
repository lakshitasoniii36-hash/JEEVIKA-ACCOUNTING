...
{
  private static readonly int IO_BUFFER_SIZE_DEFAULT = 65536 /*0x010000*/;
  ...
  public int BufferSize
  {
    ...
    set
    {
      this._bufferSize = value >= 1024 /*0x0400*/ ? value : throw new ArgumentOutOfRangeException(nameof (BufferSize), "BufferSize must be greater than 1024 bytes");
    }
  }
