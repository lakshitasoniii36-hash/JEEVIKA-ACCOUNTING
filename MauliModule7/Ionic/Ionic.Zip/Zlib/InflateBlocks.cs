...
label_37:;
      ...
      int num12;
      this.table = num12 = num1 & 16383 /*0x3FFF*/;
      if ((num12 & 31 /*0x1F*/) <= 29 && (num12 >> 5 & 31 /*0x1F*/) <= 29)
      {
        int length2 = 258 + (num12 & 31 /*0x1F*/) + (num12 >> 5 & 31 /*0x1F*/);
...
label_49:;
      ...
      while (true)
      {
        ...
        if (this.index < 258 + (table1 & 31 /*0x1F*/) + (table1 >> 5 & 31 /*0x1F*/))
        {
          ...
          if (index3 + num16 <= 258 + (table2 & 31 /*0x1F*/) + (table2 >> 5 & 31 /*0x1F*/) && (huft2 != 16 /*0x10*/ || index3 >= 1))
          {
...
label_57:;
      ...
      num5 = this.inftree.inflate_trees_dynamic(257 + (table & 31 /*0x1F*/), 1 + (table >> 5 & 31 /*0x1F*/), this.blens, bl2, bd2, tl2, td2, this.hufts, this._codec);
      switch (num5)
      {
        case -3:
          goto label_76;
...
label_84:
    ...
    r = this.Flush(r);
    destinationIndex = this.writeAt;
    int num17 = destinationIndex < this.readAt ? this.readAt - destinationIndex - 1 : this.end - destinationIndex;
