    ...
    for (int startIndex = 0; startIndex < strArray.Length; ++startIndex)
    {
      ...
      switch (lower)
      {
        ...
        case "size":
          ...
          long num2 = !str1.ToUpper().EndsWith("K") ? (!str1.ToUpper().EndsWith("KB") ? (!str1.ToUpper().EndsWith("M") ? (!str1.ToUpper().EndsWith("MB") ? (!str1.ToUpper().EndsWith("G") ? (!str1.ToUpper().EndsWith("GB") ? long.Parse(strArray[startIndex + 2]) : long.Parse(str1.Substring(0, str1.Length - 2)) * 1024L /*0x0400*/ * 1024L /*0x0400*/ * 1024L /*0x0400*/) : long.Parse(str1.Substring(0, str1.Length - 1)) * 1024L /*0x0400*/ * 1024L /*0x0400*/ * 1024L /*0x0400*/) : long.Parse(str1.Substring(0, str1.Length - 2)) * 1024L /*0x0400*/ * 1024L /*0x0400*/) : long.Parse(str1.Substring(0, str1.Length - 1)) * 1024L /*0x0400*/ * 1024L /*0x0400*/) : long.Parse(str1.Substring(0, str1.Length - 2)) * 1024L /*0x0400*/) : long.Parse(str1.Substring(0, str1.Length - 1)) * 1024L /*0x0400*/;
