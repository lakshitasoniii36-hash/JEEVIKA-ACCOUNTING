...
public interface WorkflowTemplates : _IMsoDispObj, IEnumerable
{
  ...
  [DispId(0)]
  WorkflowTemplate this[[In] int Index] { [DispId(0), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
