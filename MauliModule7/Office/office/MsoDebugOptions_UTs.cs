...
public interface MsoDebugOptions_UTs : _IMsoDispObj, IEnumerable
{
  ...
  [DispId(0)]
  MsoDebugOptions_UT this[[In] int Index] { [DispId(0), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
  ...
  MsoDebugOptions_UTs GetUnitTestsInCollection([MarshalAs(UnmanagedType.BStr), In] string bstrCollectionName);

  [DispId(3)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.Interface)]
  MsoDebugOptions_UT GetUnitTest([MarshalAs(UnmanagedType.BStr), In] string bstrCollectionName, [MarshalAs(UnmanagedType.BStr), In] string bstrUnitTestName);

  [DispId(4)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.Interface)]
  MsoDebugOptions_UTs GetMatchingUnitTestsInCollection(
    [MarshalAs(UnmanagedType.BStr), In] string bstrCollectionName,
    [MarshalAs(UnmanagedType.BStr), In] string bstrUnitTestNameFilter);
}
