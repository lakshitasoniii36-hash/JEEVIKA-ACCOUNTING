...
public interface MetaProperties : _IMsoDispObj, IEnumerable
{
  ...
  [DispId(0)]
  MetaProperty this[[MarshalAs(UnmanagedType.Struct), In] object Index] { [DispId(0), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }

  [DispId(1)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.Interface)]
  MetaProperty GetItemByInternalName([MarshalAs(UnmanagedType.BStr), In] string InternalName);
  ...
  [DispId(4)]
  string ValidationError { [TypeLibFunc(64 /*0x40*/), DispId(4), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.BStr)] get; }
  ...
  [DispId(6)]
  string SchemaXml { [DispId(6), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.BStr)] get; }
