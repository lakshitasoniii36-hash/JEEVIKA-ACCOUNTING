...
// Type: Microsoft.Office.Core._CustomXMLParts
...
public interface _CustomXMLParts : _IMsoDispObj, IEnumerable
{
  ...
  [DispId(0)]
  CustomXMLPart this[[MarshalAs(UnmanagedType.Struct), In] object Index] { [DispId(0), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }

  [DispId(1610809347 /*0x60030003*/)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.Interface)]
  CustomXMLPart Add([MarshalAs(UnmanagedType.BStr), In] string XML = "", [MarshalAs(UnmanagedType.Struct), In, Optional] object SchemaCollection);

  [DispId(1610809348 /*0x60030004*/)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.Interface)]
  CustomXMLPart SelectByID([MarshalAs(UnmanagedType.BStr), In] string Id);

  [DispId(1610809349 /*0x60030005*/)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.Interface)]
  CustomXMLParts SelectByNamespace([MarshalAs(UnmanagedType.BStr), In] string NamespaceURI);
