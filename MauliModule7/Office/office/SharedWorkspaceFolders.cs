...
public interface SharedWorkspaceFolders : _IMsoDispObj, IEnumerable
{
  ...
  [DispId(0)]
  SharedWorkspaceFolder this[[In] int Index] { [DispId(0), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
  ...
  SharedWorkspaceFolder Add([MarshalAs(UnmanagedType.BStr), In] string FolderName, [MarshalAs(UnmanagedType.Struct), In, Optional] object ParentFolder);
