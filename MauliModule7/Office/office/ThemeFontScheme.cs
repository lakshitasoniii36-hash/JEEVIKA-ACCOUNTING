...
public interface ThemeFontScheme : _IMsoDispObj
{
  ...
  void Load([MarshalAs(UnmanagedType.BStr), In] string FileName);

  [DispId(3)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  void Save([MarshalAs(UnmanagedType.BStr), In] string FileName);

  [DispId(4)]
  ThemeFonts MinorFont { [DispId(4), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }

  [DispId(5)]
  ThemeFonts MajorFont { [DispId(5), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
}
