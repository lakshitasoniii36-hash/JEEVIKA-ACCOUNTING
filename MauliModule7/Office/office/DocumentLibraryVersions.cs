...
public interface DocumentLibraryVersions : _IMsoDispObj, IEnumerable
{
  ...
  [DispId(0)]
  DocumentLibraryVersion this[[In] int lIndex] { [DispId(0), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
  ...
  [DispId(3)]
  bool IsVersioningEnabled { [DispId(3), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }
