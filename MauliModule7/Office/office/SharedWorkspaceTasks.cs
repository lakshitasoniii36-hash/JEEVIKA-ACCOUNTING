...
public interface SharedWorkspaceTasks : _IMsoDispObj, IEnumerable
{
  ...
  [DispId(0)]
  SharedWorkspaceTask this[[In] int Index] { [DispId(0), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
  ...
  SharedWorkspaceTask Add(
    ...
    [MarshalAs(UnmanagedType.Struct), In, Optional] object Status,
    [MarshalAs(UnmanagedType.Struct), In, Optional] object Priority,
    [MarshalAs(UnmanagedType.Struct), In, Optional] object Assignee,
    [MarshalAs(UnmanagedType.Struct), In, Optional] object Description,
    [MarshalAs(UnmanagedType.Struct), In, Optional] object DueDate);
  ...
  [DispId(4)]
  bool ItemCountExceeded { [DispId(4), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }
