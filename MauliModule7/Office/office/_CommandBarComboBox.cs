...
// Type: Microsoft.Office.Core._CommandBarComboBox
...
public interface _CommandBarComboBox : CommandBarControl
{
  ...
  new object Control { [TypeLibFunc(64 /*0x40*/), DispId(1610874885 /*0x60040005*/), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.IDispatch)] get; }
  ...
  int DropDownLines { [DispId(1610940418 /*0x60050002*/), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; [DispId(1610940418 /*0x60050002*/), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: In] set; }

  [DispId(1610940420 /*0x60050004*/)]
  int DropDownWidth { [DispId(1610940420 /*0x60050004*/), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; [DispId(1610940420 /*0x60050004*/), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: In] set; }

  [DispId(1610940422 /*0x60050006*/)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.BStr)]
  string get_List([In] int Index);

  [DispId(1610940422 /*0x60050006*/)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  void set_List([In] int Index, [MarshalAs(UnmanagedType.BStr), In] string pbstrItem);

  [DispId(1610940424 /*0x60050008*/)]
  int ListCount { [DispId(1610940424 /*0x60050008*/), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }

  [DispId(1610940425 /*0x60050009*/)]
  int ListHeaderCount { [DispId(1610940425 /*0x60050009*/), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; [DispId(1610940425 /*0x60050009*/), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: In] set; }

  [DispId(1610940427 /*0x6005000B*/)]
  int ListIndex { [DispId(1610940427 /*0x6005000B*/), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; [DispId(1610940427 /*0x6005000B*/), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: In] set; }
  ...
  MsoComboStyle Style { [DispId(1610940430 /*0x6005000E*/), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; [DispId(1610940430 /*0x6005000E*/), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: In] set; }

  [DispId(1610940432 /*0x60050010*/)]
  string Text { [DispId(1610940432 /*0x60050010*/), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.BStr)] get; [DispId(1610940432 /*0x60050010*/), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: MarshalAs(UnmanagedType.BStr), In] set; }
}
