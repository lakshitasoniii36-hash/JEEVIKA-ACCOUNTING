...
public interface SharedWorkspaceFiles : _IMsoDispObj, IEnumerable
{
  ...
  [DispId(0)]
  SharedWorkspaceFile this[[In] int Index] { [DispId(0), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
  ...
  SharedWorkspaceFile Add(
    ...
    [MarshalAs(UnmanagedType.Struct), In, Optional] object ParentFolder,
    [MarshalAs(UnmanagedType.Struct), In, Optional] object OverwriteIfFileAlreadyExists,
    [MarshalAs(UnmanagedType.Struct), In, Optional] object KeepInSync);
