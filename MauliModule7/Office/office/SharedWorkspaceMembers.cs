...
public interface SharedWorkspaceMembers : _IMsoDispObj, IEnumerable
{
  ...
  [DispId(0)]
  SharedWorkspaceMember this[[In] int Index] { [DispId(0), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
  ...
  SharedWorkspaceMember Add([MarshalAs(UnmanagedType.BStr), In] string Email, [MarshalAs(UnmanagedType.BStr), In] string DomainName, [MarshalAs(UnmanagedType.BStr), In] string DisplayName, [MarshalAs(UnmanagedType.Struct), In, Optional] object Role);
