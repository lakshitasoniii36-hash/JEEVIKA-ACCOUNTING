...
public interface CustomXMLValidationErrors : _IMsoDispObj, IEnumerable
{
  ...
  [DispId(0)]
  CustomXMLValidationError this[[In] int Index] { [DispId(0), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }

  [DispId(1610809347 /*0x60030003*/)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  void Add([MarshalAs(UnmanagedType.Interface), In] CustomXMLNode Node, [MarshalAs(UnmanagedType.BStr), In] string ErrorName, [MarshalAs(UnmanagedType.BStr), In] string ErrorText = "", [In] bool ClearedOnUpdate = true);
