...
public interface TabStops2 : _IMsoDispObj, IEnumerable
{
  ...
  TabStop2 Item([MarshalAs(UnmanagedType.Struct), In] object Index);
  ...
  [DispId(4)]
  float DefaultSpacing { [DispId(4), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; [DispId(4), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: In] set; }
