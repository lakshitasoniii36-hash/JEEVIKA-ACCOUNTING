...
public interface WebPageFonts : _IMsoDispObj, IEnumerable
{
  ...
  [DispId(0)]
  WebPageFont this[[In] MsoCharacterSet Index] { [DispId(0), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
