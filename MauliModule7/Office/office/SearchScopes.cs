...
public interface SearchScopes : _IMsoDispObj, IEnumerable
{
  ...
  [DispId(0)]
  SearchScope this[[In] int Index] { [DispId(0), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
