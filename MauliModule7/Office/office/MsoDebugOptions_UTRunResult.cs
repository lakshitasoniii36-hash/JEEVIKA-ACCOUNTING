...
// Type: Microsoft.Office.Core.MsoDebugOptions_UTRunResult
...
public interface MsoDebugOptions_UTRunResult : _IMsoDispObj
{
  ...
  [DispId(0)]
  bool Passed { [DispId(0), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }

  [DispId(1)]
  string ErrorString { [DispId(1), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.BStr)] get; }
}
