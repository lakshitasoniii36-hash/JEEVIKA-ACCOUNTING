...
public interface MsoDebugOptions_UT : _IMsoDispObj
{
  ...
  [DispId(1)]
  string CollectionName { [DispId(1), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.BStr)] get; }
