...
public interface HTMLProject : _IMsoDispObj
{
  ...
  [DispId(0)]
  MsoHTMLProjectState State { [DispId(0), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }
  ...
  [DispId(3)]
  HTMLProjectItems HTMLProjectItems { [DispId(3), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
