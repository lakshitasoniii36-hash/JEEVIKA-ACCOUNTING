...
// Type: Microsoft.Office.Core._CommandBarComboBoxEvents_Event
...
public interface _CommandBarComboBoxEvents_Event
{
  ...
  void add_Change([In] _CommandBarComboBoxEvents_ChangeEventHandler obj0);

  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  void remove_Change([In] _CommandBarComboBoxEvents_ChangeEventHandler obj0);
}
