...
public interface CustomXMLPrefixMappings : _IMsoDispObj, IEnumerable
{
  ...
  [DispId(0)]
  CustomXMLPrefixMapping this[[MarshalAs(UnmanagedType.Struct), In] object Index] { [DispId(0), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }

  [DispId(1610809347 /*0x60030003*/)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  void AddNamespace([MarshalAs(UnmanagedType.BStr), In] string Prefix, [MarshalAs(UnmanagedType.BStr), In] string NamespaceURI);

  [DispId(1610809348 /*0x60030004*/)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.BStr)]
  string LookupNamespace([MarshalAs(UnmanagedType.BStr), In] string Prefix);

  [DispId(1610809349 /*0x60030005*/)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.BStr)]
  string LookupPrefix([MarshalAs(UnmanagedType.BStr), In] string NamespaceURI);
