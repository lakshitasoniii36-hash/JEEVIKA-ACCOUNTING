...
public interface GradientStops : _IMsoDispObj, IEnumerable
{
  ...
  [DispId(0)]
  GradientStop this[[In] int Index] { [DispId(0), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
  ...
  [DispId(11)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  void Insert([ComAliasName("Microsoft.Office.Core.MsoRGBType"), In] int RGB, [In] float Position, [In] float Transparency = 0.0f, [In] int Index = -1);
}
