...
// Type: Microsoft.Office.Core._CommandBarActiveX
...
public interface _CommandBarActiveX : CommandBarControl
{
  ...
  string ControlCLSID { [DispId(1610940416 /*0x60050000*/), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.BStr)] get; [DispId(1610940416 /*0x60050000*/), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: MarshalAs(UnmanagedType.BStr), In] set; }

  [DispId(1610940418 /*0x60050002*/)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.IUnknown)]
  object get_QueryControlInterface([MarshalAs(UnmanagedType.BStr), In] string bstrIid);

  [DispId(1610940419 /*0x60050003*/)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  void SetInnerObjectFactory([MarshalAs(UnmanagedType.IUnknown), In] object pUnk);
  ...
  object InitWith { [DispId(1610940421 /*0x60050005*/), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: MarshalAs(UnmanagedType.IUnknown), In] set; }
}
