...
// Type: Microsoft.Office.Core.FileTypes
...
public interface FileTypes : _IMsoDispObj, IEnumerable
{
  ...
  [DispId(0)]
  MsoFileType this[[In] int Index] { [DispId(0), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }
  ...
  void Add([In] MsoFileType FileType);
