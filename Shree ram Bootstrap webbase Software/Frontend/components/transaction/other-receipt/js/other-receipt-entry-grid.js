...
var OtherReceiptEntryGrid = (function () {
  ...
  var accounts = [];
  var MIN_ROWS = 4; // Minimum visible rows for table padding
  ...
  function render() {
    ...
    for (var e = items.length; e < MIN_ROWS; e++) {
      html += '<tr class="ore-grid-row ore-grid-empty">';
      html += '<td class="ore-grid-sr" style="color:#E0E0E0;">' + (e + 1) + '</td>';
      html += '<td class="ore-grid-cell" style="color:#E0E0E0;"></td>';
      html += '<td class="ore-grid-cell" style="color:#E0E0E0;"></td>';
      html += '<td class="ore-grid-cell ore-grid-num" style="color:#E0E0E0;"></td>';
      html += '<td class="ore-grid-cell ore-grid-num" style="color:#E0E0E0;"></td>';
      html += '</tr>';
    }
