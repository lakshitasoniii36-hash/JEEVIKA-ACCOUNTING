...
var MemberDebitNoteGrid = (function () {
  ...
  function render() {
    ...
    items.forEach(function(item, idx) {
      ...
      // Account Code
      html += '<td class="mdn-grid-cell">' + (item.accountCode || '') + '</td>';

      // Account Head
      html += '<td class="mdn-grid-cell">' + (item.accountHead || '') + '</td>';
    ...
    if (currentLength < minRows) {
      for (var i = currentLength; i < minRows; i++) {
        html += '<tr class="mdn-grid-row mdn-grid-dummy-row" style="height:35px; background:transparent; pointer-events:none;">';
        html += '<td class="mdn-grid-sr">' + (i + 1) + '</td>';
        html += '<td class="mdn-grid-cell">&nbsp;</td>';
        html += '<td class="mdn-grid-cell">&nbsp;</td>';
        html += '<td class="mdn-grid-cell">&nbsp;</td>';
        html += '</tr>';
      }
    ...
    var addRowBtn = document.querySelector('.mdn-grid-add-row');
