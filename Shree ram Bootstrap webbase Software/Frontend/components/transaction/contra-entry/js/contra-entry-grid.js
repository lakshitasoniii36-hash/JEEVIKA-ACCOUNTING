...
var ContraEntryGrid = (function () {
  ...
  function render() {
    ...
    items.forEach(function(item, idx) {
      ...
      // Sr
      html += '<td class="ce-grid-sr" style="text-align:center;background:#f9f9f9;font-weight:bold;color:#777;">' + (idx + 1) + '</td>';
      ...
      if (editingCell && editingCell.row === idx && editingCell.col === 'debit') {
        ...
        html += '<td class="ce-grid-cell ce-grid-num" style="text-align:right;font-family:monospace;" onclick="ContraEntryGrid.startEdit(' + idx + ', \'debit\')">' + (item.debit > 0 ? parseFloat(item.debit).toFixed(2) : '—') + '</td>';
      }
      ...
      if (editingCell && editingCell.row === idx && editingCell.col === 'credit') {
        ...
        html += '<td class="ce-grid-cell ce-grid-num" style="text-align:right;font-family:monospace;" onclick="ContraEntryGrid.startEdit(' + idx + ', \'credit\')">' + (item.credit > 0 ? parseFloat(item.credit).toFixed(2) : '—') + '</td>';
      }
